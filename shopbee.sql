...
--
-- Host: 127.0.0.1:3301
-- Generation Time: Jul 30, 2023 at 10:52 AM
...
INSERT INTO `tbl_account` (`idAccount`, `userLogin`, `passwordLogin`, `fullName`, `email`, `phoneNumber`, `isBlock`, `codePermission`) VALUES
(1, 'client1', '123456', 'Phạm Minh Châu', 'phamchau7410@gmail.com', '0386400934', b'0', 'client'),
(2, 'client2', '123456', 'Trịnh Hồng Ngân', 'mongthuong7410@gmail.com', '0337136035', b'0', 'client'),
(3, 'client3', '123456', 'Nguyễn Thị Kim Ánh', 'kimanh7410@gmail.com', '0332371232', b'0', 'client'),
(4, 'client4', '123456', 'Phạm Văn Được', 'vanduoc7410@gmail.com', '0324835777', b'0', 'seller'),
(5, 'client5', '123456', 'Nguyễn Thị Kim Tuyền', 'kimtuyen7410@gmail.com', '0384849984', b'0', 'seller'),
(6, 'thole123', '123456', 'Lê Thị Thọ', 'thole7410@gmail.com', '0338120030', b'0', 'client'),
(7, 'demo123', '12345678', 'ABC', 'thole7410@gmail.com', '0338120030', b'0', 'client');
...
INSERT INTO `tbl_cart` (`idAccount`, `idSegment`, `quantity`) VALUES
(1, 40, 1),
(1, 44, 1),
(1, 47, 1),
(6, 128, 1),
...
CREATE TABLE `tbl_category` (
  ...
  `imageCategory` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_category` (`idCategory`, `nameCategory`, `imageCategory`) VALUES
(1, 'Thời Trang Nam', 'thoitrangnam.png'),
(2, 'Thời Trang Nữ', 'thoitrangnu.png'),
(3, 'Ba Lô', 'balo.png'),
(4, 'Điện Thoại', 'dienthoai.png'),
(5, 'Đồng Hồ', 'dongho.png'),
(6, 'Giày Dép Nam', 'giaydepnam.png'),
(7, 'Giày Dép Nữ', 'giaydepnu.png'),
(8, 'Laptop', 'laptop.png'),
(9, 'Nhà Cửa Đời Sống', 'nhacuadoisong.png'),
(10, 'Thiết Bị Điện Tử', 'thietbidientu.png'),
(11, 'Túi Xách Nữ', 'tuixachnu.png'),
(12, 'Sắc Đẹp', 'sacdep.png');
...
CREATE TABLE `tbl_classify` (
  `codeClassify` char(20) NOT NULL,
  `nameClassify` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_classify` (`codeClassify`, `nameClassify`) VALUES
('accessory', 'Phụ kiện'),
('color', 'Màu sắc'),
('compart', 'Ngăn kệ'),
...
--
-- Table structure for table `tbl_classify_product`
--

CREATE TABLE `tbl_classify_product` (
  `idSegment` int(11) NOT NULL,
  `nameSegment` varchar(100) DEFAULT NULL,
  `priceSegment` int(11) DEFAULT NULL,
  `conditionSegment` bit(1) DEFAULT NULL,
  `idProduct` int(11) NOT NULL,
  `codeClassify` char(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_classify_product`
--

INSERT INTO `tbl_classify_product` (`idSegment`, `nameSegment`, `priceSegment`, `conditionSegment`, `idProduct`, `codeClassify`) VALUES
(1, 'S', 0, b'1', 1, 'size'),
(2, 'M', 0, b'1', 1, 'size'),
(3, 'L', 0, b'1', 1, 'size'),
(4, 'XL', 0, b'1', 1, 'size'),
(5, 'Đen', 0, b'1', 1, 'color'),
(6, 'Trắng', 0, b'1', 1, 'color'),
(7, 'Ghi', 0, b'1', 1, 'color'),
(8, 'M', 0, b'1', 2, 'size'),
(9, 'L', 0, b'1', 2, 'size'),
(10, 'XL', 0, b'1', 2, 'size'),
(11, '2XL', 0, b'1', 2, 'size'),
(12, 'Đen', 0, b'1', 2, 'color'),
(13, 'Trắng', 0, b'1', 2, 'color'),
(14, 'M', 0, b'1', 3, 'size'),
(15, 'L', 0, b'1', 3, 'size'),
(16, 'XL', 0, b'1', 3, 'size'),
(17, 'Đen', 0, b'1', 3, 'color'),
(18, 'Trắng', 0, b'1', 3, 'color'),
(19, 'Ghi', 0, b'1', 3, 'color'),
(20, '40-45kg', 0, b'1', 4, 'size'),
(21, '45-50kg', 0, b'1', 4, 'size'),
(22, '50-55kg', 0, b'1', 4, 'size'),
(23, 'FreeSize', 0, b'1', 4, 'size'),
(24, 'Đen', 0, b'1', 4, 'color'),
(25, 'Trắng', 0, b'1', 4, 'color'),
(26, 'Nâu', 0, b'1', 4, 'color'),
(27, '40-45kg', 0, b'1', 5, 'size'),
(28, '45-50kg', 0, b'1', 5, 'size'),
(29, '50-55kg', 0, b'1', 5, 'size'),
(30, 'FreeSize', 0, b'1', 5, 'size'),
(31, 'Đen', 0, b'1', 5, 'color'),
(32, 'Trắng', 0, b'1', 5, 'color'),
(33, 'Nâu', 0, b'1', 5, 'color'),
(34, '40-45kg', 0, b'1', 6, 'size'),
(35, '45-50kg', 0, b'1', 6, 'size'),
(36, '50-55kg', 0, b'1', 6, 'size'),
(37, 'FreeSize', 0, b'1', 6, 'size'),
(38, 'Đen', 0, b'1', 6, 'color'),
(39, 'Trắng', 0, b'1', 6, 'color'),
(40, '256GB', 0, b'1', 7, 'memory'),
(41, '512GB', 500000, b'1', 7, 'memory'),
(42, '1TB', 1000000, b'1', 7, 'memory'),
(43, '2TB', 2000000, b'1', 7, 'memory'),
(44, 'Vàng', 0, b'1', 7, 'color'),
(45, 'Tím', 300000, b'1', 7, 'color'),
(46, 'Trắng', 0, b'1', 7, 'color'),
(47, 'FullBox', 1000000, b'1', 7, 'condition'),
(48, '95%', 0, b'1', 7, 'condition'),
(49, '98%', 500000, b'1', 7, 'condition'),
(50, '256GB', 0, b'1', 8, 'memory'),
(51, '512GB', 500000, b'1', 8, 'memory'),
(52, '1TB', 1000000, b'1', 8, 'memory'),
(53, 'Đen', 0, b'1', 8, 'color'),
(54, 'Tím than', 300000, b'1', 8, 'color'),
(55, 'Trắng', 0, b'1', 8, 'color'),
(56, 'Mới 100%', 1000000, b'1', 8, 'condition'),
(57, 'Đã sử dụng', 0, b'1', 8, 'condition'),
(58, '256GB', 0, b'1', 9, 'memory'),
(59, '512GB', 500000, b'1', 9, 'memory'),
(60, '1TB', 1000000, b'1', 9, 'memory'),
(61, 'Vàng', 0, b'1', 9, 'color'),
(62, 'Đen', 0, b'1', 9, 'color'),
(63, 'Trắng', 0, b'1', 9, 'color'),
(64, 'FullBox', 1000000, b'1', 9, 'condition'),
(65, '95%', 0, b'1', 9, 'condition'),
(66, '98%', 500000, b'1', 9, 'condition'),
(67, 'Xanh', 0, b'1', 10, 'color'),
(68, 'Vàng', 0, b'0', 10, 'color'),
(69, 'Đen', 0, b'1', 10, 'color'),
(70, 'Xám', 0, b'1', 10, 'color'),
(71, 'Xanh', 0, b'1', 11, 'color'),
(72, 'Vàng', 0, b'0', 11, 'color'),
(73, 'Đen', 0, b'1', 11, 'color'),
(74, 'Xám', 0, b'0', 11, 'color'),
(75, 'Nâu', 0, b'1', 11, 'color'),
(76, 'Dây nhôm', 0, b'1', 12, 'material'),
(77, 'Dây thép', 200000, b'1', 12, 'material'),
(78, 'Vàng', 0, b'1', 12, 'color'),
(79, 'Bạch kim', 0, b'1', 12, 'color'),
(80, 'Dây nhôm', 0, b'1', 13, 'material'),
(81, 'Dây thép', 200000, b'1', 13, 'material'),
(82, 'Vàng', 0, b'1', 13, 'color'),
(83, 'Bạch kim', 0, b'1', 13, 'color'),
(84, '37', 0, b'1', 14, 'size'),
(85, '38', 0, b'0', 14, 'size'),
(86, '39', 0, b'1', 14, 'size'),
(87, '40', 0, b'1', 14, 'size'),
...
(89, '42', 0, b'0', 14, 'size'),
(90, '43', 0, b'1', 14, 'size'),
(91, '40-45kg', 0, b'1', 15, 'size'),
(92, '45-50kg', 0, b'1', 15, 'size'),
(93, '50-55kg', 0, b'1', 15, 'size'),
(94, 'FreeSize', 0, b'1', 15, 'size'),
(95, 'Đen', 0, b'1', 15, 'color'),
(96, 'Trắng', 0, b'1', 15, 'color'),
(97, 'Nâu', 0, b'1', 15, 'color'),
(98, '1m50-1m55', 0, b'1', 16, 'size'),
(99, '1m55-1m60', 0, b'1', 16, 'size'),
(100, '1m60-1m70', 0, b'1', 16, 'size'),
(101, '1m70-1m80', 0, b'1', 16, 'size'),
(102, '>1m80', 0, b'1', 16, 'size'),
(103, 'Đen', 0, b'1', 16, 'color'),
(104, 'Trắng', 0, b'1', 16, 'color'),
(105, '50-55kg', 0, b'1', 17, 'size'),
(106, '55-60kg', 0, b'0', 17, 'size'),
(107, '60-65kg', 0, b'1', 17, 'size'),
(108, '65-70kg', 0, b'1', 17, 'size'),
(109, 'FreeSize', 0, b'1', 17, 'size'),
(110, '37', 0, b'1', 18, 'size'),
(111, '38', 0, b'1', 18, 'size'),
(112, '39', 0, b'1', 18, 'size'),
(113, '40', 0, b'0', 18, 'size'),
(114, '41', 0, b'1', 18, 'size'),
(115, '36', 0, b'1', 19, 'size'),
(116, '37', 0, b'0', 19, 'size'),
(117, '38', 0, b'1', 19, 'size'),
(118, '39', 0, b'1', 19, 'size'),
(119, '40', 0, b'0', 19, 'size'),
(120, '41', 0, b'1', 19, 'size'),
(121, '36', 0, b'1', 20, 'size'),
(122, '37', 0, b'1', 20, 'size'),
(123, '38', 0, b'1', 20, 'size'),
(124, '39', 0, b'0', 20, 'size'),
(125, '40', 0, b'0', 20, 'size'),
(126, '41', 0, b'1', 20, 'size'),
(127, 'Blue Switch', 0, b'1', 21, 'material'),
(128, 'Red Switch', 150000, b'1', 21, 'material'),
(129, 'Brown Switch', 200000, b'1', 21, 'material'),
(130, 'Black Switch', 250000, b'1', 21, 'material'),
(131, 'Xanh Trắng', 0, b'1', 21, 'color'),
(132, 'Đen Trắng', 0, b'1', 21, 'color'),
(133, 'Hồng Trắng', 0, b'1', 21, 'color'),
(134, 'Có dây', 0, b'1', 22, 'material'),
(135, 'Không dây', 50000, b'1', 22, 'material'),
(136, 'Xám', 0, b'1', 22, 'color'),
(137, 'Đen', 0, b'1', 22, 'color'),
(138, 'Trắng', 0, b'1', 22, 'color'),
(139, '2 ngăn', 0, b'1', 23, 'compart'),
(140, '3 ngăn', 10000, b'1', 23, 'compart'),
(141, '4 ngăn', 15000, b'1', 23, 'compart'),
(142, '5 ngăn', 20000, b'1', 23, 'compart'),
(143, '2 ngăn', 0, b'1', 24, 'compart'),
(144, '3 ngăn', 10000, b'1', 24, 'compart'),
(145, '4 ngăn', 15000, b'1', 24, 'compart'),
(146, '5 ngăn', 20000, b'1', 24, 'compart'),
(147, 'Dây silicon', 0, b'1', 25, 'material'),
(148, 'Dây nhôm', 10000, b'1', 25, 'material'),
(149, 'Dây thép', 20000, b'1', 25, 'material'),
(150, 'Trắng', 0, b'1', 25, 'color'),
(151, 'Đen', 0, b'1', 25, 'color'),
(152, 'Xanh', 0, b'1', 26, 'color'),
(153, 'Vàng', 0, b'0', 26, 'color'),
(154, 'Đen', 0, b'1', 26, 'color'),
(155, 'Xám', 0, b'1', 26, 'color'),
(156, 'Nâu', 0, b'1', 26, 'color'),
(157, 'Không', 0, b'1', 27, 'accessory'),
(158, 'Bộ vệ sinh', 5000, b'1', 27, 'accessory'),
(159, 'Đồ thổi bụi', 5000, b'1', 27, 'accessory'),
(160, 'Bộ Combo', 8000, b'1', 27, 'accessory'),
(161, '20W', 0, b'1', 28, 'watt'),
(162, '30W', 30000, b'1', 28, 'watt'),
(163, '50W', 50000, b'1', 28, 'watt'),
(164, 'Không', 0, b'1', 29, 'accessory'),
(165, 'Bộ vệ sinh', 5000, b'1', 29, 'accessory'),
(166, 'Dây đeo', 5000, b'1', 29, 'accessory'),
(167, 'Bộ Combo', 8000, b'1', 29, 'accessory'),
(168, 'Không', 0, b'1', 30, 'accessory'),
(169, 'Bộ vệ sinh', 5000, b'1', 30, 'accessory'),
(170, 'Dây đeo', 5000, b'1', 30, 'accessory'),
(171, 'Bộ Combo', 8000, b'1', 30, 'accessory'),
(172, 'Xanh', 0, b'1', 31, 'color'),
(173, 'Vàng', 0, b'0', 31, 'color'),
(174, 'Đen', 0, b'0', 31, 'color'),
(175, 'Xám', 0, b'1', 31, 'color'),
(176, 'Trắng', 0, b'1', 31, 'color'),
(177, 'Xanh', 0, b'1', 32, 'color'),
(178, 'Đen', 0, b'1', 32, 'color'),
(179, 'Xám', 0, b'1', 32, 'color'),
(180, 'Trắng', 0, b'1', 32, 'color'),
(181, '100ml', 0, b'1', 33, 'lit'),
(182, '150ml', 20000, b'1', 33, 'lit'),
(183, '200ml', 30000, b'1', 33, 'lit'),
(184, '250ml', 40000, b'1', 33, 'lit'),
(185, '300ml', 50000, b'1', 33, 'lit'),
(186, '250ml', 0, b'1', 34, 'lit'),
(187, '500ml', 50000, b'1', 34, 'lit'),
(188, '1l', 100000, b'1', 34, 'lit'),
(189, 'M', 0, b'1', 35, 'size'),
(190, 'L', 0, b'1', 35, 'size'),
(191, 'XL', 0, b'1', 35, 'size'),
(192, '2XL', 0, b'1', 35, 'size'),
(193, 'Đen', 0, b'1', 35, 'color'),
(194, 'Trắng', 0, b'1', 35, 'color'),
(195, '40-45kg', 0, b'1', 36, 'size'),
(196, '45-50kg', 0, b'1', 36, 'size'),
(197, '50-55kg', 0, b'1', 36, 'size'),
(198, 'FreeSize', 0, b'1', 36, 'size'),
(199, 'Đen', 0, b'1', 36, 'color'),
(200, 'Trắng', 0, b'1', 36, 'color'),
(201, 'Nâu', 0, b'1', 36, 'color'),
(202, 'M', 0, b'1', 37, 'size'),
(203, 'L', 0, b'1', 37, 'size'),
(204, 'XL', 0, b'1', 37, 'size'),
(205, '2XL', 0, b'1', 37, 'size'),
(206, 'Đen', 0, b'1', 37, 'color'),
(207, 'Trắng', 0, b'1', 37, 'color'),
(208, '1m50-1m55', 0, b'1', 38, 'size'),
(209, '1m55-1m60', 0, b'1', 38, 'size'),
(210, '1m60-1m70', 0, b'1', 38, 'size'),
(211, '1m70-1m80', 0, b'1', 38, 'size'),
(212, '>1m80', 0, b'1', 38, 'size'),
(213, 'Đen', 0, b'1', 38, 'color'),
(214, 'Trắng', 0, b'1', 38, 'color'),
(215, '1m50-1m55', 0, b'1', 39, 'size'),
(216, '1m55-1m60', 0, b'1', 39, 'size'),
(217, '1m60-1m70', 0, b'1', 39, 'size'),
(218, '1m70-1m80', 0, b'1', 39, 'size'),
(219, '>1m80', 0, b'1', 39, 'size'),
(220, 'Đen', 0, b'1', 39, 'color'),
(221, 'Trắng', 0, b'1', 39, 'color'),
(222, 'M', 0, b'1', 40, 'size'),
(223, 'L', 0, b'1', 40, 'size'),
(224, 'XL', 0, b'1', 40, 'size'),
(225, '2XL', 0, b'1', 40, 'size'),
(226, 'Đen', 0, b'1', 40, 'color'),
(227, 'Trắng', 0, b'1', 40, 'color'),
(228, 'Nâu', 0, b'1', 40, 'color'),
(229, '2XL', 0, b'1', 1, 'size'),
(230, 'Freesize', 0, b'1', 1, 'size'),
(231, 'Xanh', 0, b'1', 1, 'color'),
(232, '40-45kg', 0, b'1', 41, 'size'),
(233, '45-50kg', 0, b'1', 41, 'size'),
(234, '50-55kg', 0, b'1', 41, 'size'),
(235, 'FreeSize', 0, b'1', 41, 'size'),
(236, 'Đen', 0, b'1', 41, 'color'),
(237, 'Trắng', 0, b'1', 41, 'color'),
(238, 'Nâu', 0, b'1', 41, 'color'),
(239, '40-45kg', 0, b'1', 42, 'size'),
(240, '45-50kg', 0, b'1', 42, 'size'),
(241, '50-55kg', 0, b'1', 42, 'size'),
(242, 'FreeSize', 0, b'1', 42, 'size'),
(243, 'Đen', 0, b'1', 42, 'color'),
(244, 'Trắng', 0, b'1', 42, 'color'),
(245, 'Nâu', 0, b'1', 42, 'color'),
(246, '40-45kg', 0, b'1', 43, 'size'),
(247, '45-50kg', 0, b'1', 43, 'size'),
(248, '50-55kg', 0, b'1', 43, 'size'),
(249, 'FreeSize', 0, b'1', 43, 'size'),
(250, 'Đen', 0, b'1', 43, 'color'),
(251, 'Trắng', 0, b'1', 43, 'color'),
(252, 'Nâu', 0, b'1', 43, 'color'),
(253, '40-45kg', 0, b'1', 44, 'size'),
(254, '45-50kg', 0, b'1', 44, 'size'),
(255, '50-55kg', 0, b'1', 44, 'size'),
(256, 'FreeSize', 0, b'1', 44, 'size'),
(257, 'Đen', 0, b'1', 44, 'color'),
(258, 'Trắng', 0, b'1', 44, 'color'),
(259, 'Nâu', 0, b'1', 44, 'color'),
(260, 'Xanh', 0, b'1', 45, 'color'),
(261, 'Vàng', 0, b'0', 45, 'color'),
(262, 'Đen', 0, b'1', 45, 'color'),
(263, 'Xám', 0, b'0', 45, 'color'),
(264, 'Nâu', 0, b'1', 45, 'color'),
(265, 'Xanh', 0, b'1', 46, 'color'),
(266, 'Vàng', 0, b'0', 46, 'color'),
(267, 'Đen', 0, b'1', 46, 'color'),
(268, 'Xám', 0, b'0', 46, 'color'),
(269, 'Nâu', 0, b'1', 46, 'color'),
(270, 'Xanh', 0, b'1', 47, 'color'),
(271, 'Vàng', 0, b'0', 47, 'color'),
(272, 'Đen', 0, b'1', 47, 'color'),
(273, 'Xám', 0, b'0', 47, 'color'),
(274, 'Nâu', 0, b'1', 47, 'color'),
(275, 'Xanh', 0, b'1', 48, 'color'),
(276, 'Vàng', 0, b'0', 48, 'color'),
(277, 'Đen', 0, b'1', 48, 'color'),
(278, 'Xám', 0, b'0', 48, 'color'),
(279, 'Nâu', 0, b'1', 48, 'color'),
(280, 'Không', 0, b'1', 49, 'accessory'),
(281, 'Bộ vệ sinh', 5000, b'1', 49, 'accessory'),
(282, 'Đồ thổi bụi', 5000, b'1', 49, 'accessory'),
(283, 'Bộ Combo', 8000, b'1', 49, 'accessory'),
(284, 'Không', 0, b'1', 50, 'accessory'),
(285, 'Bộ vệ sinh', 5000, b'1', 50, 'accessory'),
(286, 'Đồ thổi bụi', 5000, b'1', 50, 'accessory'),
(287, 'Bộ Combo', 8000, b'1', 50, 'accessory'),
(288, 'Không', 0, b'1', 51, 'accessory'),
(289, 'Bộ vệ sinh', 5000, b'1', 51, 'accessory'),
(290, 'Đồ thổi bụi', 5000, b'1', 51, 'accessory'),
(291, 'Bộ Combo', 8000, b'1', 51, 'accessory'),
(292, 'Dây silicon', 0, b'1', 52, 'material'),
(293, 'Dây nhôm', 10000, b'1', 52, 'material'),
(294, 'Dây thép', 20000, b'1', 52, 'material'),
(295, 'Trắng', 0, b'1', 52, 'color'),
(296, 'Đen', 0, b'1', 52, 'color'),
(297, 'Dây silicon', 0, b'1', 53, 'material'),
(298, 'Dây nhôm', 10000, b'1', 53, 'material'),
(299, 'Dây thép', 20000, b'1', 53, 'material'),
(300, 'Trắng', 0, b'1', 53, 'color'),
(301, 'Đen', 0, b'1', 53, 'color'),
(302, 'Dây silicon', 0, b'1', 54, 'material'),
(303, 'Dây nhôm', 10000, b'1', 54, 'material'),
(304, 'Dây thép', 20000, b'1', 54, 'material'),
(305, 'Trắng', 0, b'1', 54, 'color'),
(306, 'Đen', 0, b'1', 54, 'color'),
(307, '37', 0, b'1', 55, 'size'),
(308, '38', 0, b'1', 55, 'size'),
(309, '39', 0, b'1', 55, 'size'),
(310, '40', 0, b'1', 55, 'size'),
(311, '41', 0, b'1', 55, 'size'),
(312, '42', 0, b'1', 55, 'size'),
(313, '43', 0, b'1', 55, 'size'),
(314, 'Đen', 0, b'1', 55, 'color'),
(315, 'Trắng', 0, b'1', 55, 'color'),
(316, 'Xám', 0, b'1', 55, 'color'),
(317, '37', 0, b'1', 56, 'size'),
(318, '38', 0, b'1', 56, 'size'),
(319, '39', 0, b'1', 56, 'size'),
(320, '40', 0, b'1', 56, 'size'),
(321, '41', 0, b'1', 56, 'size'),
(322, '42', 0, b'1', 56, 'size'),
(323, '43', 0, b'1', 56, 'size'),
(324, 'Đen', 0, b'1', 56, 'color'),
(325, 'Trắng', 0, b'1', 56, 'color'),
(326, 'Xám', 0, b'1', 56, 'color'),
(327, '37', 0, b'1', 57, 'size'),
(328, '38', 0, b'1', 57, 'size'),
(329, '39', 0, b'1', 57, 'size'),
(330, '40', 0, b'1', 57, 'size'),
(331, '41', 0, b'1', 57, 'size'),
(332, '42', 0, b'1', 57, 'size'),
(333, '43', 0, b'1', 57, 'size'),
(334, 'Đen', 0, b'1', 57, 'color'),
(335, 'Trắng', 0, b'1', 57, 'color'),
(336, 'Xám', 0, b'1', 57, 'color'),
(337, '37', 0, b'1', 58, 'size'),
(338, '38', 0, b'1', 58, 'size'),
(339, '39', 0, b'1', 58, 'size'),
(340, '40', 0, b'1', 58, 'size'),
(341, '41', 0, b'1', 58, 'size'),
(342, '42', 0, b'1', 58, 'size'),
(343, '43', 0, b'1', 58, 'size'),
(344, 'Đen', 0, b'1', 58, 'color'),
(345, 'Trắng', 0, b'1', 58, 'color'),
(346, 'Xám', 0, b'1', 58, 'color'),
(347, '37', 0, b'1', 59, 'size'),
(348, '38', 0, b'1', 59, 'size'),
(349, '39', 0, b'1', 59, 'size'),
(350, '40', 0, b'1', 59, 'size'),
(351, '41', 0, b'1', 59, 'size'),
(352, '42', 0, b'1', 59, 'size'),
(353, '43', 0, b'1', 59, 'size'),
(354, 'Đen', 0, b'1', 59, 'color'),
(355, 'Trắng', 0, b'1', 59, 'color'),
(356, 'Xám', 0, b'1', 59, 'color'),
(357, '37', 0, b'1', 60, 'size'),
(358, '38', 0, b'1', 60, 'size'),
(359, '39', 0, b'1', 60, 'size'),
(360, '40', 0, b'1', 60, 'size'),
(361, '41', 0, b'1', 60, 'size'),
(362, '42', 0, b'1', 60, 'size'),
(363, '43', 0, b'1', 60, 'size'),
(364, 'Đen', 0, b'1', 60, 'color'),
(365, 'Trắng', 0, b'1', 60, 'color'),
(366, 'Xám', 0, b'1', 60, 'color'),
(367, '37', 0, b'1', 61, 'size'),
(368, '38', 0, b'1', 61, 'size'),
(369, '39', 0, b'1', 61, 'size'),
(370, '40', 0, b'1', 61, 'size'),
(371, '41', 0, b'1', 61, 'size'),
(372, '42', 0, b'1', 61, 'size'),
(373, '43', 0, b'1', 61, 'size'),
(374, 'Đen', 0, b'1', 61, 'color'),
(375, 'Trắng', 0, b'1', 61, 'color'),
(376, 'Xám', 0, b'1', 61, 'color'),
(377, '37', 0, b'1', 62, 'size'),
(378, '38', 0, b'1', 62, 'size'),
(379, '39', 0, b'1', 62, 'size'),
(380, '40', 0, b'1', 62, 'size'),
(381, '41', 0, b'1', 62, 'size'),
(382, '42', 0, b'1', 62, 'size'),
(383, '43', 0, b'1', 62, 'size'),
(384, 'Đen', 0, b'1', 62, 'color'),
(385, 'Trắng', 0, b'1', 62, 'color'),
(386, 'Xám', 0, b'1', 62, 'color'),
(387, '64GB', 0, b'1', 63, 'memory'),
(388, '128GB', 50000, b'1', 63, 'memory'),
(389, '256GB', 70000, b'1', 63, 'memory'),
(390, '512GB', 90000, b'1', 63, 'memory'),
(391, '1TB', 120000, b'1', 63, 'memory'),
(392, '2TB', 150000, b'1', 63, 'memory'),
(393, '20W', 0, b'1', 64, 'watt'),
(394, '30W', 30000, b'1', 64, 'watt'),
(395, '50W', 50000, b'1', 64, 'watt'),
(396, 'Không', 0, b'1', 64, 'accessory'),
(397, 'Bộ vệ sinh', 5000, b'1', 64, 'accessory'),
(398, 'Dây đeo', 5000, b'1', 64, 'accessory'),
(399, 'Bộ Combo', 8000, b'1', 64, 'accessory'),
(400, 'Đen', 0, b'1', 65, 'color'),
(401, 'Trắng', 0, b'1', 65, 'color'),
(402, 'Xám', 0, b'1', 65, 'color'),
(403, 'Không', 0, b'1', 65, 'accessory'),
(404, 'Bộ vệ sinh', 5000, b'1', 65, 'accessory'),
(405, 'Dây đeo', 5000, b'1', 65, 'accessory'),
(406, 'Bộ Combo', 8000, b'1', 65, 'accessory'),
(407, 'Vàng', 0, b'1', 66, 'color'),
(408, 'Đen', 0, b'1', 66, 'color'),
(409, 'Trắng', 0, b'1', 66, 'color'),
(410, 'Xám', 0, b'1', 66, 'color'),
(411, 'Không', 0, b'1', 66, 'accessory'),
(412, 'Bộ vệ sinh', 5000, b'1', 66, 'accessory'),
(413, 'Dây đeo', 5000, b'1', 66, 'accessory'),
(414, 'Bộ Combo', 8000, b'1', 66, 'accessory'),
(415, '20cm', 0, b'1', 67, 'size'),
(416, '30cm', 5000, b'1', 67, 'size'),
(417, '40cm', 10000, b'1', 67, 'size'),
(418, '50cm', 15000, b'1', 67, 'size'),
(419, '60cm', 20000, b'1', 67, 'size'),
(420, '70cm', 25000, b'1', 67, 'size'),
(421, '80cm', 30000, b'1', 67, 'size'),
(422, '90cm', 35000, b'1', 67, 'size'),
(423, '100cm', 40000, b'1', 67, 'size'),
(424, '2 ngăn', 0, b'1', 68, 'compart'),
(425, '3 ngăn', 10000, b'1', 68, 'compart'),
(426, '4 ngăn', 15000, b'1', 68, 'compart'),
(427, '5 ngăn', 20000, b'1', 68, 'compart'),
(428, '2 ngăn', 0, b'1', 69, 'compart'),
(429, '3 ngăn', 10000, b'1', 69, 'compart'),
(430, '4 ngăn', 15000, b'1', 69, 'compart'),
(431, '5 ngăn', 20000, b'1', 69, 'compart'),
(432, '20cm', 0, b'1', 70, 'size'),
(433, '30cm', 5000, b'1', 70, 'size'),
(434, '40cm', 10000, b'1', 70, 'size'),
(435, '50cm', 15000, b'1', 70, 'size'),
(436, '60cm', 20000, b'1', 70, 'size'),
(437, '70cm', 25000, b'1', 70, 'size'),
(438, '80cm', 30000, b'1', 70, 'size'),
(439, '90cm', 35000, b'1', 70, 'size'),
(440, '100cm', 40000, b'1', 70, 'size'),
(441, '20W', 0, b'1', 71, 'watt'),
(442, '30W', 30000, b'1', 71, 'watt'),
(443, '50W', 50000, b'1', 71, 'watt'),
(444, 'Không', 0, b'1', 71, 'accessory'),
(445, 'Bộ vệ sinh', 5000, b'1', 71, 'accessory'),
(446, 'Dây đeo', 5000, b'1', 71, 'accessory'),
(447, 'Bộ Combo', 8000, b'1', 71, 'accessory'),
(448, '20W', 0, b'1', 72, 'watt'),
(449, '30W', 30000, b'1', 72, 'watt'),
(450, '50W', 50000, b'1', 72, 'watt'),
(451, 'Không', 0, b'1', 72, 'accessory'),
(452, 'Bộ vệ sinh', 5000, b'1', 72, 'accessory'),
(453, 'Dây đeo', 5000, b'1', 72, 'accessory'),
(454, 'Bộ Combo', 8000, b'1', 72, 'accessory'),
(455, '20W', 0, b'1', 73, 'watt'),
(456, '30W', 30000, b'1', 73, 'watt'),
(457, '50W', 50000, b'1', 73, 'watt'),
(458, 'Không', 0, b'1', 73, 'accessory'),
(459, 'Bộ vệ sinh', 5000, b'1', 73, 'accessory'),
(460, 'Dây đeo', 5000, b'1', 73, 'accessory'),
(461, 'Bộ Combo', 8000, b'1', 73, 'accessory'),
(462, '3 ổ cắm', 0, b'1', 74, 'size'),
(463, '4 ổ cắm', 5000, b'1', 74, 'size'),
(464, '5 ổ cắm', 10000, b'1', 74, 'size'),
(465, '5 ổ cắm', 15000, b'1', 74, 'size'),
(466, '20W', 0, b'1', 74, 'watt'),
(467, '30W', 30000, b'1', 74, 'watt'),
(468, '50W', 50000, b'1', 74, 'watt'),
(469, '25cm', 0, b'1', 75, 'size'),
(470, '30cm', 5000, b'1', 75, 'size'),
(471, '35cm', 10000, b'1', 75, 'size'),
(472, '40cm', 15000, b'1', 75, 'size'),
(473, '450cm', 20000, b'1', 75, 'size'),
(474, 'Vàng', 0, b'1', 75, 'color'),
(475, 'Đen', 0, b'1', 75, 'color'),
(476, 'Trắng', 0, b'1', 75, 'color'),
(477, 'Xám', 0, b'1', 75, 'color'),
(478, '25cm', 0, b'1', 76, 'size'),
(479, '30cm', 5000, b'1', 76, 'size'),
(480, '35cm', 10000, b'1', 76, 'size'),
(481, '40cm', 15000, b'1', 76, 'size'),
(482, '450cm', 20000, b'1', 76, 'size'),
(483, 'Vàng', 0, b'1', 76, 'color'),
(484, 'Đen', 0, b'1', 76, 'color'),
(485, 'Trắng', 0, b'1', 76, 'color'),
(486, 'Xám', 0, b'1', 76, 'color'),
(487, '25cm', 0, b'1', 77, 'size'),
(488, '30cm', 5000, b'1', 77, 'size'),
(489, '35cm', 10000, b'1', 77, 'size'),
(490, '40cm', 15000, b'1', 77, 'size'),
(491, '450cm', 20000, b'1', 77, 'size'),
(492, 'Vàng', 0, b'1', 77, 'color'),
(493, 'Đen', 0, b'1', 77, 'color'),
(494, 'Trắng', 0, b'1', 77, 'color'),
(495, 'Xám', 0, b'1', 77, 'color'),
(496, '25cm', 0, b'1', 78, 'size'),
(497, '30cm', 5000, b'1', 78, 'size'),
(498, '35cm', 10000, b'1', 78, 'size'),
(499, '40cm', 15000, b'1', 78, 'size'),
(500, '450cm', 20000, b'1', 78, 'size'),
(501, 'Vàng', 0, b'1', 78, 'color'),
(502, 'Đen', 0, b'1', 78, 'color'),
(503, 'Trắng', 0, b'1', 78, 'color'),
(504, 'Xám', 0, b'1', 78, 'color'),
(505, 'Vàng cam', 0, b'1', 79, 'color'),
(506, 'Nâu đất', 0, b'1', 79, 'color'),
(507, 'Hồng sen', 0, b'1', 79, 'color'),
(508, 'Hồng nâu', 0, b'1', 79, 'color'),
(509, 'Cam đất', 0, b'1', 79, 'color'),
(510, 'Đỏ nhạt', 0, b'1', 79, 'color'),
(511, 'Đỏ đậm', 0, b'1', 79, 'color'),
(512, 'Đỏ cam', 0, b'1', 79, 'color'),
(513, 'Vàng cam', 0, b'1', 82, 'color'),
(514, 'Nâu đất', 0, b'1', 82, 'color'),
(515, 'Hồng sen', 0, b'1', 82, 'color'),
(516, 'Hồng nâu', 0, b'1', 82, 'color'),
(517, 'Cam đất', 0, b'1', 82, 'color'),
(518, 'Đỏ nhạt', 0, b'1', 82, 'color'),
(519, 'Đỏ đậm', 0, b'1', 82, 'color'),
(520, 'Đỏ cam', 0, b'1', 82, 'color'),
(521, 'Vàng cam', 0, b'1', 81, 'color'),
(522, 'Nâu đất', 0, b'1', 81, 'color'),
(523, 'Hồng sen', 0, b'1', 81, 'color'),
(524, 'Hồng nâu', 0, b'1', 81, 'color'),
(525, 'Cam đất', 0, b'1', 81, 'color'),
(526, 'Đỏ nhạt', 0, b'1', 81, 'color'),
(527, 'Đỏ đậm', 0, b'1', 81, 'color'),
(528, 'Đỏ cam', 0, b'1', 81, 'color'),
(529, 'Vàng cam', 0, b'1', 80, 'color'),
(530, 'Nâu đất', 0, b'1', 80, 'color'),
(531, 'Hồng sen', 0, b'1', 80, 'color'),
(532, 'Hồng nâu', 0, b'1', 80, 'color'),
(533, 'Cam đất', 0, b'1', 80, 'color'),
(534, 'Đỏ nhạt', 0, b'1', 80, 'color'),
(535, 'Đỏ đậm', 0, b'1', 80, 'color'),
(536, 'Đỏ cam', 0, b'1', 80, 'color');
...
CREATE TABLE `tbl_contact` (
  ...
  `contentContact` text DEFAULT NULL,
  `replyContact` text DEFAULT NULL,
  `idAccount` int(11) NOT NULL,
...
INSERT INTO `tbl_contact` (`idContact`, `timeContact`, `contentContact`, `replyContact`, `idAccount`, `idShop`) VALUES
(1, '2023-02-12 00:00:00', 'Sản phẩm bên Shop có đảm bảo chất lượng không ạ?', 'Yes sure, Chắc chắn có rồi!', 1, 1),
(2, '2023-03-12 00:00:00', 'Có cam kết bảo hành đổi trả không ạ?', 'Vâng, tất cả sản phẩm chúng tôi đều được bảo hành 1 đổi 1 trong 6 tháng!', 1, 1),
(3, '2023-04-12 00:00:00', 'Tôi có thể đến trực tiếp shop mình không ạ?', 'Địa chỉ shop chúng tôi ở đường 102 Nguyễn Quý Anh, Tân Sơn Nhì, Tân Phú, TP.HCM ạ', 1, 1),
(4, '2023-03-12 00:00:00', 'Sao sản phẩm mã 12 đến giờ vẫn chưa giao vậy shop?', 'Hãy cho chúng tôi xin thông tin đơn hàng để kiểm tra ạ', 1, 2),
(5, '2023-04-12 00:00:00', 'Mã đơn 12, giao đến Bưu cục Ba Tri, ngày mua 01-03-2023', '(Chưa trả lời)', 1, 2);
...
INSERT INTO `tbl_country` (`idCountry`, `nameCountry`) VALUES
(1, 'Afghanistan'),
(2, 'Aland Islands'),
(3, 'Albania'),
(4, 'Algeria'),
...
INSERT INTO `tbl_delivery_address` (`idDelivery`, `detailAddress`, `phoneNumber`, `isDefault`, `idAccount`, `idWard`) VALUES
(1, 'Kế cái mương nhà bà 3 Cảnh', '0338361489', b'1', 1, 29137),
(2, 'Sát bên chuồng chó nhà ông 8 Lĩnh', '0386400934', b'0', 1, 29110),
(3, 'Chính giữa tiệm sửa xe Hùng Phát với Bách hóa xanh', '0384849984', b'0', 1, 27010),
(4, 'Trước cống 10 cửa Bình Đại', '0338361489', b'1', 2, 29137),
(5, 'Bên phải Thế giới di động', '0371278331', b'0', 2, 27010);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_detail_oder`
--

CREATE TABLE `tbl_detail_oder` (
...
CREATE TABLE `tbl_district` (
  ...
  `nameDistrict` varchar(100) DEFAULT NULL,
  `idProvine` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_district` (`idDistrict`, `nameDistrict`, `idProvine`) VALUES
(1, 'Quận Ba Đình', 1),
(2, 'Quận Hoàn Kiếm', 1),
(3, 'Quận Tây Hồ', 1),
(4, 'Quận Long Biên', 1),
...
CREATE TABLE `tbl_oder` (
  `idOder` int(11) NOT NULL,
  `timeOder` date DEFAULT NULL,
  `conditionOder` varchar(100) DEFAULT NULL,
  `totalAll` int(11) DEFAULT NULL,
  `note` varchar(200) DEFAULT NULL,
  `idDelivery` int(11) NOT NULL,
  `codeVoucher` char(20) NOT NULL,
  `codePay` char(20) NOT NULL,
  `codeShip` char(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_pay` (
  `codePay` char(20) NOT NULL,
  `namePay` varchar(50) DEFAULT NULL,
  `imagePay` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_pay` (`codePay`, `namePay`, `imagePay`) VALUES
('momo', 'MoMo', 'momo.png'),
('paypal', 'PayPal', 'paypal.png'),
('tienmat', 'Tiền mặt', 'tienmat.png'),
('viettelpay', 'ViettelPay', 'viettelpay.png'),
('zalopay', 'ZaloPay', 'zalopay.png');
...
INSERT INTO `tbl_permission` (`codePermission`, `namePermission`) VALUES
('admin', 'Quản lý'),
('client', 'Khách hàng'),
...
CREATE TABLE `tbl_product` (
  ...
  `quantityStorage` int(11) DEFAULT NULL,
  `idShop` int(11) NOT NULL,
  `idCategory` int(11) NOT NULL,
  `idCountry` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_product` (`idProduct`, `nameProduct`, `priceProduct`, `description`, `quantityStorage`, `idShop`, `idCategory`, `idCountry`) VALUES
(1, 'Bộ Quần Áo Thun Nam In Họa Tiết Chữ UMKLSU Tinh Tế Thời Trang Zenkonam MEN QA 129', 59000, 'THÔNG TIN SẢN PHẨM:\nBộ Quần Áo Thun Nam Hottrend In Họa Tiết Chữ UMKLSU Tinh Tế Thời Trang Zenkonam MEN QA 129\nThiết kế thời trang, đơn giản không kém phần hiện đại\nKiểu dáng gọn nhẹ, năng động\nChất vải thun mềm mại, dễ thấm hút mồ hôi\nHướng dẫn chọn size:\n- S (30-38Kg, <1m55)\n- M (39-50Kg, <1m65)\n- L (51-61Kg, <1m72)\n- XL (61-75Kg, <1m78)\nLưu ý:\n- Nếu chưa chắc chắn về chọn size sản phẩm\n- Nếu khách form người không cân đối\n- Nếu khách thích mặc ôm body hoặc mặc rộng thoải mái\n INBOX trực tiếp cho shop để được tư vấn size nhé', 250, 1, 1, 245),
(2, 'Áo sơ mi ngắn tay form rộng, thời trang hiện đại unisex chất liệu vải lụa mềm chống nhăn', 97000, 'Shop cam kết luôn mang lại chất lượng sản phẩm tốt nhất dành cho khách hàng với chăm ngon : “Trao đi giá trị, nhận lại yêu thương”.ÁO SƠ MI NGẮN TAY FORM RỘNG, THỜI TRANG HIỆN ĐẠI UNISEX CHẤT LIỆU VẢI LỤA MỀM CHỐNG NHĂN\nChất liệu: Lụa hàn.\n-	Công dụng: Chống nhăn, giãn nhẹ, êm ái, mềm mịn và mát da.\n-	Phong cách: Unisex, Form rộng, Sweetwear.\nDành cho: Nam và Nữ.\n-	Xu xướng: Hiện đại 2023.\n-	Xuất xứ: Made in Việt Nam.\n-	Size : M L XL XXL.\n•	M : Dưới 55kg, Cao dưới 1m65.\n•	L : 55 - 65kg, Cao 1m65 – 1m72.\n•	XL: 65 - 75kg, Cao 1m68 – 1m75.\n•	XXL: 75 - 85kg, Cao 1m70 – 1m80.\nÁO SƠ MI NGẮN TAY FORM RỘNG, THỜI TRANG HIỆN ĐẠI UNISEX CHẤT LIỆU VẢI LỤA MỀM CHỐNG NHĂN\n-	Quần short -> Tạo nên phong cách vô cùng đơn giản nhưng không kém phần cuốn hút. Đặc biệt mang đến cảm giác thoải mái cho người mặc. Phù hợp để đi dạo phố và trà sữa cùng bạn bè.', 359, 2, 1, 118),
(3, 'Áo thun Polo GẤU 194 Unisex vải cá sấu mè, co dãn 4 chiều dày dặn form gerular fit - PL Mè', 49000, 'Áo thun trơn năng động chất liệu: vải poly thoáng mát, mềm mại, ko xù lông, không bay màu, ƯU ĐIỂM:\n   - Thiết kế thời trang phù hợp xu hướng hiện nay\n   - Đường may tinh tế sắc sảo\n   - Sản phẩm có mức giá trung bình, chất liệu đường may và các chi tiết được thiết kế và may tỉ mỉ.\n   - Áo được thiết kế đẹp với đội ngũ design dày dặn kinh nghiệm, chuẩn form, vải dày, mịn, thấm hút mồ hôi tạo sự thoải mái khi mặc!\n   - Sản phẩm được gia công bởi những thợ may lành nghề, máy móc công nghệ hiện đại, sản phẩm đã được đông đảo khách hàng tin dùng.\n   - Những Sản phẩm được gấp hộp cẩn thận nên Có thể mặc hoặc làm quà tặng.\n SỐ ĐO ÁO POLO : Số đo có thể xê xích 1 chút tầm 1cm - 1.5cm ạ\n-Size XS: Ngang  43cm -- Dài 58cm\n-Size S: Ngang  45cm -- Dài 60cm\n-Size M: Ngang  47,5cm -- Dài 64cm\n-Size L: Ngang  50cm -- Dài 66cm\n-Size XL: Ngang  52cm -- Dài 68cm\n-Size XXL: Ngang  54cm -- Dài 72cm\n-Size XXXL: Ngang  57cm -- Dài 74cm', 700, 1, 1, 245),
(4, 'Quần Short Nhung Tăm Cho Nữ Bền Đẹp Hách Dáng Khỏi No Chân Ngắn 66', 119000, 'QUẦN NHUNG TĂM chất mềm.mịn rất thích hợp cho nàng teen xinh đẹp \nChất tăm vải vừa gân nhỏ hàng 1 lớp ko có đai lưng\nBạn có thể mặc đi chơi dạo phố. Kết hợp giày thể thao hay bốt vừa điệu đà vừa sang chảnh\n-----------------------------------------------\nSize: s m l xl 2xl 3xl:\nS cạp 66cm, dưới 49kg, dài 39 cm, đũng dài 31,5 cm, ống loe 32 cm\r\nM cạp 69cm dưới 52kg, 39 cm, ống loe 32,5, đáy  dài 31,5\nL cạp 73cm dưới 56kg, dài 40 cm, ống loe 33 cm,  đáy dài 32 cm\nXL cạp 75cm, dưới 60kg, dài 40, ống loe 34, đáy dài 32,5 cm\n2xl cạp 78 cm, dưới 62 kg, Dài 41 cm, ống loe 35 cm, đáy dài 33 cm\n3xl cạp 80 cm. Dưới 65kg, Dài 41 cm, ống loe 36 cm, đáy dài 33 cm\n------------------------------------------------\nMàu sắc quần có thể sáng hơn tí do ánh sáng đèn chụp. Hàng nhà may ra giá đến tay khách hàng là giá bán buôn cạnh tranh nhất.  \nMùa đông có cái thay đổi giá rẻ lại đẹp. \nSize quần có thể chênh lệch 2 cm do vải có co giãn tùy dáng người mặc\nĐảm bảo các bạn mặc quần không những đẹp còn rất thời trang\nQuý khách hài lòng là niềm vinh hạnh cho shop. Nếu có góp ý gì xin nhắn tin shop giải quyết ổn thỏa đừng đánh giá xấu tội nghiệp shop ạ. \n- Size số mang tính chất tương đối với cơ thể cân đối. khách bụng mông to, hoặc eo nhỏ nên tăng hoặc lùi 1 size \n- Quần k kèm đai. đơn hàng từ 250k tặng đai lưng\n------------------------------------------------\n**FASHION DUONGHOA CAM KẾT\n+ Chất lượng và mẫu mã sản phẩm giống với hình ảnh và là bản quyền của shop.\n+ Chất liệu có độ dày dặn,mềm mịn, siêu mát, thấm hút mồ hôi nhanh, quan trọng độ bền màu cao\n+ Quần được kiểm tra kỹ, cẩn thận và tư vấn nhiệt tình \n+ Hàng có sẵn, giao hàng ngay khi nhận được đơn \n+ Hoàn tiền nếu sản phẩm không giống với mô tả\n+ Chấp nhận đổi hàng khi size không vừa\n+ Giao hàng trên toàn quốc, nhận hàng trả tiền', 120, 1, 2, 245),
(5, 'Đầm Body Nữ Dáng Dài Đuôi Cá Len Tăm, Váy ôm body sexy Hai Dây 3 Màu tôn dáng cực đỉnh( có bigsize)', 235000, 'Đầm Body Nữ Dáng dài, Váy ôm body sexy Hai Dây 3 Màu tôn dáng cực đỉnh 030, Váy Đuôi Cá\n❤Vải Len Tăm Xịn❤️\nsize\ns dưới 50kg \nm 51-55kg\nL 56-60kg\nXL 61-68kg\nxxl 69-75kg\nbảng size tuỳ theo chiều cao, ib shop để được tư vấn kĩ hơn ạ\n=>> LƯU Ý:\n+ Khách đặt hàng online sẽ nhận được hàng sau khoảng 1-3 ngày làm việc tùy theo khoảng cách và đơn vị vận chuyển. \r\n+ Mọi thắc mắc, góp ý về sản phẩm, giao hàng vui lòng liên hệ với Hotline để được hỗ trợ trực tiếp và nhanh nhất.\n+ Đối với các mặt hàng đổi trả, vui lòng liên hệ và cung cấp hình ảnh cũng như chi tiết lỗi để chuyên viên bên shop đánh giá, khắc phục đảm bảo quyền lợi cho quý khách.\n+ Các mặt hàng bị lỗi hoặc không ưng , khách vui lòng CHAT hoặc liên hệ Hotline với shop, trước khi đánh giá shop nhé! Shop sẽ hỗ trợ đổi trả hàng cho khách ạ \nZ@.l.0 : 032.5.7.9.8.436', 221, 2, 2, 46),
(6, 'Váy Sơ Mi Khoá Kéo Cổ Đức Đũi Nhật Siêu Nữ Tính (Có Bigsize) 188', 88000, 'Váy Sơ Mi Khoá Kéo Cổ Đức Đũi Nhật Siêu Nữ Tính (Có Bigsize) 188 \nVáy 3 Màu xanh cốm, đen , trắng ( riêng màu trắng 2 lớp để không bị lộ nội y\nsize s 40-50kg eo 66cm\nsize m 51-55kg eo 70cm\nsize l 56-60kg eo 74cm\nsize xl 61-66kg eo 78cm\nsize xxl 67-73kg eo 83cm\nsize 3xl 74-80kg eo 87cm', 123, 2, 2, 224),
(7, 'Apple iPhone 14 Pro Max 256GB - Chính hãng quốc tế LL/A', 32000000, 'Điện thoại iPhone 14 Pro Max sở hữu thiết kế nhỏ gọn cho khả năng cầm nắm thoải mái. Về thông số màn hình, điện thoại được trang bị màn hình có độ phân giải 2556 x 1179 pixel và mật độ điểm ảnh 2556 x 1179 pixel mang lại khả năng hiển thị ấn tượng.\n\nĐiện thoại được trang bị màn hình Dynamic Island siêu ấn tượng với khả năng tuy biến thành nhiều dạng theo điều khiển của người dùng. Nhờ đó người dùng có thể theo dõi và hiển thị nhanh các thông tin như cuộc gọi, chỉ đường, hẹn giờ,...\n\nTrên điện thoại iPhone 14 Pro Max, lần đầu Apple trang bị cho sản phẩm của mình camera cảm biến lớn. Theo đó, thiết bị đã được nâng cấp camera chính lên độ phân giải 48MP, kết hợp công ngệ pixel-pinning hỗ trợ nâng cao khả năng chụp hình trong điều kiện thiếu sáng.\n\nĐiện thoại được trang bị viên pin dung lượng lớn cùng con chip Apple A16, thiết bị mang lại thời gian phát video trực tuyến lên tới 20 giờ hoặc 75 giờ phát nhạc.\n\nBộ sản phẩm bao gồm: \n•        Điện thoại \n•        Dây sạc\n•        HDSD Bảo hành điện tử 12 tháng.\nThông tin bảo hành:\nBảo hành: 12 tháng kể từ ngày kích hoạt sản phẩm.\nKích hoạt bảo hành tại: https://checkcoverage.apple.com/vn/en/ \nHướng dẫn kiểm tra địa điểm bảo hành gần nhất:\nBước 1: Truy cập vào đường link https://getsupport.apple.com/?caller=grl&locale=en_VN \nBước 2: Chọn sản phẩm.\nBước 3: Điền Apple ID, nhập mật khẩu.\nSau khi hoàn tất, hệ thống sẽ gợi ý những trung tâm bảo hành gần nhất.\nQúy khách vui lòng đọc kỹ hướng dẫn và quy định trên các trang được Apple công bố công khai, Shop chỉ có thể hỗ trợ theo đúng chính sách được đăng công khai của thương hiệu Apple tại Việt Nam,', 3000, 1, 4, 224),
(8, 'Điện Thoại Samsung Galaxy A04e (3GB/64GB)- Hàng Chính Hãng', 23000000, 'Chào mừng ~~~~\nKhuyến mãi lớn!!!! Chất lượng tốt nhất trực tiếp từ nhà máy, giá tốt nhất, dịch vụ tốt nhất!\nCửa hàng của chúng tôi đang cung cấp các khuyến mãi và phiếu giảm giá. Sản phẩm này cũng tham gia.\nChất liệu: TPU\nMàu: Đỏ, vàng.Silver.Green.Black.\nKích thước: 4.7 inch, 5.5 inch, 5.8 inch,6.1 inch, 6.5 inch.\nChức năng: Chống bụi bẩn, Chống bẩn, Mềm mại.Mỏng\nChất liệu: Mạ mờ trong suốt Vỏ mềm\nCách bán hàng: Bán buôn và bán lẻ\n100% hàng mới, chất lượng cao.\nTương thích với: Đối với iPhone 7 8 6 6s Plus 7Plus X XS XR XS Max 11 Pro\nĐóng gói: gói opp\nTính năng: Vỏ bảo vệ cho iPhone 7 8 6 6s Plus 7Plus X XS XR XS Max\nKhuôn mẫu thích hợp 1: Đối với vỏ silicon iPhone 6 Plus\nMoldel 2 thích hợp: Đối với Ốp lưng mềm iPhone 6S Plus\nMoldel 3 phù hợp: Đối với Ốp lưng iPhone 7 Plus Slim\nKhuôn mẫu 4 thích hợp: Đối với Ốp lưng mềm iPhone 8 Plus\nMoldel 5 thích hợp: Đối với vỏ hộp iPhone X\nKhuôn mẫu phù hợp 6: Đối với vỏ hộp iPhone XS Max\nKhuôn mẫu 7 thích hợp: Đối với vỏ ốp lưng iPhone XR\nMoldel 8 thích hợp: Đối với vỏ hộp iPhone XS\nKhuôn mẫu phù hợp 13: Cho iPhone 11 Pro 5.8 inch Case\nMoldel 14 thích hợp: Cho iPhone 11 6.1 inch Case\nKhuôn mẫu phù hợp 15: Đối với vỏ iPhone 11 Pro Max 6.5 inch\n', 2000, 1, 4, 224),
(9, 'Apple iPad Gen 9 10.2-inch (2021) Wi‑Fi 256GB- Hàng Chính Hãng [Futureworld- APR]', 14900000, 'Nội dung tính năng\nMạnh mẽ. Dễ sử dụng. Đa năng. iPad mới có màn hình Retina 10.2 inch tuyệt đẹp, chip A13 Bionic mạnh mẽ, camera trước Ultra Wide có tính năng Trung Tâm Màn Hình, tương thích với Apple Pencilvà Smart Keyboard.1 iPad giúp bạn dễ dàng làm được nhiều việc hơn nữa. Tất cả tính năng với mức giá ấn tượng.\nPháp lý \nỨng dụng có sẵn trên App Store. Nội dung được cung cấp có thể thay đổi.\n1Phụ kiện iPad được bán riêng. Khả năng tương thích tùy thuộc thế hệ sản phẩm.\n\nTrong hộp gồm:\n\niPad\n\nLightning to USB-C Cable\n\n20W USB-C Power Adapter', 350, 2, 4, 245),
(10, 'Balo Fortune Mouse laptop phối màu nhiều ngăn B197', 155000, '1. Balo Fortune Mouse laptop phối màu nhiều ngăn B197\n2. THÔNG SỐ CHI TIẾT :\n\n• Chất liệu: Vải bố\n• Kích thước: \n44x30x14cm\n• Xuất xứ: Việt Nam\n• Bảo hành: Khóa kéo và đường chỉ\n• Thời gian bảo hành: 6 tháng\n• Bộ sản phẩm đầy đủ: 1x túi\n• Nhãn hiệu: Fortune Mouse\n\n✔️ THÔNG TIN THƯƠNG HIỆU\n\nFortune Mouse - Ra đời từ năm 2015 với niềm đam mê thời trang, Fortune Mouse là thương balo, túi xách, áo thun dành cho giới trẻ. Với chất lượng, uy tín và đổi mới ko ngừng, Fortune Mouse luôn đem đến cho khách hàng những sản phẩm hợp thời trang, theo xu hướng hiện đại, tiện lợi với giá thành phù hợp. Sự hài lòng của khách hàng là niềm vui của chúng tôi. \n✔️THÔNG TIN BẢO HÀNH:\n💎 Đổi trả miễn phí trong vòng 7 ngày đối với bất cứ lỗi từ nhà sản xuất.\n💎 Bảo hành 1 tháng hoàn toàn miễn phí các lỗi:	\n	+ Hư dây kéo\n	+ Đứt quai\n	+ Sút chỉ\n	+ Hư đầu khóa kéo\n💎Các trường hợp không nhận bảo hành hoặc bảo hành có tính phí trong 6 tháng :\n        + Sản phẩm đã quá thời hạn 1 tháng bảo hành miễn phí \n	+ Các trường hợp bị rách vải, hư khóa kéo sẽ hỗ trợ bảo hành tùy tình trạng lỗi của sản phẩm\n	+ Không bảo hành phẩn vải simili, ép nhiệt, giả da\n\nĐặc điểm nổi bật\n\n- Kích thước 42cm x 30cm x 13cm.\nKích thước không quá lớn nhưng kích thước đủ để bạn chứa tất cả những vật dụng cần thiết tiện lợi khi đi du lịch, chơi thể thao, đi học, đi làm… Những ngăn nhỏ giúp bạn thỏa mái để những vật nhỏ như chìa khóa, cart, thẻ ATM…\n- Thiết kế hiện đại, tiện dụng\nThiết kế mang hơi hướng hiện đại, vừa đơn giản, vừa sang trọng. Sản phẩm chắc chắn sẽ khiến bạn trở nên tươm tất, phong cách và đẳng cấp khi đi du lịch, đi chơi thể thao hay đi học.\n- Chất liệu DA chuyên dụng cao cấp\nBalo HARAS được gia công bằng chất liệu DA đảm bảo độ bền chắc theo thời gian. Loại chất liệu này góp phần hạn chế tối đa tình trạng sờn cũ, phai màu sau một thời gian dài sử dụng.\n- Đường may tỉ mỉ, chắc chắn\nSản phẩm được chế tác bằng những đường may tỉ mỉ và chắc chắn, không chỉ mang đến độ bền mà còn mang đến tính thẩm mỹ, tinh tế cao. Phần dây đeo và tay xách được may bằng kỹ thuật gấp mép dây viền, vững chắc.', 249, 1, 3, 245),
(11, 'Balo Nam Nữ Thời Trang Besti, Bao Đi Học, Balo Laptop, Máy Tính 14 inch Chất Liệu Cao Cấp Chống Nước', 195000, '1. Balo Fortune Mouse laptop phối màu nhiều ngăn B197\n2. THÔNG SỐ CHI TIẾT :\n\n• Chất liệu: Vải bố\n• Kích thước: \n44x30x14cm\n• Xuất xứ: Việt Nam\n• Bảo hành: Khóa kéo và đường chỉ\n• Thời gian bảo hành: 6 tháng\n• Bộ sản phẩm đầy đủ: 1x túi\n• Nhãn hiệu: Fortune Mouse\n\n✔️ THÔNG TIN THƯƠNG HIỆU\n\nFortune Mouse - Ra đời từ năm 2015 với niềm đam mê thời trang, Fortune Mouse là thương balo, túi xách, áo thun dành cho giới trẻ. Với chất lượng, uy tín và đổi mới ko ngừng, Fortune Mouse luôn đem đến cho khách hàng những sản phẩm hợp thời trang, theo xu hướng hiện đại, tiện lợi với giá thành phù hợp. Sự hài lòng của khách hàng là niềm vui của chúng tôi. \n✔️THÔNG TIN BẢO HÀNH:\n💎 Đổi trả miễn phí trong vòng 7 ngày đối với bất cứ lỗi từ nhà sản xuất.\n💎 Bảo hành 1 tháng hoàn toàn miễn phí các lỗi:	\n	+ Hư dây kéo\n	+ Đứt quai\n	+ Sút chỉ\n	+ Hư đầu khóa kéo\n💎Các trường hợp không nhận bảo hành hoặc bảo hành có tính phí trong 6 tháng :\n        + Sản phẩm đã quá thời hạn 1 tháng bảo hành miễn phí \n	+ Các trường hợp bị rách vải, hư khóa kéo sẽ hỗ trợ bảo hành tùy tình trạng lỗi của sản phẩm\n	+ Không bảo hành phẩn vải simili, ép nhiệt, giả da\n\nĐặc điểm nổi bật\n\n- Kích thước 42cm x 30cm x 13cm.\nKích thước không quá lớn nhưng kích thước đủ để bạn chứa tất cả những vật dụng cần thiết tiện lợi khi đi du lịch, chơi thể thao, đi học, đi làm… Những ngăn nhỏ giúp bạn thỏa mái để những vật nhỏ như chìa khóa, cart, thẻ ATM…\n- Thiết kế hiện đại, tiện dụng\nThiết kế mang hơi hướng hiện đại, vừa đơn giản, vừa sang trọng. Sản phẩm chắc chắn sẽ khiến bạn trở nên tươm tất, phong cách và đẳng cấp khi đi du lịch, đi chơi thể thao hay đi học.\n- Chất liệu DA chuyên dụng cao cấp\nBalo HARAS được gia công bằng chất liệu DA đảm bảo độ bền chắc theo thời gian. Loại chất liệu này góp phần hạn chế tối đa tình trạng sờn cũ, phai màu sau một thời gian dài sử dụng.\n- Đường may tỉ mỉ, chắc chắn\nSản phẩm được chế tác bằng những đường may tỉ mỉ và chắc chắn, không chỉ mang đến độ bền mà còn mang đến tính thẩm mỹ, tinh tế cao. Phần dây đeo và tay xách được may bằng kỹ thuật gấp mép dây viền, vững chắc.', 549, 2, 3, 245),
(12, 'Đồng Hồ Nam Crnaira Japan C3079 Siêu Mỏng Dây Thép Lụa Cao Cấp', 1290000, 'THÔNG TIN NỔI BẬT\n\n•	Máy Siêu Mỏng, (hiện những đồng hồ đầy đủ chức năng này rất hiếm vì chi phí sản xuất rất cao)\n\n•	Kiểu dáng năng động và lịch lãm (phong cách doanh nhân châu âu)\n\n•	Chống nước sinh hoạt + Mặt kính Mineral rất trong và chồng trầy sinh hoạt\n•	Võ làm bằng thép cao cấp nên đeo rất chắc tay và tuyệt đối không bị gỉ sét.\n•	Cam kết giao sản phẩm 100% giống như hình ảnh và mô tả, có video thật do shop tự quay\n	Thông tin chi tiết :\n- Kiểu máy: Quartz\n- Chất liệu vỏ: Thép không gỉ\n- Chất liệu dây: Thép không gỉ\n- Chất liệu mặt trước: Kính cứng pha khoáng, tráng shaphire\n- Kích thước mặt: 40 x 6 mm (Rộng x dày)\n- Kích thước dây: 20 x 230mm (Rộng x dài)\n- Độ chịu nước: 3ATM – Rửa tay, đi mưa, rửa xe\n- Phù hợp đeo đi làm, đi học, dạo phố, xem phim, dự tiệc\n- Bảo hành: 6 tháng\n	BỘ SẢN PHẨM BAO GỒM \n	Đồng hồ chính hãng 100%\n	Tặng kèm pin dự phòng (trị giá 60k)\n	Thẻ bảo hành \n❤ Dành tặng Voucher giảm 10% khi mua sản phẩm của shop cho những khách hàng thân thiết. (Khách hàng mua trên 3 đơn hàng hoặc đơn hàng trị giá 500k trở lên)\n❤ Quy định Bảo hành: đổi trả trong 7 ngày nếu hàng bị lỗi do nhà sản xuất như là hết pin, rớt kim, hư khóa, đồng hồ không chạy. \nBảo hành pin và máy trong 6 tháng. Bị bất cứ vấn đề gì bạn cứ inbox shop sẽ luôn tư vấn và hỗ trợ bạnn\n❤ Thời gian giao hàng : từ 1-5 ngày tùy tỉnh , huyện hay nội thành Giao nội tỉnh HCM – HN thường nhanh hơn, tỉnh và huyện thường lâu hơn 1 chút \n❤ Về size , dây đồng hồ phù hợp cho khách : Tất cả đồng hồ tại shop khách đều có thể cắt ( gỡ mắt) cho vừa với tay khách nhé . Nếu không tự làm ở nhà được thì khách có thể mang ra quầy đồng hồ gần nhất, thợ sẽ cắt cho khách. Phí tầm 10k VN', 110, 2, 5, 5),
(13, 'Đồng hồ đeo tay thạch anh có lịch hàng ngày dây đeo bằng thép không gỉ thời trang nam', 2900000, 'Chú ý đếnCác sản phẩm rẻ nhất cùng chất lượng.Tất cả các sản phẩm là trên tay.Tất cả các hình ảnh thực tế.Tất cả các sản phẩm có trong kho trừ khi nó được đánh dấu đã được bán hết.\n\nVui lòng chọn các biến thể màu sắc sau đó đặt hàng Vì chúng tôi không thể chấp nhận yêu cầu nhận xét hoặc màu tin nhắn. \n\nNếu biến thể chỉ ra Random hoặc Assorted, có nghĩa là chúng tôi quyết định màu sắc)Chúng tôi có thể không hủy một số đơn đặt hàng, hãy chắc chắn rằng sau đó đặt hàng.Hỗ trợ bán lẻ và bán buôn. \"Nếu có dấu \"wholesale \")\n\nGiới tính Phong cách: Thời trang & Giản dịLoại vật liệu ban nhạc: Thép không gỉChiều dài ban nhạc: 23 CMĐộ dày vỏ: 0,8 CM\n\nĐường kính quay số: 4.0 CM\nChất liệu vỏ hợp kimChiều rộng dây: 2 CMPhong trào: Đồng hồ thạch anh\nSố mô hình: MB90Gói Loại 1: Đồng hồ 1PC có pinLoại 2: Đồng hồ 1 CÁI có Pin Vòng đeo tay 1 CÁIHộp KHÔNG BAO GỒM', 443, 1, 5, 5),
(14, 'Giày da mũi tròn phong cách Nhật Bản thời trang cho nam giày nâng chiều cao nam 2022', 285000, 'Kiểu này là size giày da, vui lòng chọn nhỏ hơn giày thể thao 1 size.\n\nVí dụ: 41 cho giày thể thao, 40 cho giày da này,\nBạn có thể thêm 1 yard cho bàn chân rộng và bàn chân mập\n\nThời gian giao hàng dự kiến cho sản phẩm này là từ 7-9 ngày\n\nThời gian ra mắt: 2023\n\n  Kiểu mũi giày: mũi tròn\n\n  Kiểu nút gài: dây buộc\n\n  Chất liệu mặt giày: PU\n\n  Chất liệu bên trong mặt giày: PU\n\n  Phong cách: giày mang ngoài trời, thường ngày\n\n  Kích thước phù hợp: nếu bạn có bất kỳ câu hỏi nào, xin vui lòng liên hệ với bộ phận chăm sóc khách hàng, bộ phận chăm sóc khách hàng sẽ phục vụ bạn tận tình \n\n EU 35 = chiều dài bàn chân 22.5 cm EU 36 = chiều dài bàn chân 23 cm\n\n EU 37 = chiều dài bàn chân 23.5 cm EU 38 = chiều dài bàn chân 24 cm\n\n EU 39 = chiều dài bàn chân 24.5 cm EU 40 = chiều dài bàn chân 25 cm\n\n EU 41 = chiều dài bàn chân 25.5 cm EU 42 = chiều dài bàn chân 26 cm\n\n\n\n ————— Vui lòng đọc kỹ phần giới thiệu về cửa hàng trước khi đặt hàng ———-——-\n\n 🧸 【Lưu ý khi đặt hàng】\n\n Về quang sai màu: Do ánh sáng chụp, màn hình hiển thị của mỗi người là khác nhau, sẽ có một số khác biệt nhỏ giữa hình ảnh và sản phẩm thực tế.\n\n Kích thước phù hợp: Kích thước nêu trên là thông tin tham khảo dựa trên kinh nghiệm bán hàng thông thường và bạn nên xem cẩn thận. Vui lòng tham khảo bảng kích thước phẳng để biết thêm chi tiết. Nếu kích thước không rõ ràng, bạn nên tham khảo ý kiến của dịch vụ chăm sóc khách hàng.', 329, 1, 6, 245),
(15, 'Đầm tiểu thơ xinh xắn HOT TREND Váy trắng đính nơ Váy dáng dài, cổ vuông siêu xinh cho nàng', 89000, 'Đầm tiểu thơ xinh xắn ⚡ HOT TREND ⚡ Váy dáng dài, cổ vuông siêu xinh cho nàng\n\n⚠️ CAM KẾT 1 ĐỔI 1 TRONG 7 NGÀY NẾU CÓ LỖI CỦA SHOP ⚠️\n\nGiao hàng tận nơi trên toàn quốc, Nhận hàng nhanh chóng tại nhà.\n\n======================\n\n⭐️ Thông tin sản phẩm:\n\n- Xuât xứ: Trung Quốc\n- Chất liệu: Sợi tổng hợp\n Váy dáng dài:\n\n- Size: S, M, L, XL,\nNgực: 86 - 89 - 92 - 95 - 98\nỐng tay: 26 - 26 - 26 - 28 - 28\nDài váy: 108 - 109 - 110 - 111 -111\n- Màu sắc: Be, Trắng\n\nVáy dáng ngắn:\n\n- Size: S, M, L, XL, \nNgực: 84 - 87 - 90 - 93 - 96\nDài váy: 87 - 88 - 89 - 90 - 91 \nTay: 25 - 26 - 26 - 26 - 26\n- Mùa sắc: Be, trắng\n\n⭐️ CHÚNG TÔI CAM KẾT BÁN HÀNG\n\n✅ Tất cả các mặt hàng đều qua kiểm định và thử chất lượng, không bán hàng trôi nổi, phương châm của chúng tôi là mang những điều tốt đẹp nhất đến với khách hàng!\n✅ Sản phẩm luôn kèm ảnh thật và video shop tự quay\n✅ Đổi trả trong vòng 7 ngày nếu hàng hỏng lỗi\n✅ Tất cả các thông tin về Shop đều được công khai \n✅ Luôn tư vấn tận tình để mang sản phẩm phù hợp nhất đến với bạn\n✅ Hỗ trợ online 24/24\n✅ Tiếp nhận phản ảnh và xử lí tích cực\n✅ Đặt hàng Bình luận trực tiếp vào sản phẩm hoặc inbox cho shop, sẽ có nhân viên trả lời ngay!', 246, 1, 2, 245),
(16, 'Quần âu nam , Quần tây nam hàn quốc dáng baggy ống suông đứng rộng vải dầy co dãn thương hiệu cao cấp Helloyou', 139000, 'Quần tây nam, quần âu Nam hàn quốc baggy ống đứng vải Hàn Cao Cấp Thương hiệu Helloyou\n- Quần tây nam hàn quốc Chất vải cotton lạnh hàn cao cấp chính phẩm được nhập tại quảng châu và sản xuất tại nhà máy dệt may Hà Nội cho chất lượng sản phẩm cao cấp.\n- Quần vải nam baggy ống rộng dáng hàn quốc là sản phẩm không thể thiếu trong tủ đồ của anh em yêu trang phục đồ âu lịch sự nhẹ nhàng thích phong cách goodboy tinh tế.\n\nHelloyou mang theo giấc mơ xây dựng một thương hiệu thời trang với chất lượng cao cấp và MỨC GIÁ HỢP LÍ để bạn có thể tự do thể hiện phong cách riêng của mình 🙆\nHÃY ỦNG HỘ GIẤC MƠ CỦA TỤI MÌNH NHÉ! \n\n✔️ TẠI SAO NÊN CHỌN MUA QUẦN TÂY ÂU NAM HÀN QUỐC   tại HELLOYOU ?\n\n- Chất liệu: Coton lạnh Hàn cao cấp nhập khẩu\n- Form dáng: dáng hàn quốc Baggy ống suông rộng đứng dáng\n- GIÁ CẢ : Chúng tôi trực tiếp sản xuất với số lượng lớn. Nên chất lượng quần cao cấp và giá thành rẻ cho ae trải nghiệm.\r\n- CAM KẾT HÀNG NHƯ HÌNH CHỤP - ĐỔI TRẢ, HOÀN TIỀN NẾU THẤY KHÔNG HÀI LÒNG.\n- HÃY INBOX CHO SHOP KHI SẢN PHẨM CÓ VẤN ĐỀ ( ĐỔI SIZE, SP LỖI...) ĐỂ HỖ TRỢ TRƯỚC KHI ĐÁNH GIÁ.\n\n👖Size 27  (Từ 44 - 49kg Cao Dưới 1m71)\n👖 Size 28  (Từ 50 - 54kg Cao Dưới 1m75)\n👖 Size 29 (Từ 55 - 58 kg Cao Dưới 1m80) \n👖 Size 30  ( Từ 59- 62 kg Cao Dưới 1m80) \n👖 Size 31 (Từ 63 - 67 kg Cao Dưới 1m85)  \n👖 Size 32  (Từ 68 - 73 kg Cao Dưới 1m85)  \n👖 Size 34  (Từ 75 - 83 kg Cao Dưới 1m88)  \n👖 Size 36  (Từ 85 - 90 kg Cao Dưới 1m9) \n👖 Size 37  (Từ̛90 - 95 kg Cao Dưới 1m95)\n👖 Size 38  (Từ 96 - 100 kg Cao Dưới 1m95)\n👖 Size 39  (Từ 100 - 108 kg Cao Dưới 1m95)\n👖 Size 40  (Từ 108 - 120 kg Cao Dưới 1m95)\n\nNOTE : Hãy nhắn tin cho shop để được tư vấn size chuẩn nhất với bạn.', 126, 1, 1, 245),
(17, 'Áo khoác Jean bò Danisa chính hãng', 239000, '🙆🏻‍♀️🙆🏻‍♂️ ĐẾN VỚI “TAN” ĐỂ CÙNG CHÚNG TÔI TẠO NÊN PHONG CÁCH RIÊNG CỦA BẠN 🥰\n\n\n--------------------------------------------------\n\n\n⭕️ Đặt quyền lợi khách hàng lên hàng đầu, chúng tôi cam kết:\n\n “ KHÁCH HÀNG “\n\n👉🏻 Được kiểm tra trước khi nhận hàng và thanh toán.\n\n👉🏻 Đổi mẫu và size nếu không ưng ý.\n\n👉🏻 Form Unisex, nam nữ đều có thể mặc được\n\n👉🏻 Đủ size cho người từ 40kg-88kg\n\n--------------------------------------------------\n\nThông tin sản phẩm Áo khoác Jeans Đen Trơn Xịn \n\n- Chất liệu: Jeans ở thân áo chất mềm mịn không xù, dày dặn \n\n- Đường may tỉ mỉ, chắc chắn\n\n- Công dụng: mặc ở nhà, mặc đi chơi \n\n- Thiết kế hiện đại, trẻ trung, năng động. Dễ phối đồ\n\n- Đủ size: M - L - XL - XXL\n\n Sz M : 42-64Kg 1m5-m65 : \n\n Sz L : 65-73kg 1m66 -1m73\n\n Sz XL-: 74 - 79kg 1m74-1m84\n\nSz XXL: 80- 88kg 1m75 - 1m88\n\nSố Đo Áo size M : Ngực 112cm. Chiều Dài 70cm. Rộng vai 56cm \n\nTay áo 59cm \n\nsize L : Ngực 114cm . Dài Áo 72cm . Rộng vai 57cm . Tay áo 60cm \n\nsize XL: Ngực 116cm . Dài áo 74cm rộng vai 58cm Tay áo 61cm \n\nSize XXL: ngực 120cm .dài áo 76cm .rộng vai 60cm . Tay áo 61cm .\n\nHướng dẫn sử dụng sản phẩm Áo khoác Jeans \n\n- giặt bình thường \n\nT-A-N CAM KẾT\n\nSản phẩm Áo khoác Jeans 100% giống mô tả. Hình ảnh sản phẩm là ảnh thật do shop tự chụp và giữ bản quyền hình ảnh\n\nĐảm bảo vải chất lượng 100% cotton chuẩn xuất khẩu.\n\nÁo được kiểm tra kĩ càng, cẩn thận và tư vấn nhiệt tình trước khi gói hàng giao cho Quý Khách\n\nHàng có sẵn, giao hàng ngay khi nhận được đơn \n\nHoàn tiền nếu sản phẩm không giống với mô tả\n\nChấp nhận đổi hàng khi size không vừa\n\nGiao hàng trên toàn quốc, nhận hàng trả tiền \n\nHỗ trợ đổi trả theo quy định của Shopee ', 526, 2, 1, 245),
(18, 'Dép vải quai ngang đế hộp ( Vân chìm nam đế hộp szie 38/43 )', 499000, '🙆🏻‍♀️🙆🏻‍♂️ ĐẾN VỚI “TAN” ĐỂ CÙNG CHÚNG TÔI TẠO NÊN PHONG CÁCH RIÊNG CỦA BẠN 🥰\n\n\n--------------------------------------------------\n\n\n⭕️ Đặt quyền lợi khách hàng lên hàng đầu, chúng tôi cam kết:\n\n “ KHÁCH HÀNG “\n\n👉🏻 Được kiểm tra trước khi nhận hàng và thanh toán.\n\n👉🏻 Đổi mẫu và size nếu không ưng ý.\n\n👉🏻- dép đế hộp vân chìm quai vải\n\n-Dép nam quai ngang đế hộp 2 lớp cho nam và nữ\n\n-sản phẩm được gia công rất cẩn thận \n\n-sản phẩm có đủ size đủ số từ 38/43 cho cả nam và nữ\n\n-đế được làm bằng ca su đúc quai làm bằng vải dệt \n\n-độ bền rất cao đế và dép có trọng lượng khoảng 500g\n\n-đế chống trơn trượt và có độ ma sát rất tốt\n\n-mua hàng đặt hàng sau 2/3 ngày mình cảm ơn các bạn đã quan tâm đến sản phẩm bên mình ', 296, 1, 6, 245),
(19, 'GIÀY ĐỐC NƠ 2 MÀU ĐEN- NÂU ( Vân chìm nữ đế hộp full size )', 425000, '🙆🏻‍♀️🙆🏻‍♂️ MẪU  MỚI VỀ HOT NHẤT CỦA NĂM\n\nCÓ 2 màu : Nơ nâu,nơ đen\n\n\nSIZE 35-39 FORM CHUẨN\n\n#sỉ____79kkkk\n\nRi #75k \n\n\nSll ib zalo o986323337', 290, 2, 7, 245),
(20, 'Dép Sục Hà Mã Mắt To Dễ Thương Hot Trend - Ảnh thật 100%', 75000, '🙆🏻‍♀️🙆🏻‍♂️ MẪU  MỚI VỀ HOT NHẤT CỦA NĂM\n\nCÓ 2 màu : Nơ nâu,nơ đen\n\n\nSIZE 35-39 FORM CHUẨN\n\n#sỉ____79kkkk\n\nRi #125k \n\n- Dép làm từ nhựa EVA cao cấp, siêu nhẹ, cực kỳ dẻo dai, khả năng chịu lực cao và hoàn toàn không độc hại\n\n\n- Đảm bảo đi cực kỳ êm chân, cực bền với thiết kế bề mặt giúp đôi chân luôn thoáng mát, không tạo mùi hôi chân\n\n- Đế thiết kế ma sát, chống trơn trượt, chống nước cực tốt Mọi người đi  mưa lội nước thoải mái mà không lo hỏng dép nhé ạnSll ib zalo o986323337', 140, 1, 7, 245),
(21, 'Bàn Phím CƠ ZIYOU K3 Luxury Cao Cấp, Phím Gõ Êm Sử Dụng Trục Cơ Red Switch, Led 16,5 Triệu Màu 10 Chế Độ, Bảo Hành 12t', 1225000, 'ZIYOU CAM KẾT\n\n\n-------------\n\n\n\nTOÀN BỘ SẢN PHẨM GỬI ĐI ĐỀU ĐÃ ĐƯỢC KIỂM TRA KỸ 100% TRƯỚC KHI ĐÓNG GÓI\n\n\nCAM KẾT BẢO HÀNH ĐÚNG THEO THÔNG TIN\n\n\nHOÀN 100% TIỀN NẾU NHẬN HÀNG BỊ LỖI, GIAO NHẦM\n\n\nHIỆN TẠI CÓ RẤT NHIỀU SẢN PHẨM GIỐNG MẪU MÃ NHƯNG CHẤT LƯỢNG KÉM HƠN -> ZIYOU CAM KẾT LUÔN BÁN SẢN PHẨM CÓ CHẤT LƯỢNG TỐT NHẤT\n\n\n- Bàn phím cơ K3 Luxury trang bị đầy đủ các phím bấm cơ bản với hành trình phím rất đỗi quen thuộc, dễ dàng để người dùng mới tiếp cận và làm quen ngay từ lần đầu sử dụng.\n\n- Bàn Phím Có thể tùy chọn thay thế  keycaps theo sở thích cá nhân.\n\n- Bàn phím cơ sử dụng switch treo cho độ nảy, độ đàn hồi và độ nhạy cực tốt, Switch red tuổi thọ tốt lên đến 60 triệu lượt nhấn, đảm bảo bàn phím bền bỉ đồng hành cùng bạn trong suốt thời gian dài.\n\n- Dù là bàn phím gaming nhưng K3 Luxury lại có thiết kế khá đơn giản, trang nhã để bạn dễ dàng đặt nó trên bàn làm việc gia đình hoặc cả ở văn phòng, hay mang theo sử dụng khi ra ngoài.\n\n- Phím cơ quen thuộc độ trũng bề mặt vừa phải, chất liệu nhựa nhám thao tác chắc tay, thiết kế che chắn hiệu quả cho các bo mạch bên trong để ngăn nhiễm ẩm trong các tình huống bị đổ tràn nước.\n\n- tương thích với hệ điều hành Windows và MacOS, chiều dài dây nối 1.8 m dùng linh hoạt. Dây cáp nối usb-typeC có thể tháo rời tiện lợi.\n\n\n- sẽ mang đến những trải nghiệm thật ấn tượng cho từng tác vụ mà bạn sử dụng, làm việc hiệu quả hơn, chiến game thích thú hơn.\n\n\n\n- hiệu ứng led 10 chế độ nhày kết hợp màu sắc nên đến 16,5 triệu màu mang lại màu sắc tươi mới hiện đại hơn cho bàn phím của bạn.\n\n\n#banphimco#banphimled#redswitch#banphimgaming#banphimchoigame#banphimmaytinh', 740, 1, 8, 5),
(22, 'Chuột game có dây Logitech G203 Lightsync - Tùy chỉnh RGB, 6 nút lập trình, nhẹ', 129000, '- Hiệu ứng sóng màu Lightsync RGB với 16,8 triệu màu\n\n- Cảm biến từ 200dpi cho đến 8.000dpi (Phần mềm Logitech G HUB)\n\n- Kiểu dáng cổ điển thoải mái tự tin sử dụng\n\n- Hệ thống ứng lực nút bằng lò xo kim loại độc quyền Logitech G\n\n- Thương hiệu Logitech Thụy Sỹ\n\n- Bảo hành 1 đổi 1 trong vòng 2 năm\n\n==============================\n\nHIỆU ỨNG SÓNG MÀU LIGHTSYNC RGB\n\nChọn từ các màu sắc sống động, cài đặt lấy cảm hứng từ trò chơi và phương tiện, hay lập trình màu sắc của riêng bạn từ khoảng 16,8 triệu màu.\n\nCẢM BIẾN ĐẲNG CẤP GAMING 8.000DPI\n\nTheo dõi con trỏ chính xác và đạt hiệu suất phản hồi nhanh nhạy nhờ vào cảm biến cấp độ chơi game. Với độ nhạy có thể tùy chỉnh từ 200-8.000dpi, hãy chọn mức độ phù hợp với sở thích chơi của bạn. Sử dụng phần mềm Logitech G HUB của Logitech để lập trình lên tới 5 chế độ thiết lập sẵn.\n\nTHIẾT KẾ CỔ ĐIỂN, ĐƯỢC ƯA CHUỘNG RỘNG RÃI\n\nThiết kế sáu nút cổ điển đem đến cả sự thoải mái lẫn tự tin để bạn có thể khám phá, sáng tạo và chơi như ý muốn. Sử dụng phần mềm G HUB của Logitech để gán các lệnh trong trò chơi, điều khiển hệ thống hoặc tổ hợp phím và đơn giản hóa việc chơi game của bạn.\n\nNÚT ỨNG LỰC ĐƯỢC TỐI ƯU HÓA\n\nCác nút chính bên trái và phải có hệ thống ứng lực nút bằng lò xo kim loại độc quyền của Logitech G, đem đến sự chính xác khi nhấn nút và trải nghiệm đồng nhất - từ cú nhấp này đến cú nhấp khác.\n\nLOGITECH G HUB\n\nG102 được thiết kế để làm việc liền mạch với bất kỳ hệ thống nào, nhưng nếu bạn đang muốn tinh chỉnh các nút điều khiển , thì phần mềm tùy chỉnh tải về miễn phí rất dễ sử dụng và thiết lập. Phần mềm HUB G của logitech là bộ tùy chỉnh hoàn thiện, cho phép bạn cá nhân hóa ánh sáng, độ nhạy và các lệnh trên nút của chuột G102', 72, 1, 8, 5),
(23, '{LOẠI 1]KỆ ĐỂ giày chữ X MẪU MỚI-CAO CẤP 5 TẦNG', 229000, 'Kệ để giày dép chữ X thông minh có thể tháo lắp gấp gọn, kệ để đồ trang trí đa năng cao cấp\n\nThông tin sản phẩm\nTên sản phẩm : Kệ để giày dép chữ X tháo lắp\n\nDòng sản phẩm: Kệ để giày dép\n\n\n- Chất liệu: Nhựa PVC Chịu Lực cao cấp\n\n- Chất liệu chính: nhựa\n\n- Có hỗ trợ tùy chỉnh hay không: Hỗ trợ tùy chỉnh\n\n- Chiều sâu: 26cm\n\n- Phương pháp cài đặt: không đục lỗ\n\n- Phong cách: phong cách Bắc Âu\n\n- Màu sắc: Đa dạng\n\nĐẶC ĐIỂM NỔI BẬT:\n\n- Kiểu dáng chắc chắn, nhỏ gọn giúp tiết kiệm được tối đa diện tích nhà bạn.\n\n- Nhựa PVC rất chắc chắn để giầy dép th.oải mái không lọ kệ xập hay méo vẹo.\n\n- Kệ không chỉ đê giầy dép mà còn để được rất nhiều đồ vật tiện ích khác nhau và có thể treo 1 -số sản phẩm tiện dụng như ô túi xách\n\n- Kệ để giày dép 5 tầng thiết kế dạng lắp ghép, việc lắp vào, tháo ra rất nhanh chóng,\n\n dễ dàng di chuyển nhiều nơi, với nhiều mục đích khác nhau: giá sách, kệ để đồ, giá để giày…\n\n- Sản phẩm phù hợp -với mọi không g.ian, tiết kiệm diện tích sử dụng\n\n- Sản phẩm được ưa chuộng nhờ là,m bằng chất liệu nhựa cao  cấp và các thanh inox không gỉ, chịu lực, kiểu dáng trang nhã.\n\n- Kiểu dáng chắc chắn, nhỏ gọn giúp tiết kiệm được tối đa diện tích nhà bạn.', 132, 1, 9, 46),
(24, 'Kệ Treo Quần Ao , Giá Treo Quần Áo Đa Dạng Mẫu Mã Kích Thước Màu Sắc', 99000, '1. THÔNG TIN SẢN PHẨM : Kệ Treo Quần Ao , Giá Treo Quần Áo Đa Dạng Mẫu Mã Kích Thước Màu Sắc\n\n- Giá Treo Quần Áo Chữ A : Kích Thước 60x36x152      Màu Sắc  :  Trắng ,Nâu\n\n- Giá Treo Quần Áo Chữ  H  : Kich Thước 55x35x170    Màu Sắc  : Hồng , Xám , Nâu\n\n- Giá Treo Quần Áo Chữ L  :  Kích Thước 51x57x30x165  Màu Sắc  : Nâu , Trắng , Đen\n\n- Giá Treo Quần Áo Mẫu Mới : Kích Thước 40x110x150   Màu Sắc :Trắng , Đen\n\n- Cây Treo Quần Áo 3 Chân : Kích Thước   31x175          Màu Sắc : Trắng , Đen , Xám\n\n2. CÔNG DỤNG SẢN PHẨM : Kệ Treo Quần Ao , Giá Treo Quần Áo Đa Dạng Mẫu Mã Kích Thước Màu Sắc\n\n- Kệ thiết kế gồm 3 ngăn 4 tầng giúp sắp xếp nhiều đồ dùng, quần áo gia đình.\n\n- Ngoài quần áo, sản phẩm còn thuận tiện đặt để các loại chăn màn, túi xách, giày dép…\n\n- Khung bằng sắt sơn tĩnh điện chắc chắn, ngăn để đồ bằng vải không dệt bền đẹp.\n\n- Kiểu dáng nhỏ gọn, đẹp mắt, phù hợp với nhiều không gian nhà ở.\n\n- Kệ treo quần áo đa năng là sản phẩm mới, được thiết kế hiện đại, nhỏ gọn, tiện dụng chắc chắn với nhiều tầng giúp bạn treo và để được rất nhiều quần áo, chăn màn, túi xách,cùng các vật dụng gia đình.', 143, 1, 9, 245),
(25, 'Đồng Hồ LED Điện Tử Dây Silicone Chống Nước C16 Cho Trẻ Em', 79000, 'Mô tả:\n\nKích thước gần đúng tại tay: 40 * 34 * 13mm\n\nChiều dài dây đeo: 21 cm\n\nPin đồng hồ, có thể cung cấp năng lượng mạnh mẽ cho đồng hồ kỹ thuật số khi trẻ em đang tập thể dục.\n\nĐồng HỒ KỸ THUẬT SỐ CHẤT LƯỢNG CAO: Thiết kế mặt số thể thao thời trang cho trẻ em Hiển thị thời gian một cách kỹ thuật số, dễ dàng cho con bạn đọc\n\nDây đeo có thể điều chỉnh để vừa vặn thuận tiện và thoải mái cho cổ tay của con bạn. Đồng hồ trẻ em này hoàn hảo cho các hoạt động ngoài trời\n\n\nNhững chiếc đồng hồ trẻ em này được làm từ vật liệu thân thiện với môi trường và an toàn cho con bạn\n\n\n\nĐóng gói:\n\n1 * Đồng hồ trẻ em (bao gồm pin nút)\n\n\nGhi chú:\n\n\n1. Nếu bạn có bất kỳ vấn đề gì, bạn có thể trò chuyện với chúng tôi và chúng tôi sẽ trả lời bạn càng sớm càng tốt.\n\n2. Dịch vụ sau bán hàng được cung cấp và vui lòng trò chuyện với chúng tôi.\n\n3.Nếu bạn hài lòng với sản phẩm của chúng tôi, vui lòng cho chúng tôi đánh giá năm sao (★★★★★), Cảm ơn\n\n', 478, 1, 5, 5),
(26, 'Balo Học Sinh Tiểu Học Cho Bé Gái Bé Trai Balo Gấu Trẻ Em Cấp 1', 98000, '❤️❤️CÁC MẸ ƠI! \n\n❤️❤️BALO CHO BÉ HOT NHẤT NĂM HỌC 2020 VỀ CHO CÁC BÉ NHÀ MÌNH RỒI Ạ☘️☘️\n\n↔️Ba lô chống nước SM BABY hình gấu:\n\nThông tin sản phẩm:\n\n-Kích thước size to:40*30*20cm.\n\n- Cặp có form hộp ,thiết kế với cấu tạo phù hợp với đường cột sống của bé, cơ chế chống gù hiệu quả.\n\n- Có phát quang bảo vệ bé vào ban đêm.\n\n- Chất liệu chống thấm, chống vi khuẩn, chống mùi , chống mài mòn, chống sốc, thoát khí lưng, quai đeo.\n\n- Cặp có quai đeo bền, thoát khí và có khả năng chịu lực tốt, có thể điều chỉnh phù hợp với từng bé\n\n​- Có dây kéo và khóa kéo chắc chắn hai bên , kéo mượt mà dễ dàng.\n\n- Kích thước :   Phù hợp với học sinh từ lớp 1 đến lớp 5.\n\n- Trọng lượng 0,6 kg ; rất nhẹ nhàng cho bé.\n\n- Hàng thật như hình 100% nha mọi người. \n\n- Có 5 màu để bạn lựa chọn: Xanh dương, xanh da trời, đỏ, hồng,xanh lá.\n\n\n=============================\n\n', 93, 1, 3, 46),
(27, 'Kính cường lực oppo reno 8T 5G màn cong - Dán keo UV cao cấp', 49000, 'Kính cường lực oppo reno 8T 5G màn cong - Dán keo UV cao cấp [Đèn UV]\n\n❤️ HƯỚNG DẪN SỬ DỤNG:\n\n\n👉- Bước 1: Vệ sinh màn hình điện thoại bằng bộ vệ sinh màn hình thật sạch\n\n👉- Bước 2: Bóc lớp nilon ở dưới tấm kính ra lấy được tấm kính trong suốt\n\n👉- Bước 3: Đổ keo vào chính giữa màn hình hoặc đổ chính giữa của  2 nửa màn hình, tầm gần hết lọ keo là đủ cho 1 máy. \n\n☠️☠️☠️: LƯU Ý: SAU KHI ĐỔ KEO, ĐỂ KÍNH LÊN, KHÔNG ĐƯỢC DÙNG NGÓN TAY DI LẠI KÍNH NẾU ĐẶT KHÔNG CÂN, NHƯ VẬY SẼ LÀM KEO TRÊN BỀ MẶT BỊ LOANG LỔ\n\n👉- Bước 4:  Đợi tầm 2 phút cho keo nước tràn  phủ kín màn hình máy Samsung lưu ý ko tì lên trên bề mặt màn hình mà để keo tự chạy hết, nếu keo chẩy ra khỏi viền màn hình,  dùng  khăn khô lau sạch, chỉnh cho tấm dán đặt cân chính giữa màn hình\n\n👉- Bước 5: Bật đèn UV sáng bằng cách: Ở 2 đầu có lỗ cắm type c. Bạn chỉ cần dùng dây sạc type C cắm vào là đèn sáng\n\n👉- Bước 6: Dùng đèn chiều tia UV chia màn hình máy thành 4 phần sau đó chiếu mỗi phần 20 giây, làm 2 lượt, đảm bảo keo khô hết, vô cùng chắc chắn.\n\n\n👍Chúc các bạn thành công!\n\n', 268, 1, 4, 5),
(28, 'Củ sạc nhanh 2 cổng USB có đèn led chất lượng cao', 249000, 'Mô tả\n\nChỉ cần cắm cáp USB và cắm bộ chuyển đổi vào tường.\n\nĐầu cắm sạc USB kép nhỏ gọn, nhẹ, di động, thời trang, dễ bảo quản.\n\nSạc cho hầu hết các mẫu điện thoại và máy tính bảng: nó &#39; s phù hợp với các thiết bị điện tử và mô hình và pin dự phòng.\n\nNó thêm phong cách cho phòng khách của bạn, cho phép bạn mang theo đơn đặt hàng và hài hòa vào cáp sạc của mình.\n\nCổng USB kép với tổng dòng điện định mức là 2Amperes (2A), không cần chờ đợi, có thể sử dụng đồng thời để sạc hai thiết bị.\n\n\nThông tin chi tiết:\n\nLoại: phích cắm sạc USB kép.\n\nKích thước: 5 * 5 * 5cm.\n\nMàu sắc: Như hình ảnh hiển thị.\n\nPhích cắm: phích cắm của Hoa Kỳ.\n\n\nGhi chú:\n\nCó thể có một chút biến dạng màu sắc do độ phân giải máy tính khác nhau.\n\nCó thể có lỗi nhỏ do các phép đo tay khác nhau.\n\n\nGói hàng bao gồm:\n\n\n1 * Đầu cắm sạc USB kép.\n\n\n\n* Chào mừng bạn đến với cửa hàng VOLLTER, chúng tôi rất vui được phục vụ bạn ở đây và nhằm mục đích cung cấp cho bạn trải nghiệm mua sắm tốt nhất.\n\n* Chúng tôi cung cấp nhiều sản phẩm thời trang bao gồm cả đồ gia dụng và sinh hoạt và nhiều sản phẩm khác. Hãy theo dõi chúng tôi để cập nhật thông tin mới nhất.\n\n*Mọi Vấn đề, xin vui lòng trò chuyện với chúng tôi. Chúng tôi sở hữu một loạt các sản phẩm với chất lượng cao và giá cả phải chăng\n\n* Chúng tôi chủ yếu kinh doanh, gia đình và cuộc sống, ngoài trời và thể thao, sản phẩm điện tử 3c, v.v.\n\n\n*Bạn Có thể tiết kiệm nhiều hơn khi mua hàng với số lượng lớn ~ Chúng tôi cung cấp các sản phẩm với chất lượng cao và giá cả phải chăng.\n\n* Sản phẩm của chúng tôi sẽ được vận chuyển ra nước ngoài trong vòng 3-5 ngày và sẽ mất 7-15 ngày để đến nơi. xin phép được miễn.\n\n* Chúng tôi sẽ cập nhật danh sách sản phẩm kịp thời và cam kết tất cả các sản phẩm là 313% mới. \n\n\n* Để biết thêm nhiều thông mới vui lòng theo dõi cửa hàng của chúng tôi.', 548, 1, 4, 245),
(29, 'Micro cho mọi loại loa - cho loa kéo P88 P89', 165000, 'Với thiết kế khá nhỏ gọn, vỏn vẹn trong lòng bàn tay cho bạn dễ dàng sử dụng, với thiết kế này sản phẩm phù hợp với mọi lứa tuổi rất thuận tiện dễ dàng sử dụng.\n\nHệ thống tay Micro được làm bằng hợp kim đặc biệt phủ nano chống xước, chống ẩm, chống thấm mồ hôi đảm bảo cho người dùng luôn được thoải mái nhất trong quá trình sử dụng.\n\nHệ thống linh kiện được chọn lọc kỹ lưỡng với chụp Micro làm bằng thép chống gỉ cứng cáp, đảm bảo chống méo nếu lỡ sản phẩm vô tình bị rơi bảo vệ cho vỉ mạch được an toàn nhất. Và với lọc mút âm được làm chất liệu vô cùng cao cấp giúp sản phẩm dễ dàng nhận tín hiệu âm thanh đầu vào và qua lọc mút cho âm thanh trong trẻo mềm mại nhất.\n\nVới khả năng chống rú rít vô cùng tốt sản phẩm mang đến cho bạn một giọng hát vô cùng trong trẻo mềm mại nhất', 122, 1, 10, 245),
(30, 'Loa Tắm Ngôn Ngữ Cho Bé, Loa Craven CR 853 3 Pin Chính Hãng', 65000, '🍒🍒 Tắm Ngôn Ngữ là gì?\n\nTắm Ngôn Ngữ có 2 phương pháp: \n\n ⭐ Nghe vô thức - còn được gọi là “tắm ngôn ngữ”, là phương pháp tuyệt vời để trẻ 0-3 tuổi bắt đầu tiếp xúc và học ngôn ngữ, phương pháp này còn có thể duy trì và nâng cao khả năng ngoại ngữ cho bất kỳ ai ở mọi lứa tuổi. Với phương pháp này, bố mẹ có thể cho bé nghe tiếng Anh cho bé nghe một cách vô thức, vào bất cứ thời điểm nào trong ngày.\n\n⭐ Nghe có chủ đích là phương pháp nghe kết hợp với học. Phương pháp này thường được áp dụng đối với trẻ lớn từ 9 tháng đến 1 tuổi trở lên, tùy theo tốc độ phát triển của trẻ.\n\n❤️ File nghe 1500 bài cho bé - Có danh sách chọn bài chi tiết ❤️\n\n✔️ Nhạc thiền có tác dụng gì?\n\n Nhạc thiền giúp mẹ và bé giảm stress... Nhạc thiền Phật giáo cho bé nghe, bé ngủ sâu và ngon giấc, ít giật mình.\n\n✔️Tiếng Ồn Trắng (white noise) là gì? Tác dụng ra sao?\n\nTiếng Ồn Trắng (white noise) được tạo ra từ sự kết hợp của các âm thanh với tần số thấp như tiếng mưa rơi, tiếng thác nước chảy, tiếng lá cây xào xạc, tiếng ve kêu,...\n\nTiếng Ồn Trắng (white noise) – âm thanh kỳ diệu giúp bé ngủ ngoan\n\n✔️ Kể chuyện cổ tích và hát ru cho bé: \n\n\nCác mẹ còn nhớ chương trình \"Kể chuyện cổ tích và hát ru cho bé\" trên đài tiếng nói Việt Nam lúc 9h tối chứ. Chỉ cần nghe nh ạc chương trình thôi là tuổi thơ đã ùa về rồi. Những câu chuyện cổ tích việt nam và thế giới với giọng đọc truyền cảm của các nghệ sĩ.', 224, 1, 10, 245),
(31, 'Túi nữ mới của Hàn Quốc Cô gái Túi yên ngựa nhỏ Chuỗi túi nhỏ Túi đeo vai Túi', 72000, 'Người mua thân mến, Chào mừng bạn đến với túi Lulu😄😄\n\n\nCung cấp cho bạn trải nghiệm mua sắm tốt, vui lòng nhận phiếu giảm giá cửa hàng và theo dõi cửa hàng của chúng tôi để nhận được nhiều chiết khấu hơn❣❣\n\n\n\nThông tin sản phẩm:\n\nKết cấu lót: PU\n\n\nHình dạng túi: Hình bầu dục\n\nHọa tiết: màu trơn\n\n\nBộ phận mang theo: Xử lý chuỗi\n\nKích thước túi: Chiều rộng: 10cm Chiều cao: 8cm Dây đeo vai: 110cm Cân nặng: 0,13kg\n\n\nLưu ý:📢：\n\n1.Mua Nhiều Sản Phẩm, Vui Lòng Thêm Vào Giỏ Hàng Đầu Và Cuối Cùng.😃😃\n\n2.Cần Sửa Đơn Hàng Vì Màu Sắc, Kích Thước, Số lượng, Vui Lòng Hủy Đơn Hàng Và Đặt Hàng Trước Khi Vận Chuyển\n\n3.Cửa hàng này không chấp nhận trả lại hàng mà không có lý do. Nếu Sản Phẩm Bị Hỏng Do Lý Lý Người Mua, Sẽ Ảnh hưởng Đến Việc Bán Hàng Thứ Hai, Và Không Trả Lại Hoặc Hoàn Tiền Sẽ Được Chấp Nhận, Để Không Ảnh hưởng Trả Hàng Của Người Mua Khác.🙅🙅\n\n4.Nếu Bạn Có Bất Kỳ Câu Hỏi Và Đề Xóa Sau Khi Nhận Được Sản Phẩm, Vui Lòng Liên Hệ Với Bộ Phận Chăm Sóc Khách Hàng, Chúng Tôi Sẽ Chủ Động Giải Quyết Phản Hồi Của Bạn, Và Nhanh Chấp Để Mang Đến Cho Bạn Trải Nghiệm Mua Sắm Tiện Lợi Và Tốt💯💯\n\n5.Dịch vụ khách hàng Trả lời thời gian☎:: Am 8: 00-PM 18: 00\n\n\n6.Cửa hàng của chúng tôi vận chuyển từ nước ngoài, thời gian hậu cần là 5-15 ngày, xin hãy kiên nhẫn👏👏', 245, 1, 11, 46),
(32, 'Túi xách nữ công sở đẹp tote da pu để vừa A4 kẹp nách đeo vai đi học đi chơi thời trang cao cấp giá rẻ', 48000, 'Túi xách nữ công sở đẹp tote da pu để vừa A4 kẹp nách đeo vai đi học đi chơi thời trang cao cấp - sản phẩm thời thượng dành cho mọi cô gái\n\nTúi xách công sở thường có kiểu dáng đặc trưng phù hợp với phong cách thanh lịch và cũng không kém phần quý phái. Hầu hết mẫu túi xách công sở có kích thước to bảng và rộng. Chúng giúp các nàng công sở có thể mang theo cả một thế giới vật dụng cá nhân cho một ngày làm việc hiệu quả.\n\nTúi xách nữ công sở là một phụ kiện thời trang không thể thiếu của bất kỳ giới văn phòng công sở nào. Việc lựa chọn một phong cách thời trang kèm theo phụ kiện chuyên nghiệp sẽ giúp bạn thêm phần năng động.\n\n\nBạn có thể bắt gặp hình ảnh các cô gái cùng chiếc túi xách nữ công sở thời trang ở bất kỳ đâu dù khi đi học đi chơi hoặc tại nơi làm việc.\n\n\nTúi xách nữ giúp các cô nàng hoàn thiện ngoại hình, tạo nên sự tự tin và điểm nhấn mới trong mọi trường hợp.Việc sử dụng một chiếc túi xách thời trang không chỉ là sở thích của phái đẹp mà còn giúp họ trở nên tự tin hơn.\n\nPhối túi xách với trang phục công sở: Với môi trường công sở, bạn không nên chọn những chiếc túi có họa tiết quá sặc sỡ và lòe loẹt. Thay vào đó bạn nên chọn những chiếc túi có kiểu dáng đơn giản, thanh lịch để mang lại cho bạn vẻ ngoài tự tin và chuyên nghiệp. Gợi ý: bạn nên chọn những mẫu túi có kích thước vừa phải với thiết kế trẻ trung, sang trọng\n\n\n 88STORE Luôn là nơi cập nhật những xu hướng TÚI XÁCH NỮ CÔNG SỞ mới nhất\n\nCách Sử Dụng Và Bảo Quản Túi Xách Nữ Công Sở Đẹp Bền Nâu\n\n', 47, 1, 11, 245),
(33, 'Nước Hoa Nam Mini Sexy Man chính Hãng Thơm Lâu Phong Cách Sexy Nam Tính', 299000, 'Nước Hoa Nam Mini Sexy Man 💖 Nước Hoa Nam Chính Hãng Thơm Lâu Sexy Man Mang phong cách Sexy Nam Tính.\n\nHương thơm dịu nhẹ, Đẳng cấp phái mạnh mang đặc trưng riêng biệt của hãng Nước Hoa Nam Mini Sexy\n\nNước Hoa Nam Mini Sexy được lấy cảm hứng từ không gian mở tự nhiên với bầu trời xanh, núi đá dưới ánh mặt trời, hương hoa tự nhiên thoang thoảng đem lại cảm giác tự tin, mạnh mẽ và cuốn hút.\n\n➡Nước Hoa Nam Mini Sexy Man: Nam tính, mạnh mẽ, cá tính mang đến cho bạn phong cách tự tin, Nam Tính.\n\n👉🏻 Hương đầu: cam bergamot, bạc hà, Hoa Huệ, osmanthus và Chanh.\n\n👉🏻 Hương giữa: hoa oải hương, cỏ vetiver, Hoa Sen, Hoa Hồng, Nhài và Táo.\n\n👉🏻 Hương cuối: bách hương, hoa labdanum, ambroxan, Quế, Đào.\n\n\n➡ Mùi hương dịu nhẹ tươi mát, đầy gợi cảm, tạo đẳng cấp cho phải mạnh.\n\n➡ Độ lưu hương: 5 - 7 giờ Tùy mức độ vận động của bạn.\n\n➡ Khoảng cách toả hương: 1-2m\n\n➡ Xịt ở những vị trí dễ toả mùi: cổ tay, gáy\n\n➡ Sử dụng theo hướng dẫn để có hiệu quả tốt.\n\n------------------------------------------------------\n\n', 552, 1, 12, 5),
(34, 'Sữa tắm gội hương nước hoa cao cấp Gentleman 3 in 1', 118000, '* Công dụng: \n\nSản phẩm dùng để tắm gội hàng ngày, giúp: làm sạch da, duy trì độ ẩm da, làm thơm cơ thể. Giúp làm sạch tóc và da đầu, giúp tóc mềm mượt hơn.\n\n\n* Hướng dẫn sử dụng: \n\nDùng để gội đầu:\n\nBước 1: Làm ướt toàn bộ tóc.\n\nBước 2: Lấy một lượng sản phẩm vừa đủ, thoa đều lên tóc và da đầu. Dùng các đầu ngón tay massage nhẹ nhàng để thư giãn và làm sạch hiệu quả.\n\nBước 3: Xả sạch tóc bằng nước. Có thể gội lại lần 2 nếu muốn.\n\nDùng để tắm:\n\nLàm ướt cơ thể, lấy một lượng sản phẩm vừa đủ vào lòng bàn tay hoặc bông tắm đã được nhúng ướt để tạo bọt, thoa đều lên cơ thể, massage nhẹ nhàng và thư giãn với hương nước hoa quyến rũ. Tắm sạch lại với nước.\n\n\n\n* Ưu điểm vượt trội: \n\n\n\nĐược bào chế và nghiên cứu phù hợp với làn da nam giới.\n\n\nNerman được bào chế bằng công nghệ Nano. Các thành phần, dưỡng chất có cấu trúc phân tử siêu nhỏ sẽ đi sâu vào da, thẩm thấu và mang lại tác dụng thực sự chứ không chỉ nằm trên bề mặt da\n\n\nSản xuất theo tiêu chuẩn Mỹ, được kiểm soát bởi Marvel.\n\n', 254, 1, 12, 245),
(35, 'Quần đùi nam sọc ( 2 màu như hình ) - Chính hãng UNISEX', 58000, 'Quần đùi nam nữ phong cách trẻ trung thoáng mát cho ngày hè năng động\n\n\nChiếc quần ko thể thiếu trong mùa hè nóng bức , dễ mặc dễ phối đồ phù hợp cả nam nữ  \n\nMàu sắc : đen - trắng\n\n4sz :M - L - Xl -xxl\n\nChất liệu : thun thái \n\nLấy sll có giảm\n\nNHẬN ĐƠN ĐẶT HÀNG  - CHUYỂN SẢN XUẤT TRỰC TIẾP QUẦN ÁO THỜI TRANG 4 MÙA\n\nBÁN BUÔN BÁN LẺ - TUYỂN CTV ĐẠI LÍ \n\n Nhận THU HỘ ( ship COD ) toàn quốc \n\n Hình Shop chụp, đảm bảo mặc lên form đẹp như ảnh\n\nVải đẹp , không xù , mềm mịn dày dặn , hút mồ hôi cực nhanh, mặc siêu mát . \n\n#QUẦN_THỂ_THAO #QUANTHETHAO #QUANROTSOC #QUANNAM #QUẦNTHỜITRANG #QUẦNĐẸP  \n\n\n✔️ Tên Đơn Vị Sản Xuất : XƯỞNG MAY HOÀNG MẬU\n\n✔️ Địa Chỉ Sản Xuất: XÓM 8 MỸ THẮNG MỸ LỘC NAM ĐỊNH', 221, 1, 1, 245),
(36, 'Áo gile nam len cổ V form rộng thời trang ulzzang học sinh hàn quốc áo gile len mặc ngoài oversize unisex đi học đi chơi', 75000, '[Áo gile nam ],Áo gile nam form rộng\n\n#áo_gile_nam #áo_gile_len #áo_len_cổ_v\n\n\nGiới thiệu: Áo thun nữ thiết kế bởi TMALL:\n\nĐược thiết kế độc đáo cho người mặc, khi mặc lên cảm giác mát mẻ thoải mái tự tin sải bước khi đi ra ngoài, đi chơi du lịch\n\n✪ Thông tin sản phẩm áo thun nữ :\n- Tên sản phẩm: ao hoodie nữ\n- Kiểu dáng thiết kế: tay ngắn, form rộng\n- Chất liệu: NỈ BÔNG\n✪ Size và quy đổi\n✿M   : dưới 45kg, Cao dưới 1m55   | Thân áo rộng: 108cm, thân áo dài:68cm, độ rộng vai: 54cm, ống tay dài:56cm\n✿L    : từ 45-52kg, Cao 1m50-1m60 | Thân áo rộng:112cm, thân áo dài: 70cm, độ rộng vai: 56cm, ống tay dài: 57cm\n✿XL  : từ 52-63kg, Cao 1m6-1m70   | Thân áo rộng:116cm, thân áo dài:72cm, độ rộng vai:58cm, ống tay dài: 58cm\n✿2XL  : từ kg, Cao   | Thân áo rộng:116cm, thân áo dài:120cm, độ rộng vai:74cm, ống tay dài:58cm,ống tay dài: 59cm\n\ních thước có sai số 1-3 cm do cắt thủ công)\n\n(Bảng size mang tính chất tham khảo và phù hợp 80-90% sở thích các cậu ạ. \n\n\n Bạn muốn chọn size phù hợp ib cho shop nhé ^^)', 234, 1, 1, 46),
(37, 'Áo gilê GILE nam nữ áo phao đen ngầu cá tính Hàn bigsize form rộng hot street style darkswear menswear áo túi hộp', 139000, '• Hàng có sẵn tại shop\n\n▪ Cam kết hàng giống ảnh và video shop đăng\n\n▪ Size: M, L, XL, 2XL, 3XL\n\n(Inbox shop để được tư vấn size ^^)\n\n• Cả nam lẫn nữ đều mặc được\n\n• Màu: đen\n\n\n\n• Áo chỉ dày 1 lớp, kiểu dáng áo phao chứ không phải dày như áo phao nên không thể mong đợi mua áo để giữ ấm ạ. Nhưng áo này có rất nhiều loại, khác biệt nhau ở form áo, khoá kéo, đường may mũi chỉ, nút gài… Shop Wonna mình tự tin nhập form áo đẹp nhất trên thị trường ạ ^^~\n\n\n✪ Chính sách bán hàng\n- Cam kết giá tốt nhất thị trường\r\n- Sản phẩm như hình thật 100% \n- Hoàn tiền nếu sản phẩm không giống với mô tả theo đúng quy định của Shopee:\n+ Hàng hóa hư hỏng hoặc bị lỗi do vận chuyển hoặc do nhà sản xuất.\n+ Giao sai mẫu, sai size, thiếu hàng.', 193, 1, 1, 245),
(38, 'Áo Blazer Tay Ngắn Nam Mùa Hè 2 Lớp BZ23 M.RO Kiểu Dáng Vest Nam Bigsize Rộng Tay Lỡ Màu Nâu Đen Trắng Mrhero', 119000, 'Áo blazer nam là một một kiểu áo được thiết kế khá tương đồng với áo vest nhưng có sự đa dạng và thoải mái hơn nhiều. Form dáng áo blazer thường là form rộng không ôm sát người dáng dài hơn.  Đây là mẫu áo khoác  được giúp các bạn nam dễ dàng mix match được với nhiều item khác nhau mang tính ứng dụng cao hơn vest.\n\nBZ01 của nhà Mr.Hero là một item blazer đơn giản mà lại cực kỳ hữu ích với bạn đấy.\n\n-------------------------\n\n🔥 TẠI SAO NÊN MUA AÓ KHOÁC BLAZER CHÍNH HÃNG TẠI MR.HERO? 🔥\n\n✅ HÀNG ĐẸP 99% GIỐNG HÌNH, 1% DO ÁNH SÁNG\n\n✅ ĐƯỢC ĐỔI, TRẢ HÀNG NẾU CÓ BẤT CỨ LỖI NÀO TRONG 7 NGÀY\n\n✅ CHẤT LIỆU ĐƯỢC LỰA CHỌN KỸ LƯỠNG PHÙ HỢP VỚI THIẾT KẾ, TỐT NHẤT TRONG TẦM GIÁ\n\n✅ THIẾT KẾ PHÙ HỢP VỚI VÓC DÁNG NGƯỜI VIỆT NAM\n\n-------------------------\n\nNẾU BẠN MUỐN TÌM KIẾM NHỮNG MẪU QUẦN ÁO THỜI TRANG, VỪA THANH LỊCH, LẠI THOẢI MÁI MANG PHONG CÁCH HÀN QUỐC HÃY ĐẾN VỚI HERO NHA.\n\nHero mang đến cho bạn những trải nghiệm mua sắm tuyệt vời. Cho bạn nhiều sự lựa chọn với mức giá tốt nhất với các mẫu thiết áo khoác blazer, áo vest, áo khoác mùa đông, áo dạ, áo len, áo sơ mi, quần âu… phù hợp với nhiều lứa tuổi sử dụng linh hoạt trong nhiều trường hợp đi học, đi làm đi chơi.\n\n\nThiết kế tại Hero mang hơi hướng đơn giản dễ phối cho các khách hàng\n\n-------------------------n\n', 433, 1, 1, 224),
(39, 'Áo ghi lê INCERUN không tay cài khuy Size S-5XL thời trang cho nam', 49000, 'Thương hiệu: INCERUN\n\nKích thước: s, M, L, XL, 2XL, 3XL, 4XL, 5XL\n\nChất liệu vải: 100% Polyester\n\nMàu: Trắng, Đen, Cà phê\n\nPhong cách: cơ sở\n\nNhân dịp: Giải trí\n\nHoa văn: Màu trơn\n\nĐộ dày: Hiện đại\n\nMô tả sản phẩm: Áo không tay màu trơn của nam.\n\n\n\nGói hàng bao gồm:\n\n1 * áo\n\nXin lưu ý:\n\nMong quý khách thông cảm, kích thước có thể không chính xác 2 cm / 1 inch do các phép đo thủ công.', 432, 1, 1, 245);
INSERT INTO `tbl_product` (`idProduct`, `nameProduct`, `priceProduct`, `description`, `quantityStorage`, `idShop`, `idCategory`, `idCountry`) VALUES
(40, 'Áo Thun Oversize Spow ODIN CLUB', 89000, '- Áo thun oversize SPOW Odin Club\n\n- Màu sắc: Đen \n\n- Size: M / L / XL.\n\n- Kiểu dáng: Oversized.\n\n- Chất liệu: Cotton co giãn hai chiều.\n\n\nHƯỚNG DẪN SỬ DỤNG:\n\n- Lần giặt đầu chỉ nên xả nước lạnh rồi phơi khô.\n\n- Khuyến cáo nên giặt tay, hạn chế giặt máy.\n\n- Chú ý lộn trái sản phẩm trước khi giặt để không ảnh hướng tới bề mặt vải.\n\n- Không sử dụng thuốc tẩy, không giặt chung với các sản phẩm dễ phai màu\n\n- Hạn chế phơi trực tiếp dưới ánh nắng mặt trời, nên phơi khô dưới ảnh sáng tự nhiên\n\n\nCAM KẾT TỪ ODIN CLUB\n\n- Sản phẩm 100% giống mô tả.\n\n- Hình ảnh sản phẩm là ảnh thật do shop tự chụp và giữ bản quyền hình ảnh.\n\n- Đảm bảo chất lượng sản phẩm luôn ở mức cao nhất. \n\n- Hàng có sẵn, giao hàng trên toàn quốc, nhận hàng sau 2-3 ngày đối với các khu vực thuộc nội thành Hà Nội và 3-4 ngày đối với các khu vực khác.', 242, 1, 1, 46),
(41, 'Áo thun tay ngắn cổ tròn màu sắc đơn giản phong cách mùa hè thời trang cho nữ', 43000, 'M- Chiều dài: 68cm / 27\', Ngực: 100cm / 39\', Vai: 50cm / 20\', Tay áo: 19cm / 7\'\n\nL- Chiều dài: 70cm / 27\', Ngực: 106cm / 41\', Vai: 53cm / 21\', Tay áo: 19cm / 7\'\n\nXl Chiều dài: 72cm / 28\', Ngực: 112cm / 44\', Vai: 56cm / 22\', Tay áo: 20cm / 8\'\n\n2xl Chiều dài: 74cm / 29\', Ngực: 118cm / 46\', Vai: 59cm / 23\', Tay áo: 20cm / 8\'\n\n3xl Chiều dài: 76cm / 30\', Ngực: 124cm / 48\', Vai: 62cm / 24\', Tay áo: 21cm / 8\'\n\n(Bảng kích thước chỉ mang tính tham khảo, do đo lường thủ công nên sẽ có sai số 3-5cm, đây không phải là lý do để trả hàng và hoàn tiền)\n\n\n[Zuoan Studio - Lưu ý khi mua hàng]\n\n1. Nếu không rõ cách chọn kích thước Trung Quốc xin vui lòng liên hệ với chúng tôi.\n2. Không chấp nhận các đơn đặt hàng khẩn cấp.\n3. Tất cả các sản phẩm denim mới không cắt sẵn lỗ cài nút, vui lòng tự cắt lỗ cài nút.\n4. Màu sắc hình ảnh sẽ khác nhau do ánh sáng màn hình điện thoại hoặc máy tính.\n5. Nếu bạn gặp phải bất kỳ vấn đề nào sau khi nhận hàng, thiếu sản phẩm hoặc sản phẩm bị lỗi, xin vui lòng liên hệ với chúng tôi.\n\n※ Nếu bạn hài lòng với hàng hóa và dịch vụ của chúng tôi, xin vui lòng cho chúng tôi đánh giá 5 sao, còn nếu không hài lòng xin vui lòng liên hệ với chúng tôi, cảm ơn bạn', 132, 1, 2, 245),
(42, 'Áo bra nữ 2 dây học sinh đẹp hở lưng, áo ngực không gọng quyến rủ JOCOSI B7719', 39000, '✅ Shop Cam Kết\n\n- Cam kết hàng đúng mô tả\n- Hàng có sẵn, giao hàng ngay khi nhận được đơn\n- Hoàn tiền nếu sản phẩm không giống với mô tả\n- Giao hàng trên toàn quốc, nhận hàng trả tiền \n\n✅ Quy Định Đổi Trả\n1. Điều kiện áp dụng (trong vòng 03 ngày kể từ khi nhận sản phẩm) \n- Hàng hoá vẫn còn mới, chưa qua sử dụng \n- Hàng hoá bị lỗi hoặc hư hỏng do vận chuyển hoặc do nhà sản xuất \n2. Trường hợp được chấp nhận: \n- Hàng không đúng size, kiểu dáng như quý khách đặt hàng \n- Không đủ số lượng, không đủ bộ như trong đơn hàng \n\n✅ Do màn hình và điều kiện ánh sáng khác nhau, màu sắc thực tế của sản phẩm có thể chênh lệch khoảng 3-5%', 232, 1, 2, 245),
(43, 'Tất Cổ Cao Nữ Hàn Quốc Trắng Trơn , Vớ Cổ Cao Nữ Hàn Quốc Trơn Nhiều Màu', 9000, 'Tất Cổ Cao Nữ Hàn Quốc Trắng Trơn , Vớ Cổ Cao Nữ Hàn Quốc Trơn Nhiều Màu\n\nTất Cổ Cao Nữ Hàn Quốc Trắng Trơn là phụ kiện thời trang có mặt trong tủ đồ của mọi người tiêu dùng.Vớ Cổ Cao Nữ Hàn Quốc  thường được sử dụng với mục đích giữ ấm bàn chân, bảo vệ sức khỏe hoặc đơn giản là thấm hút mồ hôi trong quá trình bạn đi giày.\n Tất Cổ Cao Nữ Hàn Quốc Trắng Trơn Trắng  đi kèm với các loại giày tránh đau chân, hạn chế hôi chân và làm thoải mái chân. \n- Thời trang, các loại tất vớ thời trang làm tôn lên vẻ đẹp của người đi. \n\nƯU ĐIỂM CỦA SẢN PHẨM:\nTất Cổ Cao Nữ Hàn Quốc Trắng Trơn , Vớ Cổ Cao Nữ Hàn Quốc Trơn Nhiều Màu\nThiết kế tinh tế cực kỳ đáng yêu, trẻ trung, năng động và đặc biệt rất thời trang \nVớ Cổ Cao Nữ Hàn Quốc mỏng thoáng, phần chun mảnh không gây hằn, đau khi sử dụng \nTất Cổ Cao Nữ Hàn Quốc Trắng được làm từ chất liệu 100% cotton giúp khử mùi kháng khuẩn rất tốt \nChất liệu vải mềm, nhẹ, co giãn 4 chiều, thấm hút mồ hơi cực tốt \nTất Cổ Cao Nữ Hàn Quốc Trắng Trơn  mềm mại, thấm hút mồ hôi mang lại cảm giác mát mẻ khô thoáng suốt 4 mùa \nChất vải mịn màng, không bị xù lông khi sử dụng \n\nĐặc biệt sản phẩm tất vớ rất dề phối đồ cho các bạn nữ.\n\n THÔNG TIN CHI TIẾT SẢN PHẨM: \nTất Cổ Cao Nữ Hàn Quốc Trắng Trơn , Vớ Cổ Cao Nữ Hàn Quốc Trơn Nhiều Màu\n- Màu sắc: Nhiều màu hợp thời trang - Chất liệu: Little chuyên cung cấp các sản phẩm tất vớ được làm từ cotton, len, nylon,lụa, lông cừu...\n - Kích thước: Freesize', 232, 1, 2, 245),
(44, 'Áo thun phông logo tay nam nữ PINK tay lỡ form rộng SANJATI Unisex', 79000, '🔻Chất liệu : thun cotton dày dặn, hình in nhiệt chắc chắn\n\n 💥 Đặc biệt :  ở phiên bản màu TRẮNG đã có full tag / logo phần Cổ , Tay & bên Hông đầy đủ ạ\n\n🔻Form : 3 Size ( Áo đã được cải tiến về Số Đo , Form Dáng & Mẫu Mã đẹp hơn ạ )\n\n✔️M : < 45kg , Cao < 1.6m \n\n✔️L : 46kg _ 65kg , Cao 1.6m _ 1.7m \n\n✔️XL : 66kg _ 75kg , Cao 1.7m _ 1.75m \n\n🗣Lưu ý : Áo dạng Unisex mặc form rộng rộng mới đẹp, khách nên chọn size rộng hơn số cân nặng mình xíu nhé ❤️\n\n\n👉👉 NHẬN LÀM ÁO LỚP NHÓM _ ÁO LỚP _ ÁO ĐỒNG PHỤC', 332, 1, 2, 245),
(45, 'Ví Vải Nam Nhỏ Gọn Nhiều Ngăn Tiện Lợi Phong Cách Hàn Quốc Chất Vải Canvas Cao Cấp', 129000, 'Chiếc ví lấy cảm hứng từ những sản phẩm đơn giản nhưng vẫn mang lại tiện lợi tối đa cho khách hàng.\n\n1. MÔ TẢ SẢN PHẨM:\n- Đựng được trên 20 tờ tiền\n- Tối đa 10 thẻ ATM\n- 2 ngăn đựng tiền chính\n- 6 ngăn đựng thẻ\n- Chất liệu: Vải Polyeste\n- Kích thước: 9 x10 (cm)\n\n2. HƯỚNG DẪN VỆ SINH:\nKhông giặt tẩy bằng các chất tẩy rửa mạnh\n- Không nên giặt chung với các sản phẩm khác\n- Không nên sấy khô trong máy giặt sẽ làm ảnh hướng đến các phần cầu kì như móc, khoá cứng\n- Dùng chất tẩy rửa nhẹ như xà bông, sửa tắm chà đánh bọt lên xong chà nhẹ lên vải. Sau đó giặt nhẹ lại bằng nước sạch\n- Phơi mát tự nhiên tránh ánh nắng mặt trời làm ảnh hướng đến chất liệu và bạc màu vải\n\n3. BẢO HÀNH VÀ QUY ĐỊNH ĐỔI TRẢ :\n- Sản phẩm được bảo hành tất cả các lỗi trên sản phẩm.\n- Đổi trả hàng miễn phí trong vòng 7 ngày kể từ ngày mua ( nhận được ) hàng.\n- Khi Đổi trả hàng, sản phẩm phải còn nguyên vẹn, chưa qua giặt - tẩy.', 332, 1, 3, 245),
(46, 'Balo BL22 loang thời trang họa tiết đi học đi chơi du lịch phong cách', 225000, 'Balo nam nữ đi học ulzzang thời trang Hàn Quốc , túi xách unisex đẹp hàng cao cấp , cặp sách basic sinh viên\n\nƯu điểm sản phẩm balo nữ đi học của Ulzzang.vn :\n- Thiết kế kiểu dáng Hàn Quốc hiện đại, trẻ trung, năng động.\n- Chất liệu vải Nilon kết hợp với vải Polyester mềm mịn, dày dặn, bền màu, không bám bụi, chống thấm nước, chuẩn form. ( Shop nói không với chất vải kém chất lượng: thô, cứng, phai màu )\n- Đường may, các chi tiết nhỏ được hoàn thiện với độ chính xác cao\n- Khóa kim loại có độ bền cao.\n\nĐặc điểm của sản phẩm balo nữ đi học Ulzzang :\n- Sản phẩm có kích thước: 46cm x 32cm x 14cm (cao x dài x rộng)\n- Chất liệu: vải polyester kết hợp vải nilon mềm , mịn, dày dặn, chống thấm.\n- Trọng lượng khoảng: ~ 0.4 kg\n- Sản phẩm phù hợp với học sinh, sinh viên, giới trẻ.\n- Mục đích sử dụng: đi học, đi làm, đi chơi.\n- Có 5 màu : trắng đen, đen vàng, đen trắng, đen xanh, xanh đen. Màu sắc trẻ trung, cá tính, dễ phối đồ.', 532, 1, 3, 245),
(47, 'Balo Ulzzang Hàn Quốc học sinh đi học đi chơi ngăn Mica trong suốt phối lưới siêu xinh', 269000, 'Thông tin sản phẩm :\n\n-Màu sắc : 4 màu\n- Không kèm gấu bông và sticker\n-Kích thước : 35x42cm\n-Khối lượng : 400g\n-Chất liệu : dù chống nước\n\n⭐️Shop ko nhân đặt hàng theo note hoặc inbox..chỉ đóng gói theo đơn khách đặt trên hệ thống.\n\n⭐️Khách hàng muốn mua nhiều màu hoặc nhiều sản phẩm khác nhau vui lòng chọn từng màu,từng sản phẩm cho vô giỏ hàng...rồi quay ra tiếp tục chọn...sau khi đã chọn đủ sản phẩm mình cần mua vui lòng quay lại giỏ hàng ấn chọn tất cả và ấn đặt hàng.\n\n⭐️Trong quá trình đóng gói và vận chuyển có thể xảy ra sai sót,cần hỗ trợ vui lòng inbox cho shop hoặc gọi điện,nhắn tin : 0367532597\n\n🌵 Lưu ý: màu hồng sẽ lệch 1 2 tone màu tuỳ vào lô vải sản xuất, sản phẩm không kèm túi nước', 232, 1, 3, 245),
(48, 'Balo thời trang, đi học, đựng laptop - BALO NẮP QTK 2 Khoá', 88000, '☀ Mô tả sản phẩm\n\n-	Chất liệu: Vải dày, dễ giặt, ít bám bụi bẩn\n-	Size túi: 34x14x39cm\n-	Không gian lớn chứa vừa áo khoác, son, dụng cụ trang điểm và nhiều vật dụng khác\n-	Đeo theo 2 kiểu: có thể làm túi xách tiện dụng hoặc làm túi đeo vai thời trang.\n\n🍀 Túi Tote – chiếc túi hot hit nhất đến từ Hàn Quốc chưa bao giờ hết nóng. Tote nổi bật bởi khả năng thay đổi, từ chiếc túi xách nhỏ nhắn có thể xách đi chợ cho đến chiếc túi đeo vai thời trang cho các bạn nữ. Còn về màu sắc và họa tiết, dù là tote vải trơn, in slogan hay in đôi ba hình thù độc đáo, chiếc túi này cũng thừa sức làm nổi bật cả set đồ và truyền tải khéo léo gu thời trang độc nhất của các nàng.\n\n🍀 Trong tay các nàng, Tote – Túi đeo vải biến hóa rất tuyệt vời, phối với các trang phục khác nhau, tạo nên phong cách thời trang sành điệu và riêng biệt độc nhất cho các cô nàng\n\n🍀 Túi tote mang tới cho các cô nàng sự thoải mái khi đi dạo phố hoặc hẹn hò bè bạn vì không phải cầm mang những vật dụng linh tinh, chiếc túi xách đã trở thành người bạn không thể thiếu các nàng. Chúng có sự đa dạng từ kiểu cách tới màu sắc, size…tùy theo nhu cầu của mình mà các nàng lựa chọn một sản phẩm thích hợp. ', 332, 1, 3, 245),
(49, 'Ốp điện thoại iphone hở táo viền vuông mạ màu, kính bảo về camera cho ip 7plus 8plus X Xsmax 11 12 13 14 pro max promax', 68000, 'Ốp điện thoại iphone hở táo viền vuông mạ màu, kính bảo về camera cho ip 7plus 8plus X Xsmax 11 12 13 14 pro max promax\nThông tin sản phẩm: \n- Chất liệu:  Viền nhựa dẻo , cjanh vuông\n- Màu sắc: Nhiều Màu.\n- Ốp lưng được đóng gói bằng túi nilon thiết kế đẹp.\n- Hình ảnh chất lượng cao,sắc nét, không phai màu.\n- Hình ảnh thiết kế đẹp, phong cách, trẻ trung.\n- Công dụng: Là phụ kiện thời trang, thay đổi màu sắc cho điện thoại, giữ điện thoại chắc chắn trên tay, an toàn chống trầy xước,  bảo vệ chiếc điện thoại khỏi va đập.\n\n- Dòng máy tương thích ốp lưng iphone - ốp iphone ; iphone 6 ; iphone 6s ; iphone 6 plus ; iphone 6s plus ; iphone 7 ; iphone 8 ; iphone 7 plus ; iphone 8 plus ; iphone x ; iphone xs ; iphone xs max ; iphone 11 ; iphone 11 pro ; iphone 11 pro max ; iphone 12 mini, iphone 12, iphone 12 pro, iphone 12 pro max ; iphone 6splus ; iphone 7plus ; iphone 8plus ; iphone xsmax ; iphone 11pro ; iphone 11 promax, 13 , iphone 12pro, iphone 12 promax', 432, 1, 4, 245),
(50, 'Kinh cường lực tự dán baiko dành cho iphone 7plus 8plus x xsmax/11 11promax 12 12promax 13 14 13promax pro max 14promax', 59000, 'Kinh cường lực  KINGKONG BAIKO full màn cho 7plus 8plus x xsmax 11 11promax 12 12promax 13 13promax pro max \n\nMô tả sản phẩm:\n- Cường lực full viền\n- Có lớp lưới bảo vệ loa thoại\n- Thiết kế: Bo khít máy, vừa tầm khi dùng kèm ốp.\n- Chất liệu: kính cường lực.\n- Dòng máy tương thích: x/xs/xs max/11/11 pro/11 promax /12 13 pro promax\n- Xuất xứ: Việt Nam\nQuý khách lưu ý:\n- Khi đặt hàng Quý khách vui lòng ghi chú vào đơn hàng khi cần có thêm thông tin như : màu sắc, kiểu, dáng thời gian Quý khách có thể nhận hàng.', 342, 1, 4, 245),
(51, 'Kính cường lực iphone tự dán KINGKONG GLASS chống nhìn trộm cho ip 7P/8P/X/Xsmax/11/11promax/...13promax', 55000, 'DOLPHIN CASE CAM KẾT\n\n✔ Mang lại cho quý khách những sản phẩm tốt nhất, đẹp nhất\n\n✔ Giao hàng nhanh chóng  – shop sẽ đóng hàng sớm nhất để hàng có thể đến tay khách một cách nhanh nhất \n\n✔ Đổi trả, hoàn tiền nếu có lỗi của nhà sản xuất hoặc không giống như mô tả. \n\n*** Khách hàng lưu ý : Quay lại video khi mở hàng để được đảm bảo quyền lợi một cách nhất\n\nCường lực khung dán đã hot hòn họt, Kính cường lực iphone KINGKONG GLASS chống nhìn trộm còn hot hơn gấp bội\n\nTín đồ của kính chống nhìn trộm nay đã có thể tự dán tại nhà mà không cần ra tiệm dán với giá trên trời nữa rồi ạ ^^\n\n\nPhải nói là Kính cường lực iphone KINGKONG GLASS chống nhìn trộm \n\nSIÊU DỄ DÁN - SIÊU MƯỚT MỊN (Chuẩn hơn cả thợ ngoài tiệm)', 322, 1, 4, 245),
(52, 'Đồng Hồ Nam nữ HU Cặp Đôi - Dây Hương Vani Cao Cấp - DH602 - Bảo hành 12 tháng', 339000, 'THÔNG SỐ SẢN PHẨM : Đồng hồ HU\n• Kiểu máy : Pin nhật\n• Kích thước mặt : Nam 42mm / Nữ 36mm\n• Kích thước đây :Nam 220 x 20mm / Nữ 220 x16mm\n• Chất liệu dây: Dây cao su\n• Chất liệu khung : Thép không gỉ.\n• Kính : Kính Mineral chống xước\n• Chống nước : KHÔNG\n• Bảo hành máy 12 tháng.\nBỘ SẢN PHẨM BAO GỒM\n\n- 1 Đồng hồ\n- 1 Hộp đồng hồ đi kèm\n- 1 Pin dự phòng\nTRƯỜNG HỢP KHÔNG ĐỦ ĐIỀU KIỆN BẢO HÀNH\n • Vỡ do tai nạn trong quá trình sử dụng.\n • Trầy xước về dây hoặc mặt kính bị trầy xước\n • Tự ý mở ra can thiệp sửa chữa trong thời gian bảo hành', 327, 1, 5, 245),
(53, 'Đồng Hồ Điện Tử Thể Thao Chống Nước Phong Cách One Piece Thời Trang', 135000, 'Thương hiệu: BASID\nChứng nhận: CE\nChất liệu vỏ: Cao su\nXuất xứ: CN (Xuất xứ)\nChiều dài dây: 26cm\nĐộ sâu kháng nước: 5Bar\nPhong cách: THỂ THAO\nPhong trào: Kỹ thuật số\nLoại khóa: Khóa\nHình dạng vỏ: Tròn\nChiều rộng dải: 29mm\nĐộ dày vỏ: 16mm\nQuay số loại vật liệu cửa sổ: Hardlex', 232, 1, 5, 245),
(54, 'Đồng Hồ Đeo Tay Kỹ Thuật Số Màn Hình LED Dây Silicon Hình Chuột Mickey Dễ Thương Cho Bé Gái', 59000, 'Loại nguồn hàng: hàng có sẵn\n\nMàu sắc: Pikachu màu vàng, Mèo Jingle trắng, Mickey đen, Xám My Neighbor Totoro, Vàng Pooh, Gấu bạo lực hồng, Gấu bạo lực xám, Dâu xanh, Hồng lợn, Thỏ cam, Gấu bạo lực da, Mickey màu da, Xanh đậm Mickey\n\nĐộ dày: 12mm\nChức năng đặc biệt: trang trí, phát sáng, giờ thế giới, giờ kép GMT\nKiểu Clasp: giảm giá đơn\nĐường kính quay số: 46mm\nHình dạng quay số: hình chữ nhật\nHiệu suất chống thấm nước: 50m\nLoại chuyển động: điện tử\nPhương pháp đeo: dây đeo cổ tay\nLoại hiển thị: số\nPhong cách: Giản dị', 372, 1, 5, 245),
(55, 'Giày thể thao nữ phối màu đen nâu cá tính', 79000, '-------------------------------\n\nMÔ TẢ SẢN PHẨM CHI TIẾT\n - Phần thân trên chất da mềm cao cấp đi rất êm chân, mang thoải mái đi lại cả ngày \n - Phần Midsole (đế giữa) lót EVA êm ái\n - Phần Outsole (đế ngoài) là điểm quyết định của em giày này. Đế cao su đặc có độ bám dính, chống trơn trượt, ma sát tối đa, tạo độ êm ái thoải mái nên sản phẩm hết sức tuyệt vời cho những cô nàng có tính chất công việc phải đi lại cả ngày.\n\n-------------------------------\nKiểu dáng cơ bản này giúp các nàng tha hồ mix với các loại trang phục từ cá tính mạnh mẽ tới bánh bèo nhẹ nhàng, vô cùng trẻ trung, năng động và còn giúp các nàng ăn gian thêm chiều cao chút xíu nữa đấy. \n\n▪︎ Tiêu chí ĐẸP + DỄ MIX ĐỒ + THOẢI MÁI CHẤT LƯỢNG + GIÁ RẺ\n\n▪︎ Sản phẩm phù hợp đi chơi, đi tiệc đi học, du lịch, dạo phố', 42, 1, 6, 245),
(56, 'Chai xịt khử mùi giày, dép chống hôi chân, diệt khuẩn hiệu quả đến 24h dung tích 260ml (chuyên sỉ)', 39000, '✔✔ Hướng dẫn sử dụng\n- Giày ở trạng thái khô ráo, sử dụng bình xịt vào bên trong và ngoài giày.\n- Tính chất của dung dịch khử mùi là dung môi nhanh khô (trong 10 giây)\n-  Lắc đều trước khi xịt\n- Xịt đều lên đồ cần xịt rồi để khô trước khi sử dụng\n- Khi xịt dung môi xong để giày ở nơi thoáng mát khoảng 5-10 phút, sau đó có thể mang bảo quản trong hộp, tủ hoặc sử dụng ngay\nSỈ LH 0858868995', 142, 1, 6, 245),
(57, 'Dép Sandan Nam Nữ, Sandal Học Sinh Quai Ngang(Đế cao 2,5cm)', 129000, 'Sandal Quai Ngang New 2020\n\n- Thiết kế: Dép Sandal Nam năng động trẻ trung\n\n- Chất Liệu: đế được làm từ cao su tổng hợp\n\n- Size: 37-43\n\n- Màu sắc: Đen, Trắng,Ghi\n\n+ Địa chỉ :  Hoài Đức Hà Nội\n\n+ SĐT : 0936446188', 422, 1, 6, 245),
(58, 'Dép quai ngang nam nữ Minimal, Dép quai ngang Masler MT với dòng đế êm chân và chống nước khoáng khuẩn MIN', 219000, 'Masler-MT thương hiệu dép quai ngang thể thao thời trang dẫn đầu xu hướng Streetwear.\n\nBạn đang gặp phải các vấn đề khó chịu khi dùng các sản phẩm giá rẻ nhưng chất liệu không đảm bảo an toàn, xuất hiện mùi và khó vệ sinh, dùng một thời gian bị hư hỏng và phải mua mới liên tục. Nắm bắt được các vấn đề mà phần lớn người dùng đang gặp phải, chúng mình sẽ giúp bạn xóa bỏ cảm giác đau chân và khó chịu, sẽ đem lại trải nghiệm tận hưởng cảm giác thoải mái hàng giờ đến với bạn.\n\n* Thông tin sản phẩm Dép bánh mì Masler-MT\n- Chất liệu : Phần Quai Da chắc chắn, Lớp Đế IP Cải Tiến nhẹ hơn 2 lần\n- Lớp Đế IP nhẹ êm với công nghệ chống trượt, chống nước cực tốt, đi đứng thoải mái,\n- Đế được làm từ dây chuyền khép kín giúp dép đế thêm bền đẹp, form ôm chân và thoải mái khi di chuyển.\n- Phù hợp để đi chơi, dạo phố, đi dạo, đi biển, đi gym...\n- Dép bánh mì Masler-MT được lựa chọn là phụ kiện không thể thiếu, thoải mái phối đồ với mọi phong cách.\n- Thời gian giao hàng dự kiến cho sản phẩm này là từ 3-4 ngày\n- Xuất xứ thương hiệu: Việt Nam', 424, 1, 6, 245),
(59, 'Giày Lolita Nữ Quai Ngọc BUỘC NƠ Cao Cấp (đặt lùi 1 sz)- Giày búp bê nữ đế độn 4 phân 2 màu siêu hót', 229000, '🔶QUY ĐỊNH ĐỔI TRẢ HÀNG: Quý khách có quyền đổi trả hàng trong vòng 03 ngày kể từ ngày nhận hàng (với điều kiện GIÀY CÒN MỚI NGUYÊN-CHƯA QUA SỬ DỤNG) cho những trường hợp sau:\n✔️Hàng lỗi nghiêm trọng do sản xuất; hàng giao sai mẫu, nhầm size. Anh/chị vui lòng inbox lại Shop để được hướng dẫn trả hàng/hoàn tiền và Shopee sẽ hỗ trợ 100% phí ship. \n✔️Trường hợp anh/chị đổi giày do muốn đổi size, đổi mẫu khác thì cũng xin inbox lại shop để được hướng dẫn. Nếu anh/chị không đến đổi trực tiếp được thì chi phí ship 2 chiều sẽ chịu 100% để thuê bên vận chuyển, bưu điện đi đổi hộ. \nVì vậy, anh/chị vui lòng đọc kỹ quy định đổi trả hàng ạ😊', 242, 1, 7, 245),
(60, 'Giày thể thao nữ chạy bộ Chữ N 3 màu siêu nhẹ hàng xuất xịn', 149000, '- Kiểu dáng thanh lịch, màu sắc hài hòa trang nhã\n- Đế bằng cao su tổng hợp chắc chắn, bền\n\n- Giày có hộp của shop mới, nhưng trong quá trình vận chuyển rất có thể hộp sẽ bị móp méo, điều này shop không hề mong muốn và cũng không thể can thiệp được vào công việc vận chuyển, nên mong anh/chị thông cảm.', 42, 1, 7, 245),
(61, 'Bốt da nữ Cổ Thấp chữ V khoá sau chất da mềm xịn', 219000, '- Kiểu dáng thanh lịch, màu sắc hài hòa trang nhã\n- Đế bằng cao su tổng hợp chắc chắn, bền\n- Giày có hộp của shop mới, nhưng trong quá trình vận chuyển rất có thể hộp sẽ bị móp méo, điều này shop không hề mong muốn và cũng không thể can thiệp được vào công việc vận chuyển, nên mong anh/chị thông cảm.', 142, 1, 7, 245),
(62, 'Giày thể thao nữ đế bánh mỳ 2 quai dán Khuy cài Cao Cấp', 99000, '- Kiểu dáng thanh lịch, màu sắc hài hòa trang nhã\n- Đế bằng cao su tổng hợp chắc chắn, bền\n- Giày có hộp của shop mới, nhưng trong quá trình vận chuyển rất có thể hộp sẽ bị móp méo, điều này shop không hề mong muốn và cũng không thể can thiệp được vào công việc vận chuyển, nên mong anh/chị thông cảm.', 421, 1, 7, 245),
(63, 'Usb 2.0 Dung Lượng 1tb 128gb 64gb 32gb 16gb 8gb 1gb Chất Lượng Cao', 339000, 'Mô tả sản phẩm\n\n  1. Kết nối USB, chỉ cần cắm và sử dụng\n  2. Không cần nguồn điện bên ngoài.\n  3. Hỗ trợ các hệ điều hành khác nhau\n  4. Lưu trữ trạng thái ổ cứng, chống sốc và bức xạ điện từ.\n  5. Lưu trữ dữ liệu lâu bền\n  6. Phù hợp cho: Máy tính có kết nối USB, Notebook, MAC\n  7. Tuổi thọ: > 1 triệu giờ', 42, 1, 8, 245),
(64, 'Quạt Tản Nhiệt - Fan Led RGB Cắm nguồn trực tiếp không qua HUB WM Star V8 S2 33 Bóng', 69000, '𝗖𝗔𝗠 𝗞𝗘̂́𝗧 𝗦𝗔̉𝗡 𝗣𝗛𝗔̂̉𝗠 𝐓𝐀̣𝐈 𝐌𝐀́𝐘 𝐓𝐈́𝐍𝐇 𝐓𝐓\n- 𝐶𝑎𝑚 𝑘𝑒̂́𝑡 ℎ𝑎̀𝑛𝑔 𝑐ℎ𝑢𝑎̂̉𝑛 𝑐ℎ𝑎̂́𝑡 𝑙𝑢̛𝑜̛̣𝑛𝑔 𝑐𝑎𝑜.\n. – Máy Tính TT 𝑐𝑎𝑚 𝑘𝑒̂́𝑡 𝑙𝑢𝑜̂𝑛 𝑙𝑢𝑜̂𝑛 𝑛ℎ𝑖𝑒̣̂𝑡 𝑡𝑖̀𝑛ℎ 𝑣𝑎̀ 𝑡𝑎̣̂𝑛 𝑡   ̂𝑚 𝑣𝑜̛́𝑖 𝑚𝑜̣𝑖 𝑘ℎ𝑎́𝑐ℎ ℎ𝑎̀𝑛𝑔\n -1 đ𝑜̂̉𝑖 1 𝑡𝑟𝑜𝑛𝑔 3 𝑛𝑔𝑎̀𝑦 đ𝑎̂̀𝑢 \n- 𝐾ℎ𝑖 𝑚𝑢𝑎 ℎ𝑎̀𝑛𝑔 𝑔𝑎̣̆𝑝 𝑙𝑜̂̃𝑖 𝑡𝑢̛̀ 𝑛ℎ𝑎̀ 𝑠𝑎̉𝑛 𝑥𝑢𝑎̂́𝑡 𝑠ℎ𝑜𝑝 𝑡𝑢𝑎̂𝑛 𝑡ℎ𝑢̉ đ𝑢́𝑛𝑔 𝑡ℎ𝑒𝑜 𝑞𝑢𝑦 đ𝑖̣𝑛ℎ đ𝑜̂̉𝑖 𝑡𝑟𝑎̉ 𝑐𝑢̉𝑎 𝑠ℎ𝑜𝑝𝑝𝑒. 𝑉𝑎̀ 𝑘ℎ𝑎́𝑐ℎ 𝑦𝑒̂𝑢 𝑐𝑢̃𝑛𝑔 𝑙𝑢̛𝑢 𝑦́ 𝑙𝑎̀ 𝑠ℎ𝑜𝑝 𝑠𝑒̃ 𝑘ℎ𝑜̂𝑛𝑔 𝑐ℎ𝑎̂́𝑝 𝑛ℎ𝑎̣̂𝑛 đ𝑜̂̉𝑖 𝑡𝑟𝑎̉ 𝑣𝑜̛́𝑖 𝑙𝑖́ 𝑑𝑜 𝑙𝑎̀ 𝑚𝑢𝑎 𝑘ℎ𝑜̂𝑛𝑔 𝑡ℎ𝑖́𝑐ℎ, đ𝑎̣̆𝑡 𝑛ℎ𝑎̂̀𝑚, 𝑡𝑢̛𝑜̛̉𝑛𝑔 𝑛𝑜̣ 𝑡𝑢̛𝑜̛̉𝑛𝑔 𝑘𝑖𝑎. 𝑇𝑟𝑢̛𝑜̛́𝑐 𝑘ℎ𝑖 𝑚𝑢𝑎 𝑘ℎ𝑎́𝑐ℎ 𝑦𝑒̂𝑢 𝑛𝑒̂𝑛 đ𝑜̣𝑐 𝑚𝑜̂ 𝑡𝑎̉ 𝑠𝑎̉𝑛 𝑝ℎ𝑎̂̉𝑚 𝑡𝑟𝑢̛𝑜̛́𝑐 𝑛ℎ𝑎 > 𝐵𝑎̣𝑛 𝑐𝑜́ 𝑡ℎ𝑒̂̉ 𝑙𝑖𝑒̂𝑛 ℎ𝑒̣̂ 𝑆ℎ𝑜𝑝 𝑡ℎ𝑒𝑜 𝑠𝑜̂́ đ𝑖𝑒̣̂𝑛 𝑡ℎ𝑜𝑎̣𝑖 0822101111 ℎ𝑜𝑎̣̆𝑐 𝐼𝑛𝑏𝑜𝑥 𝑆ℎ𝑜𝑝 đ𝑒̂̉ đ𝑢̛𝑜̛̣𝑐 ℎ𝑜̂̃ 𝑡𝑟𝑜̛̣ 𝑛ℎ𝑎𝑛ℎ 𝑛ℎ𝑎̂́𝑡 𝑎̣', 342, 1, 8, 245),
(65, 'Tai nghe chụp tai game TT A6 âm bass cực hay - Máy tính TT', 89000, '𝗖𝗔𝗠 𝗞𝗘̂́𝗧 𝗦𝗔̉𝗡 𝗣𝗛𝗔̂̉𝗠 𝐓𝐀̣𝐈 𝐌𝐀́𝐘 𝐓𝐈́𝐍𝐇 𝐓𝐓\n- 𝐶𝑎𝑚 𝑘𝑒̂́𝑡 ℎ𝑎̀𝑛𝑔 𝑐ℎ𝑢𝑎̂̉𝑛 𝑐ℎ𝑎̂́𝑡 𝑙𝑢̛𝑜̛̣𝑛𝑔 𝑐𝑎𝑜.\n. – Máy Tính TT 𝑐𝑎𝑚 𝑘𝑒̂́𝑡 𝑙𝑢𝑜̂𝑛 𝑙𝑢𝑜̂𝑛 𝑛ℎ𝑖𝑒̣̂𝑡 𝑡𝑖̀𝑛ℎ 𝑣𝑎̀ 𝑡𝑎̣̂𝑛 𝑡   ̂𝑚 𝑣𝑜̛́𝑖 𝑚𝑜̣𝑖 𝑘ℎ𝑎́𝑐ℎ ℎ𝑎̀𝑛𝑔\n -1 đ𝑜̂̉𝑖 1 𝑡𝑟𝑜𝑛𝑔 3 𝑛𝑔𝑎̀𝑦 đ𝑎̂̀𝑢 \n- 𝐾ℎ𝑖 𝑚𝑢𝑎 ℎ𝑎̀𝑛𝑔 𝑔𝑎̣̆𝑝 𝑙𝑜̂̃𝑖 𝑡𝑢̛̀ 𝑛ℎ𝑎̀ 𝑠𝑎̉𝑛 𝑥𝑢𝑎̂́𝑡 𝑠ℎ𝑜𝑝 𝑡𝑢𝑎̂𝑛 𝑡ℎ𝑢̉ đ𝑢́𝑛𝑔 𝑡ℎ𝑒𝑜 𝑞𝑢𝑦 đ𝑖̣𝑛ℎ đ𝑜̂̉𝑖 𝑡𝑟𝑎̉ 𝑐𝑢̉𝑎 𝑠ℎ𝑜𝑝𝑝𝑒. 𝑉𝑎̀ 𝑘ℎ𝑎́𝑐ℎ 𝑦𝑒̂𝑢 𝑐𝑢̃𝑛𝑔 𝑙𝑢̛𝑢 𝑦́ 𝑙𝑎̀ 𝑠ℎ𝑜𝑝 𝑠𝑒̃ 𝑘ℎ𝑜̂𝑛𝑔 𝑐ℎ𝑎̂́𝑝 𝑛ℎ𝑎̣̂𝑛 đ𝑜̂̉𝑖 𝑡𝑟𝑎̉ 𝑣𝑜̛́𝑖 𝑙𝑖́ 𝑑𝑜 𝑙𝑎̀ 𝑚𝑢𝑎 𝑘ℎ𝑜̂𝑛𝑔 𝑡ℎ𝑖́𝑐ℎ, đ𝑎̣̆𝑡 𝑛ℎ𝑎̂̀𝑚, 𝑡𝑢̛𝑜̛̉𝑛𝑔 𝑛𝑜̣ 𝑡𝑢̛𝑜̛̉𝑛𝑔 𝑘𝑖𝑎. 𝑇𝑟𝑢̛𝑜̛́𝑐 𝑘ℎ𝑖 𝑚𝑢𝑎 𝑘ℎ𝑎́𝑐ℎ 𝑦𝑒̂𝑢 𝑛𝑒̂𝑛 đ𝑜̣𝑐 𝑚𝑜̂ 𝑡𝑎̉ 𝑠𝑎̉𝑛 𝑝ℎ𝑎̂̉𝑚 𝑡𝑟𝑢̛𝑜̛́𝑐 𝑛ℎ𝑎 > 𝐵𝑎̣𝑛 𝑐𝑜́ 𝑡ℎ𝑒̂̉ 𝑙𝑖𝑒̂𝑛 ℎ𝑒̣̂ 𝑆ℎ𝑜𝑝 𝑡ℎ𝑒𝑜 𝑠𝑜̂́ đ𝑖𝑒̣̂𝑛 𝑡ℎ𝑜𝑎̣𝑖 0822101111 ℎ𝑜𝑎̣̆𝑐 𝐼𝑛𝑏𝑜𝑥 𝑆ℎ𝑜𝑝 đ𝑒̂̉ đ𝑢̛𝑜̛̣𝑐 ℎ𝑜̂̃ 𝑡𝑟𝑜̛̣ 𝑛ℎ𝑎𝑛ℎ 𝑛ℎ𝑎̂́𝑡 𝑎̣', 421, 1, 8, 245),
(66, 'Loa máy tính để bàn mini PC Laptop YST có led - Bass cực đã, giá thành rẻ - Máy Tính TT', 119000, '𝗖𝗔𝗠 𝗞𝗘̂́𝗧 𝗦𝗔̉𝗡 𝗣𝗛𝗔̂̉𝗠 𝐓𝐀̣𝐈 𝐌𝐀́𝐘 𝐓𝐈́𝐍𝐇 𝐓𝐓\n- 𝐶𝑎𝑚 𝑘𝑒̂́𝑡 ℎ𝑎̀𝑛𝑔 𝑐ℎ𝑢𝑎̂̉𝑛 𝑐ℎ𝑎̂́𝑡 𝑙𝑢̛𝑜̛̣𝑛𝑔 𝑐𝑎𝑜.\n. – Máy Tính TT 𝑐𝑎𝑚 𝑘𝑒̂́𝑡 𝑙𝑢𝑜̂𝑛 𝑙𝑢𝑜̂𝑛 𝑛ℎ𝑖𝑒̣̂𝑡 𝑡𝑖̀𝑛ℎ 𝑣𝑎̀ 𝑡𝑎̣̂𝑛 𝑡   ̂𝑚 𝑣𝑜̛́𝑖 𝑚𝑜̣𝑖 𝑘ℎ𝑎́𝑐ℎ ℎ𝑎̀𝑛𝑔\n -1 đ𝑜̂̉𝑖 1 𝑡𝑟𝑜𝑛𝑔 3 𝑛𝑔𝑎̀𝑦 đ𝑎̂̀𝑢 \n- 𝐾ℎ𝑖 𝑚𝑢𝑎 ℎ𝑎̀𝑛𝑔 𝑔𝑎̣̆𝑝 𝑙𝑜̂̃𝑖 𝑡𝑢̛̀ 𝑛ℎ𝑎̀ 𝑠𝑎̉𝑛 𝑥𝑢𝑎̂́𝑡 𝑠ℎ𝑜𝑝 𝑡𝑢𝑎̂𝑛 𝑡ℎ𝑢̉ đ𝑢́𝑛𝑔 𝑡ℎ𝑒𝑜 𝑞𝑢𝑦 đ𝑖̣𝑛ℎ đ𝑜̂̉𝑖 𝑡𝑟𝑎̉ 𝑐𝑢̉𝑎 𝑠ℎ𝑜𝑝𝑝𝑒. 𝑉𝑎̀ 𝑘ℎ𝑎́𝑐ℎ 𝑦𝑒̂𝑢 𝑐𝑢̃𝑛𝑔 𝑙𝑢̛𝑢 𝑦́ 𝑙𝑎̀ 𝑠ℎ𝑜𝑝 𝑠𝑒̃ 𝑘ℎ𝑜̂𝑛𝑔 𝑐ℎ𝑎̂́𝑝 𝑛ℎ𝑎̣̂𝑛 đ𝑜̂̉𝑖 𝑡𝑟𝑎̉ 𝑣𝑜̛́𝑖 𝑙𝑖́ 𝑑𝑜 𝑙𝑎̀ 𝑚𝑢𝑎 𝑘ℎ𝑜̂𝑛𝑔 𝑡ℎ𝑖́𝑐ℎ, đ𝑎̣̆𝑡 𝑛ℎ𝑎̂̀𝑚, 𝑡𝑢̛𝑜̛̉𝑛𝑔 𝑛𝑜̣ 𝑡𝑢̛𝑜̛̉𝑛𝑔 𝑘𝑖𝑎. 𝑇𝑟𝑢̛𝑜̛́𝑐 𝑘ℎ𝑖 𝑚𝑢𝑎 𝑘ℎ𝑎́𝑐ℎ 𝑦𝑒̂𝑢 𝑛𝑒̂𝑛 đ𝑜̣𝑐 𝑚𝑜̂ 𝑡𝑎̉ 𝑠𝑎̉𝑛 𝑝ℎ𝑎̂̉𝑚 𝑡𝑟𝑢̛𝑜̛́𝑐 𝑛ℎ𝑎 > 𝐵𝑎̣𝑛 𝑐𝑜́ 𝑡ℎ𝑒̂̉ 𝑙𝑖𝑒̂𝑛 ℎ𝑒̣̂ 𝑆ℎ𝑜𝑝 𝑡ℎ𝑒𝑜 𝑠𝑜̂́ đ𝑖𝑒̣̂𝑛 𝑡ℎ𝑜𝑎̣𝑖 0822101111 ℎ𝑜𝑎̣̆𝑐 𝐼𝑛𝑏𝑜𝑥 𝑆ℎ𝑜𝑝 đ𝑒̂̉ đ𝑢̛𝑜̛̣𝑐 ℎ𝑜̂̃ 𝑡𝑟𝑜̛̣ 𝑛ℎ𝑎𝑛ℎ 𝑛ℎ𝑎̂́𝑡 𝑎̣', 432, 1, 8, 245),
(67, 'Gương trang điểm 2 mặt để bàn xinh xắn xoay 360 độ nhiều mẫu', 39000, 'Trang điểm đẹp hơn, nhanh hơn và đơn giản hơn.\nKhông phải đứng hàng giờ liền trước gương treo tường, chỉ cần ngồi đúng tư thế và chỉnh mặt gương cho phù hợp với hướng soi của bạn.\nTên sản phẩm: Gương trang điểm để bàn lúa mạch 2 mặt gương xoay 360 độ\nMake up, uốn lô, đắp mặt nạ đều trở nên dễ dàng hơn bao giờ hết.\nVật trang trí đẹp mắt giúp tôn lên vẻ chuyên nghiệp và sang trọng nơi bàn trang điểm của bạn. Đây còn là một món quà thích hợp tặng bạn bè, người thân trong những dịp đặc biệt', 42, 1, 9, 245),
(68, 'Kệ đựng đồ đa năng đựng mĩ phẩm đồ trang điểm nhựa 3 tầng để bàn, khay để mỹ phẩm có hộp ngăn kéo tiện lợi', 119000, 'Kệ đựng đồ đa năng đựng mĩ phẩm đồ trang điểm nhựa 3 tầng để bàn, khay để mỹ phẩm có hộp ngăn kéo tiện lợi\n\n-Chất liệu: Nhựa PP cao cấp\n-Màu sắc: Trắng, Hồng \n-Kích thước : 28,5 * 12,5 * 17cm\nĐặc điểm sản phẩm kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp:\n-Thiết kế nhiều ngăn nhỏ gọn, tiện dụng\n-Đựng mỹ phẩm, trang sức gọn gàng\n-Kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp có màu sắc tươi sáng nổi bật.\n-Thiết kế nhỏ gọn tiện lợi.Cấu tạo ngăn đựng khoa học\n- Kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp được làm bằng chất liệu nhựa PP cao cấp, an toàn và siêu bền không thấm nước.\n-Thiết kế kệ thông minh với 3 tầng 2 ngăn kéo cùng nhiều ngăn nhỏ tiện dụng. Cấu tạo ngăn đựng khoa học. \n-Có thể dùng đựng mỹ phẩm, trang sức, đồ dùng học tập,... phù hợp để ở bàn trang điểm, bàn học góc làm việc giúp không gian gọn gàng hơn, các đồ mỹ phẩm không bị lẫn và giữ cho các lọ, chai không bị đổ vỡ.', 427, 1, 9, 245),
(69, 'Giỏ đựng đồ, giỏ decor trang trí nhà cửa, shop mỹ phẩm đa năng tiện lợi màu hồng pastel tặng kèm nơ xinh', 49000, 'Kệ đựng đồ đa năng đựng mĩ phẩm đồ trang điểm nhựa 3 tầng để bàn, khay để mỹ phẩm có hộp ngăn kéo tiện lợi\n\n-Chất liệu: Nhựa PP cao cấp\n-Màu sắc: Trắng, Hồng \n-Kích thước : 28,5 * 12,5 * 17cm\nĐặc điểm sản phẩm kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp:\n-Thiết kế nhiều ngăn nhỏ gọn, tiện dụng\n-Đựng mỹ phẩm, trang sức gọn gàng\n-Kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp có màu sắc tươi sáng nổi bật.\n-Thiết kế nhỏ gọn tiện lợi.Cấu tạo ngăn đựng khoa học\n- Kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp được làm bằng chất liệu nhựa PP cao cấp, an toàn và siêu bền không thấm nước.\n-Thiết kế kệ thông minh với 3 tầng 2 ngăn kéo cùng nhiều ngăn nhỏ tiện dụng. Cấu tạo ngăn đựng khoa học. \n-Có thể dùng đựng mỹ phẩm, trang sức, đồ dùng học tập,... phù hợp để ở bàn trang điểm, bàn học góc làm việc giúp không gian gọn gàng hơn, các đồ mỹ phẩm không bị lẫn và giữ cho các lọ, chai không bị đổ vỡ.', 642, 1, 9, 245),
(70, 'Bảng ghim bần khung gỗ treo tranh ảnh, ghi chú, postcard decor bàn học, bàn làm việc tặng kèm phụ kiện', 39000, 'Kệ đựng đồ đa năng đựng mĩ phẩm đồ trang điểm nhựa 3 tầng để bàn, khay để mỹ phẩm có hộp ngăn kéo tiện lợi\n\n-Chất liệu: Nhựa PP cao cấp\n-Màu sắc: Trắng, Hồng \n-Kích thước : 28,5 * 12,5 * 17cm\nĐặc điểm sản phẩm kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp:\n-Thiết kế nhiều ngăn nhỏ gọn, tiện dụng\n-Đựng mỹ phẩm, trang sức gọn gàng\n-Kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp có màu sắc tươi sáng nổi bật.\n-Thiết kế nhỏ gọn tiện lợi.Cấu tạo ngăn đựng khoa học\n- Kệ đựng mỹ phẩm 3 tầng 2 ngăn cao cấp được làm bằng chất liệu nhựa PP cao cấp, an toàn và siêu bền không thấm nước.\n-Thiết kế kệ thông minh với 3 tầng 2 ngăn kéo cùng nhiều ngăn nhỏ tiện dụng. Cấu tạo ngăn đựng khoa học. \n-Có thể dùng đựng mỹ phẩm, trang sức, đồ dùng học tập,... phù hợp để ở bàn trang điểm, bàn học góc làm việc giúp không gian gọn gàng hơn, các đồ mỹ phẩm không bị lẫn và giữ cho các lọ, chai không bị đổ vỡ.', 42, 1, 9, 245),
(71, 'Loa bluetooth Q5 bản cao cấp nhất hiện tại, kiêm đồng hồ, báo thức,nghe nhạc, nghe đài FM, hiển thị đèn led', 99000, 'GIỚI THIỆU:\nLoa bluetooth mini phiên bản Q5 mới cao cấp nhất hiện tại, kiêm đồng hồ báo thức ,nghe đài FM, màn hình tráng gương hiển thị đèn led - BH 1 đổi 1 lỗi nhà sản xuất\n\nTHÔNG TIN SẢN PHẨM: loa đồng hồ\n1. Dung lượng pin lớn 1400mAh cho phép chơi nhạc 5 giờ liên tiếp (tùy âm lượng). \n2. Chất lượng âm thanh cao chống ồn và tăng cường âm Bass.\n3. Loa bluetooth có Màn hình LED hiển thị lớn: LED hiển thị đồng hồ , báo thức, trạng thái chế độ, và nhiệt độ theo độ 4 . Bạn cũng có thể sử dụng nó như một chiếc gương soi. Và có thể điều chỉnh độ sáng 3 mức độ (BRIGHTEST, MIDDLE & LOWEST).\n5. Công nghệ Bluetooth mới nhất: Bluetooth 5.0 cho phép smartphone kết nối tới với khoảng cách lên tới 10M. Có microphone để nghe điện thọai ở chế độ rảnh tay.\n6. Dưng lượng pin bền hơn, nghe được lâu hơn, âm thanh bass được nâng cấp sịn hơn', 425, 1, 10, 245),
(72, 'Tranh cát chuyển động 3D đèn LED, tranh cát chảy nghệ thuật trang trí làm quà tặng, đèn ngủ để bàn đầu giường', 119000, 'GIỚI THIỆU: \nTranh cát chảy chuyển động 3D kết hợp đèn LED trang trí để bàn decor đèn ngủ làm quà tặng cao cấp\n\nTHÔNG TIN SẢN PHẨM: Tranh cát chảy chuyển động 3D tích hợp đèn LED\n - Là một món quà tuyệt vời cho các dịp tân gia, sinh nhật, tiệc tùng cho bạn bè, dùng để decor, trang trí nhà cửa, phòng ngủ, bàn làm việc\n- Được làm bằng thủy tinh, chất lỏng và nhựa, sản phẩm này có khả năng chống mài mòn và bền lâu.\n-  Những gì sản phẩm này có thể cung cấp cho bạn là có thể thêm một số nét hiện đại vào vị trí của bạn với hiệu ứng 3D và thiết kế cát chảy, mang đến cho bạn sự thoải mái, thư giãn và điềm tĩnh.', 412, 1, 10, 245),
(73, 'Đèn ngủ mặt trăng 3D mô hình phi hành gia đèn decor trang trí bàn làm việc, phòng ngủ siêu đẹp', 59000, 'GIỚI THIỆU: \nTranh cát chảy chuyển động 3D kết hợp đèn LED trang trí để bàn decor đèn ngủ làm quà tặng cao cấp\n\nTHÔNG TIN SẢN PHẨM: Tranh cát chảy chuyển động 3D tích hợp đèn LED\n - Là một món quà tuyệt vời cho các dịp tân gia, sinh nhật, tiệc tùng cho bạn bè, dùng để decor, trang trí nhà cửa, phòng ngủ, bàn làm việc\n- Được làm bằng thủy tinh, chất lỏng và nhựa, sản phẩm này có khả năng chống mài mòn và bền lâu.\n-  Những gì sản phẩm này có thể cung cấp cho bạn là có thể thêm một số nét hiện đại vào vị trí của bạn với hiệu ứng 3D và thiết kế cát chảy, mang đến cho bạn sự thoải mái, thư giãn và điềm tĩnh.', 42, 1, 10, 245),
(74, 'Ổ cắm điện đa năng thông minh kèm 2 cổng USB 5v sạc nhanh, ổ cắm chống giật chịu tải 2500W, tiết kiệm 30 kilowatt giờ', 49000, 'Ổ cắm điện đa năng là sản phẩm với kiểu dáng hiện đại, đơn giản, tinh tế được nhiều người ưa chuộng sử dụng trong ngôi nhà, tiện lợi di chuyển ổ cắm đến nhiều nơi với nhiều địa hình khác nhau\n\nỔ cắm điện đa năng thông minh kèm 2 cổng USB 5v sạc nhanh, ổ cắm chống giật chịu tải 2500W, tiết kiệm 30 kilowatt giờ\n\nThông tin sản phẩm ổ cắm điện đa năng thông minh:\n- Số ổ cắm: 3 phân loại \n- Dòng điện tối đa: 10A\n- Điện áp: 220V\n- Công suất tối đa: 2500W\n- Chiều dài dây: 1,8m đến 4m', 242, 1, 10, 245),
(75, 'ENVIROSAX Túi Xách Đan Thủ Công Thân Thiện Với Môi Trường Phong Cách Nhật Bản', 79000, 'Kích thước: 14 * 28 * 12 * 0,15cm\n\nGiới thiệu: Sản phẩm này là một chiếc túi xách dệt nhỏ thân thiện với môi trường. Sản phẩm này thân thiện với môi trường và chống mài mòn, thích hợp cho nhiều dịp khác nhau.\n Phần thân túi được tô điểm bằng những quả bóng sang trọng nhiều màu sắc giúp chiếc túi này trở nên dễ thương, nhiều màu sắc và rực rỡ hơn; rất thích hợp để đi du lịch hàng ngày cho các bé gái. \nSử dụng, thiết kế là độc đáo!!', 422, 1, 11, 245),
(76, 'Balo hình gấu bông hoạt hình xinh xắn thời trang dành cho các bé', 39000, 'Kích thước: 14 * 28 * 12 * 0,15cm\n\nGiới thiệu: Sản phẩm này là một chiếc túi xách dệt nhỏ thân thiện với môi trường. Sản phẩm này thân thiện với môi trường và chống mài mòn, thích hợp cho nhiều dịp khác nhau.\n Phần thân túi được tô điểm bằng những quả bóng sang trọng nhiều màu sắc giúp chiếc túi này trở nên dễ thương, nhiều màu sắc và rực rỡ hơn; rất thích hợp để đi du lịch hàng ngày cho các bé gái. \nSử dụng, thiết kế là độc đáo!!', 242, 1, 11, 245),
(77, 'Túi đeo vai ENVIROSAX vải nhung cỡ lớn phong cách retro dễ phối đồ thời trang cho học sinh, túi canvas đeo chéo cỡ lớn', 89000, 'Kích thước: 14 * 28 * 12 * 0,15cm\n\nGiới thiệu: Sản phẩm này là một chiếc túi xách dệt nhỏ thân thiện với môi trường. Sản phẩm này thân thiện với môi trường và chống mài mòn, thích hợp cho nhiều dịp khác nhau.\n Phần thân túi được tô điểm bằng những quả bóng sang trọng nhiều màu sắc giúp chiếc túi này trở nên dễ thương, nhiều màu sắc và rực rỡ hơn; rất thích hợp để đi du lịch hàng ngày cho các bé gái. \nSử dụng, thiết kế là độc đáo!!', 112, 1, 11, 245),
(78, 'Túi vải mới của Nhật Bản dành cho nữ sinh túi xách đeo vai có sức chứa lớn Túi đeo vai sinh viên', 69000, 'Kích thước: 14 * 28 * 12 * 0,15cm\n\nGiới thiệu: Sản phẩm này là một chiếc túi xách dệt nhỏ thân thiện với môi trường. Sản phẩm này thân thiện với môi trường và chống mài mòn, thích hợp cho nhiều dịp khác nhau.\n Phần thân túi được tô điểm bằng những quả bóng sang trọng nhiều màu sắc giúp chiếc túi này trở nên dễ thương, nhiều màu sắc và rực rỡ hơn; rất thích hợp để đi du lịch hàng ngày cho các bé gái. \nSử dụng, thiết kế là độc đáo!!', 42, 1, 11, 245),
(79, 'Son kem lì Herorange lâu trôi mềm mịn như nhung hàng nội địa Trung', 229000, 'Thời gian giao hàng dự kiến cho sản phẩm này là 7-9 ngày\n\nMô tả:\n\n1. Son môi dạng lỏng sẫm màu này giữ cho đôi môi mềm mại và tạo ra nhiều loại bình xịt, bao gồm tất cả các loại son môi màu đỏ cổ điển. Thoa lên môi để tạo màu son đẹp.\n2. Lớp dưỡng bên trên có thể dưỡng ẩm cho đôi môi luôn tươi trẻ và khỏe mạnh. Che môi bằng son kem sang trọng, nhẹ nhàng và không gây khô da.\n3. Màu son cổ điển này là sự kết hợp hoàn hảo giữa công thức siêu dưỡng ẩm và màu tối. Dòng son này sử dụng màu siêu mịn nên đầy sức sống, nhưng cảm giác rất nhẹ khi chạm vào. Kết cấu giống như mousse này lướt trên bề mặt kem mịn.\n4. Bất kể bạn cắn hay hôn bao nhiêu lần thì son bóng dạng kem sẽ kéo dài cả ngày! Vuốt với đầu bút chính xác và để lại màu đậm, có thể kéo dài cả ngày.\n5. Cho dù bạn là phụ nữ hay sinh viên, cho dù bạn mới trang điểm hay trang điểm. Bạn có thể chọn sản phẩm này.\n', 142, 1, 12, 245),
(80, 'Son Môi Gege Bear Dưỡng Ẩm Lâu Trôi Chống Thấm Nước Không Dễ Phai Màu Thiết Kế Hình Gấu Dễ Thương', 119000, 'Thời gian giao hàng dự kiến cho sản phẩm này là 7-9 ngày\n\nMô tả:\n\n1. Son môi dạng lỏng sẫm màu này giữ cho đôi môi mềm mại và tạo ra nhiều loại bình xịt, bao gồm tất cả các loại son môi màu đỏ cổ điển. Thoa lên môi để tạo màu son đẹp.\n2. Lớp dưỡng bên trên có thể dưỡng ẩm cho đôi môi luôn tươi trẻ và khỏe mạnh. Che môi bằng son kem sang trọng, nhẹ nhàng và không gây khô da.\n3. Màu son cổ điển này là sự kết hợp hoàn hảo giữa công thức siêu dưỡng ẩm và màu tối. Dòng son này sử dụng màu siêu mịn nên đầy sức sống, nhưng cảm giác rất nhẹ khi chạm vào. Kết cấu giống như mousse này lướt trên bề mặt kem mịn.\n4. Bất kể bạn cắn hay hôn bao nhiêu lần thì son bóng dạng kem sẽ kéo dài cả ngày! Vuốt với đầu bút chính xác và để lại màu đậm, có thể kéo dài cả ngày.\n5. Cho dù bạn là phụ nữ hay sinh viên, cho dù bạn mới trang điểm hay trang điểm. Bạn có thể chọn sản phẩm này.\n', 421, 1, 12, 245),
(81, 'Herorange Son Kem Hiệu Ứng Gương Dưỡng Ẩm Lâu Trôi Không Dính Cốc Màu Sắc Thời Trang', 129000, 'Thời gian giao hàng dự kiến cho sản phẩm này là 7-9 ngày\n\nMô tả:\n\n1. Son môi dạng lỏng sẫm màu này giữ cho đôi môi mềm mại và tạo ra nhiều loại bình xịt, bao gồm tất cả các loại son môi màu đỏ cổ điển. Thoa lên môi để tạo màu son đẹp.\n2. Lớp dưỡng bên trên có thể dưỡng ẩm cho đôi môi luôn tươi trẻ và khỏe mạnh. Che môi bằng son kem sang trọng, nhẹ nhàng và không gây khô da.\n3. Màu son cổ điển này là sự kết hợp hoàn hảo giữa công thức siêu dưỡng ẩm và màu tối. Dòng son này sử dụng màu siêu mịn nên đầy sức sống, nhưng cảm giác rất nhẹ khi chạm vào. Kết cấu giống như mousse này lướt trên bề mặt kem mịn.\n4. Bất kể bạn cắn hay hôn bao nhiêu lần thì son bóng dạng kem sẽ kéo dài cả ngày! Vuốt với đầu bút chính xác và để lại màu đậm, có thể kéo dài cả ngày.\n5. Cho dù bạn là phụ nữ hay sinh viên, cho dù bạn mới trang điểm hay trang điểm. Bạn có thể chọn sản phẩm này.\n', 42, 1, 12, 245),
(82, 'Son Kem CAPPUVINI Dưỡng Ẩm Lâu Trôi Thiết Kế Vỏ Son Hình Hành Tinh Màu Đen / Hồng Xinh Xắn', 99000, 'Thời gian giao hàng dự kiến cho sản phẩm này là 7-9 ngày\n\nMô tả:\n\n1. Son môi dạng lỏng sẫm màu này giữ cho đôi môi mềm mại và tạo ra nhiều loại bình xịt, bao gồm tất cả các loại son môi màu đỏ cổ điển. Thoa lên môi để tạo màu son đẹp.\n2. Lớp dưỡng bên trên có thể dưỡng ẩm cho đôi môi luôn tươi trẻ và khỏe mạnh. Che môi bằng son kem sang trọng, nhẹ nhàng và không gây khô da.\n3. Màu son cổ điển này là sự kết hợp hoàn hảo giữa công thức siêu dưỡng ẩm và màu tối. Dòng son này sử dụng màu siêu mịn nên đầy sức sống, nhưng cảm giác rất nhẹ khi chạm vào. Kết cấu giống như mousse này lướt trên bề mặt kem mịn.\n4. Bất kể bạn cắn hay hôn bao nhiêu lần thì son bóng dạng kem sẽ kéo dài cả ngày! Vuốt với đầu bút chính xác và để lại màu đậm, có thể kéo dài cả ngày.\n5. Cho dù bạn là phụ nữ hay sinh viên, cho dù bạn mới trang điểm hay trang điểm. Bạn có thể chọn sản phẩm này.\n', 422, 1, 12, 245);
...
CREATE TABLE `tbl_product_image` (
  ...
  `fourthImage` text DEFAULT NULL,
  `fivethImage` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_product_image` (`idProduct`, `firstImage`, `secondImage`, `thirdImage`, `fourthImage`, `fivethImage`) VALUES
(1, 'ttn11.png', 'ttn12.png', 'ttn13.png', 'ttn14.png', 'ttn15.png'),
(2, 'ttn21.png', 'ttn22.png', 'ttn23.png', 'ttn24.png', 'ttn25.png'),
(3, 'ttn31.png', 'ttn32.png', 'ttn33.png', 'ttn34.png', 'ttn35.png'),
(4, 'ttnu11.png', 'ttnu12.png', 'ttnu13.png', 'ttnu14.png', 'ttnu15.png'),
(5, 'ttnu21.png', 'ttnu22.png', 'ttnu23.png', 'ttnu24.png', 'ttnu25.png'),
(6, 'ttnu31.png', 'ttnu32.png', 'ttnu33.png', 'ttnu34.png', 'ttnu35.png'),
(7, 'dt11.png', 'dt12.png', 'dt13.png', 'dt14.png', 'dt15.png'),
(8, 'dt21.png', 'dt22.png', 'dt23.png', 'dt24.png', 'dt25.png'),
(9, 'dt31.png', 'dt32.png', 'dt33.png', 'dt34.png', 'dt35.png'),
(10, 'balo11.png', 'balo12.png', 'balo13.png', 'balo14.png', 'balo15.png'),
(11, 'balo21.png', 'balo22.png', 'balo23.png', 'balo24.png', 'balo25.png'),
(12, 'dh11.png', 'dh12.png', 'dh13.png', 'dh14.png', 'dh15.png'),
(13, 'dh21.png', 'dh22.png', 'dh23.png', 'dh24.png', 'dh25.png'),
(14, 'gdn11.png', 'gdn12.png', 'gdn13.png', 'gdn14.png', 'gdn15.png'),
(15, 'ttnu41.png', 'ttnu42.png', 'ttnu43.png', 'ttnu44.png', 'ttnu45.png'),
(16, 'ttn41.png', 'ttn42.png', 'ttn43.png', 'ttn44.png', 'ttn45.png'),
(17, 'ttn51.png', 'ttn52.png', 'ttn53.png', 'ttn54.png', 'ttn55.png'),
(18, 'gdn21.png', 'gdn22.png', 'gdn23.png', 'gdn24.png', 'gdn25.png'),
(19, 'gdnu11.png', 'gdnu12.png', 'gdnu13.png', 'gdnu14.png', 'gdnu15.png'),
(20, 'gdnu21.png', 'gdnu22.png', 'gdnu23.png', 'gdnu24.png', 'gdnu25.png'),
(21, 'lap11.png', 'lap12.png', 'lap13.png', 'lap14.png', 'lap15.png'),
(22, 'lap21.png', 'lap22.png', 'lap23.png', 'lap24.png', 'lap25.png'),
(23, 'tbgd11.png', 'tbgd12.png', 'tbgd13.png', 'tbgd14.png', 'tbgd15.png'),
(24, 'tbgd21.png', 'tbgd22.png', 'tbgd23.png', 'tbgd24.png', 'tbgd25.png'),
(25, 'dh31.png', 'dh32.png', 'dh33.png', 'dh34.png', 'dh35.png'),
(26, 'balo31.png', 'balo32.png', 'balo33.png', 'balo34.png', 'balo35.png'),
(27, 'dt41.png', 'dt42.png', 'dt43.png', 'dt44.png', 'dt45.png'),
(28, 'dt51.png', 'dt52.png', 'dt53.png', 'dt54.png', 'dt55.png'),
(29, 'tbdt11.png', 'tbdt12.png', 'tbdt13.png', 'tbdt14.png', 'tbdt15.png'),
(30, 'tbdt21.png', 'tbdt22.png', 'tbdt23.png', 'tbdt24.png', 'tbdt25.png'),
(31, 'txn11.png', 'txn12.png', 'txn13.png', 'txn14.png', 'txn15.png'),
(32, 'txn21.png', 'txn22.png', 'txn23.png', 'txn24.png', 'txn25.png'),
(33, 'sd11.png', 'sd12.png', 'sd13.png', 'sd14.png', 'sd15.png'),
(34, 'sd21.png', 'sd22.png', 'sd23.png', 'sd24.png', 'sd25.png'),
(35, 'ttn61.png', 'ttn62.png', 'ttn63.png', 'ttn64.png', 'ttn65.png'),
(36, 'ttn111.png', 'ttn112.png', 'ttn113.png', 'ttn114.png', 'ttn115.png'),
(37, 'ttn71.png', 'ttn72.png', 'ttn73.png', 'ttn74.png', 'ttn75.png'),
(38, 'ttn81.png', 'ttn82.png', 'ttn83.png', 'ttn84.png', 'ttn85.png'),
(39, 'ttn91.png', 'ttn92.png', 'ttn93.png', 'ttn94.png', 'ttn95.png'),
(40, 'ttn101.png', 'ttn102.png', 'ttn103.png', 'ttn104.png', 'ttn105.png'),
(41, 'ttnu51.png', 'ttnu52.png', 'ttnu53.png', 'ttnu54.png', 'ttnu55.png'),
(42, 'ttnu61.png', 'ttnu62.png', 'ttnu63.png', 'ttnu64.png', 'ttnu65.png'),
(43, 'ttnu71.png', 'ttnu72.png', 'ttnu73.png', 'ttnu74.png', 'ttnu75.png'),
(44, 'ttnu81.png', 'ttnu82.png', 'ttnu83.png', 'ttnu84.png', 'ttnu85.png'),
(45, 'balo41.png', 'balo42.png', 'balo43.png', 'balo44.png', 'balo45.png'),
(46, 'balo51.png', 'balo52.png', 'balo53.png', 'balo54.png', 'balo55.png'),
(47, 'balo61.png', 'balo62.png', 'balo63.png', 'balo64.png', 'balo65.png'),
(48, 'balo71.png', 'balo72.png', 'balo73.png', 'balo74.png', 'balo75.png'),
(49, 'dt61.png', 'dt62.png', 'dt63.png', 'dt64.png', 'dt65.png'),
(50, 'dt71.png', 'dt72.png', 'dt73.png', 'dt74.png', 'dt75.png'),
(51, 'dt81.png', 'dt82.png', 'dt83.png', 'dt84.png', 'dt85.png'),
(52, 'dh41.png', 'dh42.png', 'dh43.png', 'dh44.png', 'dh45.png'),
(53, 'dh51.png', 'dh52.png', 'dh53.png', 'dh54.png', 'dh55.png'),
(54, 'dh61.png', 'dh62.png', 'dh63.png', 'dh64.png', 'dh65.png'),
(55, 'gdn31.png', 'gdn32.png', 'gdn33.png', 'gdn34.png', 'gdn35.png'),
(56, 'gdn41.png', 'gdn42.png', 'gdn43.png', 'gdn44.png', 'gdn45.png'),
(57, 'gdn51.png', 'gdn52.png', 'gdn53.png', 'gdn54.png', 'gdn55.png'),
(58, 'gdn61.png', 'gdn62.png', 'gdn63.png', 'gdn64.png', 'gdn65.png'),
(59, 'gdnu31.png', 'gdnu32.png', 'gdnu33.png', 'gdnu34.png', 'gdnu35.png'),
(60, 'gdnu41.png', 'gdnu42.png', 'gdnu43.png', 'gdnu44.png', 'gdnu45.png'),
(61, 'gdnu51.png', 'gdnu52.png', 'gdnu53.png', 'gdnu54.png', 'gdnu55.png'),
(62, 'gdnu61.png', 'gdnu62.png', 'gdnu63.png', 'gdnu64.png', 'gdnu65.png'),
(63, 'lap31.png', 'lap32.png', 'lap33.png', 'lap34.png', 'lap35.png'),
(64, 'lap41.png', 'lap42.png', 'lap43.png', 'lap44.png', 'lap45.png'),
(65, 'lap51.png', 'lap52.png', 'lap53.png', 'lap54.png', 'lap55.png'),
(66, 'lap61.png', 'lap62.png', 'lap63.png', 'lap64.png', 'lap65.png'),
(67, 'tbgd31.png', 'tbgd32.png', 'tbgd33.png', 'tbgd34.png', 'tbgd35.png'),
(68, 'tbgd41.png', 'tbgd42.png', 'tbgd43.png', 'tbgd44.png', 'tbgd45.png'),
(69, 'tbgd51.png', 'tbgd52.png', 'tbgd53.png', 'tbgd54.png', 'tbgd55.png'),
(70, 'tbgd61.png', 'tbgd62.png', 'tbgd63.png', 'tbgd64.png', 'tbgd65.png'),
(71, 'tbdt31.png', 'tbdt32.png', 'tbdt33.png', 'tbdt34.png', 'tbdt35.png'),
(72, 'tbdt41.png', 'tbdt42.png', 'tbdt43.png', 'tbdt44.png', 'tbdt45.png'),
(73, 'tbdt51.png', 'tbdt52.png', 'tbdt53.png', 'tbdt54.png', 'tbdt55.png'),
(74, 'tbdt61.png', 'tbdt62.png', 'tbdt63.png', 'tbdt64.png', 'tbdt65.png'),
(75, 'txn31.png', 'txn32.png', 'txn33.png', 'txn34.png', 'txn35.png'),
(76, 'txn41.png', 'txn42.png', 'txn43.png', 'txn44.png', 'txn45.png'),
(77, 'txn51.png', 'txn52.png', 'txn53.png', 'txn54.png', 'txn55.png'),
(78, 'txn61.png', 'txn62.png', 'txn63.png', 'txn64.png', 'txn65.png'),
(79, 'sd31.png', 'sd32.png', 'sd33.png', 'sd34.png', 'sd35.png'),
(80, 'sd41.png', 'sd42.png', 'sd43.png', 'sd44.png', 'sd45.png'),
(81, 'sd51.png', 'sd52.png', 'sd53.png', 'sd54.png', 'sd55.png'),
(82, 'sd61.png', 'sd62.png', 'sd63.png', 'sd64.png', 'sd65.png');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_product_rate`
--

CREATE TABLE `tbl_product_rate` (
  `idProduct` int(11) NOT NULL,
  `idAccount` int(11) NOT NULL,
  `rate` int(11) DEFAULT NULL,
  `feedBack` text DEFAULT NULL,
  `timeRate` date DEFAULT NULL,
  `firstImage` text DEFAULT NULL,
  `secondImage` text DEFAULT NULL,
  `thirdImage` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping data for table `tbl_product_rate`
--

INSERT INTO `tbl_product_rate` (`idProduct`, `idAccount`, `rate`, `feedBack`, `timeRate`, `firstImage`, `secondImage`, `thirdImage`) VALUES
(1, 1, 4, 'Sản phẩm rất đẹp vừa vặn, nhưng giao hàng khá lâu.', '2023-06-10', 'fb1.png', 'fb2.png', 'fb3.png'),
(1, 2, 5, 'Giao hàng đúng ngày, shop tư vấn rất nhiệt tình', '2023-05-15', NULL, NULL, NULL),
(1, 3, 4, 'Form vải đẹp, mặt vừa vặn, thoải mái, đáng mua nha', '2023-06-17', 'fb4.png', 'fb5.png', 'fb6.png'),
(1, 4, 5, 'Quá là ưng ý, sản phẩm vừa rẻ vừa đẹp', '2023-06-17', NULL, NULL, NULL),
(1, 5, 4, 'Rất tốt trong tầm giá này', '2023-04-12', NULL, NULL, NULL),
(2, 1, 4, 'Sản phẩm rất đẹp vừa vặn, nhưng giao hàng khá lâu.', '2023-06-10', NULL, NULL, NULL),
(2, 2, 5, 'Áo đẹp giao nhanh mắt lé lên hình rất ngầu và đẹp xịn sò con bò cho 5 sao', '2023-05-15', 'fb21.png', 'fb22.png', NULL),
(2, 3, 4, 'Vải dày dặn đẹp ạ,giao hàng nhanh đúng số lươmg đúng size đúng màu ạ giông với mô tả', '2023-06-17', 'fb23.png', 'fb24.png', 'fb25.png'),
(3, 1, 4, 'Áo chất lượng tốt so với giá tiền. Chất liệu vải mềm mịn và co dãn tốt. Màu sắc đúng như hình.', '2023-06-10', NULL, NULL, NULL),
(3, 2, 5, 'Áo rất là đẹp mình thích mặc rộng nên đặt size xL giao hàng nhanhh síp pơ thì dĩa huông lắm nhaaa áo rẻ mà chất lượng tốt lắmm ạa đáng đồng tiền nch là nên muaa', '2023-05-15', 'fb31.png', 'fb32.png', 'fb33.png'),
(3, 3, 5, 'Vải dày dặn đẹp ạ,giao hàng nhanh đúng số lươmg đúng size đúng màu ạ giông với mô tả', '2023-06-17', 'fb34.png', NULL, NULL),
(3, 4, 4, 'Sản phẩm rất đẹp vừa vặn, nhưng giao hàng khá lâu.', '2023-06-10', NULL, NULL, NULL),
(3, 5, 5, 'Áo rẻ mà chất lượng cực kì nha mng form và chất vải đẹp mặc mát mng muốn mặc rộng xíu ko bị bó bắp tay thì nên đặt xxl nha lần sau sẽ ủng hộ shop tiếp nè', '2023-06-10', 'fb35.png', 'fb36.png', NULL),
(5, 2, 5, 'Tui m50 47kg mặc như hình. Boăn khoăn cỡ 2 tuần mới dám đặt. Tui thề là nó đẹp hơn trong hình tui chụp í mn.', '2023-05-15', 'fb51.png', 'fb52.png', NULL),
(5, 3, 4, 'Vải dày dặn đẹp ạ,giao hàng nhanh đúng số lươmg đúng size đúng màu ạ giông với mô tả', '2023-06-17', 'fb53.png', 'fb54.png', 'fb55.png'),
(5, 5, 5, 'Hùi ui xinh vãi chưởng các bà ạ.Đầm ôm,vải thích lắm,ai có mỡ thì mua luôn đi,đẹp quá nên để đó nào giảm cân xong mặc đi choáy phố.', '2023-06-10', NULL, NULL, NULL),
(7, 1, 5, 'Máy nguyên seal nguyên hộp chưa active! Lần thứ 2 mua hàng và vẫn rất hài lòng', '2023-06-10', 'fb71.png', 'fb72.png', NULL),
(7, 2, 5, 'Đã mua tại gian hàng chính hãng nhiều lần nên hoàn toàn yên tâm về chất lượng sản phẩm. Mã hàng VN. Shop ship nhanh.', '2023-05-15', NULL, NULL, NULL),
(7, 3, 5, 'Đẹp, đóng gói cẩn thận, kĩ càng, giao nhanh gọn lẹ. Iphone 14 này khung vuông vắn, cầm chắc tay.', '2023-06-17', 'fb76.png', 'fb77.png', 'fb78.png'),
(7, 4, 4, 'Sản phẩm tốt. Shop có hóa đơn đầy đủ. Nói chung là oke nhé', '2023-06-10', 'fb73.png', 'fb74.png', 'fb75.png'),
(7, 5, 5, 'Nhận hàng sau 5 ngày, lúc đầu cũng hơi rén đặt qua shoppee nên nhận hàng phải quay lại video đầy đủ.', '2023-05-15', NULL, NULL, NULL),
(8, 1, 4, 'Sản phẩm chính hãng còn nguyên tem, chất lượng tuyệt vời, đóng gói cực kì cẩn thận', '2023-06-10', NULL, NULL, NULL),
(8, 2, 5, 'Hàng chất lượng giá cả phải chăng mik mua lúc đang giảm nên giá rất rẻ sản phẩm tốt chưa dùng chưa bít cho shop 5s sẽ ủng hộ shop nhìu', '2023-05-15', 'fb81.png', 'fb82.png', NULL),
(8, 3, 5, 'Mình mua Black Friday được giảm thêm 200k. Giá rẻ, mua cho mẹ dùng. Shop đóng gói cẩn thận, giao hàng siêu nhanh.', '2023-06-17', 'fb83.png', 'fb84.png', 'fb85.png'),
(9, 1, 4, 'Hàng đóng gói rất cẩn thận. Còn nguyên seal, ko cấn móp. Đúng mẫu mả đã chọn. Kết nối wifi nhanh chóng, ko lỗi lầm gi.', '2023-06-10', NULL, NULL, NULL),
(9, 2, 4, 'Nhận được hàng mà hú hồn. Hộp bị móp 2 góc trên và dưới vết móp này chắc do bị rơi trước lúc đóng gói, còn lại ok đầy đủ phụ kiện.', '2023-05-15', NULL, NULL, NULL),
(9, 3, 5, 'Đã nhận được sản phẩm đúng như mô tả chất lượng của iPhone thì quá yên tâm giao hàng khá nhanh! Mua được giá quá tốt so với mong đợi', '2023-06-17', NULL, NULL, NULL),
(9, 4, 5, 'Mua đợt giảm giá so với niêm yết giảm được hơn 10%. Máy chạy mượt, nói chung quá tốt .', '2023-06-12', NULL, NULL, NULL),
(9, 5, 5, 'Hàng chuẩn chính hãng, shop đóng gói rất cẩn thận và giao hàng cũng rất đúng hẹn.', '2023-05-10', NULL, NULL, NULL),
(10, 2, 5, 'Shop giao hàng siêu nhanh,gói hàng cẩn thận,balo giống đúng như hình,mẫu mã trẻ trung thời trang,màu sắc đẹp xịn xò,dây đeo chắc chắn,chất lượng quá ok so với giá tiền,5sao nhé shop', '2023-05-15', NULL, NULL, NULL),
(10, 3, 5, 'Vải dày dặn đẹp ạ,giao hàng nhanh đúng số lươmg đúng size đúng màu ạ giông với mô tả', '2023-06-17', NULL, NULL, NULL),
(10, 5, 5, 'Bự vãi lồng sương sương 5 ngăn bà bự chà bá đựng đồ siêuuuu đã siêu nhiều đồ lun í đẹp phối màu đỉnh đẹp trắng đen đỏ phối rất đẹp rất chuẩn hàng còn bự hơn trong hình nữa chứ chốt lại bự đẹp nhiều ngăn phối màu chuẩn đỉnh gút chóppp', '2023-06-10', NULL, NULL, NULL),
(11, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(11, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(11, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(11, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(11, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(12, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(12, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(12, 3, 5, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(12, 4, 3, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(12, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(13, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(13, 2, 2, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(13, 3, 2, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(13, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(13, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(14, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(14, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(14, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(14, 4, 5, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(14, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(15, 1, 4, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(15, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(15, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(15, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(15, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(16, 1, 4, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(16, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(16, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(16, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(16, 5, 4, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(17, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(17, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(17, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(17, 4, 5, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(17, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(18, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(18, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(18, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(18, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(18, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(19, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(19, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(19, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(19, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(19, 5, 4, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(20, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(20, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(20, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(20, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(20, 5, 3, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(21, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(21, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(21, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(21, 4, 3, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(21, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(22, 1, 3, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(22, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(22, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(22, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(22, 5, 4, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(23, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(23, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(23, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(23, 4, 5, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(23, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(24, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(24, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(24, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(24, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(24, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(25, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(25, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(25, 3, 5, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(25, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(25, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(26, 1, 3, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(26, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(26, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(26, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(26, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(27, 1, 3, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(27, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(27, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(27, 4, 5, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(27, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(28, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(28, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(28, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(28, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(28, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(29, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(29, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(29, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(29, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(29, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(30, 1, 4, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(30, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(30, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(30, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(30, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(31, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(31, 2, 5, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(31, 3, 5, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(31, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(31, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(32, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(32, 2, 5, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(32, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(32, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(32, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(33, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(33, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(33, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(33, 4, 5, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(33, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(34, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(34, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(34, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(34, 4, 3, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(34, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(35, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(35, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(35, 3, 5, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(35, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(35, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(36, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(36, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(36, 3, 3, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(36, 4, 3, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(36, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(37, 1, 4, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(37, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(37, 3, 3, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(37, 4, 5, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(37, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(38, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(38, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(38, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(38, 4, 3, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(38, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(39, 1, 4, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(39, 2, 4, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(39, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(39, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(39, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL),
(40, 1, 5, 'Giao hàng nhanh, đóng góp cẩn thận, sẽ mua thêm vào lần tới.', '2023-04-23', NULL, NULL, NULL),
(40, 2, 5, 'Giao hàng chậm, hộp bị cấn, móp, tôi không hài lòng về dịch vụ giao hàng', '2023-05-23', NULL, NULL, NULL),
(40, 3, 4, 'Sản phẩm đúng với mô tả, shop này uy tín sẽ ủng hộ tiếp.', '2023-04-29', NULL, NULL, NULL),
(40, 4, 4, 'Nói chung cũng ok, ngoài trừ việc giao hàng hơn 7 ngày.', '2023-03-23', NULL, NULL, NULL),
(40, 5, 5, 'Hàng về tay giống như hình, ảnh thật, shop đáng tin cậy', '2023-04-23', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_provine`
--

CREATE TABLE `tbl_provine` (
  `idProvine` int(11) NOT NULL,
  `nameProvine` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_provine`
--

INSERT INTO `tbl_provine` (`idProvine`, `nameProvine`) VALUES
(1, 'Thành phố Hà Nội'),
(2, 'Tỉnh Hà Giang'),
(4, 'Tỉnh Cao Bằng'),
(6, 'Tỉnh Bắc Kạn'),
...
--
-- Table structure for table `tbl_sale_off`
--
...
--
-- Dumping data for table `tbl_sale_off`
--

INSERT INTO `tbl_sale_off` (`idProduct`, `oldPrice`, `salePrice`, `startTime`, `endTime`, `quantityLimit`) VALUES
(2, 97000, 79000, '2023-01-01', '2024-01-01', 200),
(3, 49000, 39000, '2023-01-01', '2024-01-01', 400),
(5, 235000, 199000, '2023-01-01', '2024-01-01', 50),
(7, 32000000, 29900000, '2023-01-01', '2024-01-01', 1000),
(8, 23000000, 21000000, '2023-01-01', '2024-01-01', 500),
(11, 195000, 155000, '2023-01-01', '2024-01-01', 200),
(13, 2900000, 1900000, '2023-01-01', '2024-01-01', 100),
(17, 239000, 199000, '2023-01-01', '2024-01-01', 400),
(21, 1225000, 998000, '2023-01-01', '2024-01-01', 500),
(25, 79000, 59000, '2023-01-01', '2024-01-01', 300),
(28, 249000, 199000, '2023-01-01', '2024-01-01', 300),
(30, 65000, 49000, '2023-01-01', '2024-01-01', 100),
(31, 72000, 55000, '2023-01-01', '2024-01-01', 150),
(33, 299000, 199000, '2023-01-01', '2024-01-01', 300),
(34, 118000, 79000, '2023-01-01', '2024-01-01', 150);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_ship_code`
--

CREATE TABLE `tbl_ship_code` (
  `codeShip` char(20) NOT NULL,
  `nameShip` varchar(50) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `days` int(11) DEFAULT NULL,
  `imageShip` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_ship_code`
--

INSERT INTO `tbl_ship_code` (`codeShip`, `nameShip`, `price`, `days`, `imageShip`) VALUES
('giaohanghoatoc', 'Giao hàng hỏa tốc', 45000, 1, 'hoatoc.png'),
('giaohangj&t', 'Giao hàng J&T', 20000, 4, 'j&t.png'),
('giaohangnhanh', 'Giao hàng nhanh', 25000, 3, 'giaohangnhanh.png'),
('giaohangtietkiem', 'Giao hàng tiết kiệm', 15000, 5, 'giaohangtietkiem.png'),
('viettelpost', 'Viettel Post', 30000, 3, 'viettelpost.png');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_shop_follow`
--

CREATE TABLE `tbl_shop_follow` (
  `idAccount` int(11) NOT NULL,
  `idShop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_shop_follow`
--

INSERT INTO `tbl_shop_follow` (`idAccount`, `idShop`) VALUES
(1, 1),
(1, 2),
(2, 1),
(2, 2),
...
--
-- Table structure for table `tbl_shop_of_seller`
--

CREATE TABLE `tbl_shop_of_seller` (
  `idShop` int(11) NOT NULL,
  `nameShop` varchar(100) DEFAULT NULL,
  `addressShop` text DEFAULT NULL,
  `joinDate` date DEFAULT NULL,
  `imageShop` text DEFAULT NULL,
  `idAccount` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_shop_of_seller`
--

INSERT INTO `tbl_shop_of_seller` (`idShop`, `nameShop`, `addressShop`, `joinDate`, `imageShop`, `idAccount`) VALUES
(1, 'Cheaper Shop', '140 Lê Trọng Tấn, Tân Sơn Nhì, Tân Phú, TP.HCM', '2023-10-06', 'cheapershop.png', 4),
(2, 'MELIA SHOP', '482/PTHA, Phước Ngãi, Ba Tri, Bến Tre', '2023-10-06', 'melia.png', 5);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_shop_voucher`
--

CREATE TABLE `tbl_shop_voucher` (
  `codeVoucher` char(20) NOT NULL,
  `idShop` int(11) NOT NULL,
  `nameVoucher` varchar(100) DEFAULT NULL,
  `conditionPrice` int(11) DEFAULT NULL,
  `percentOff` int(11) DEFAULT NULL,
  `maxPriceOff` int(11) DEFAULT NULL,
  `startTime` date DEFAULT NULL,
  `endTime` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_shop_voucher`
--

INSERT INTO `tbl_shop_voucher` (`codeVoucher`, `idShop`, `nameVoucher`, `conditionPrice`, `percentOff`, `maxPriceOff`, `startTime`, `endTime`) VALUES
('quockhanh2023', 1, 'Mừng ngày quốc khánh 02-09-2023', 500000, 20, 50000, '2023-09-02', '2023-09-05'),
('quockhanh2023', 2, 'Mừng ngày quốc khánh 02-09-2023', 500000, 20, 50000, '2023-09-02', '2023-09-05'),
('quoctephunu2023', 1, 'Mừng ngày quốc tế phụ nữ 08-03-2023', 200000, 20, 20000, '2023-03-07', '2023-03-09'),
('quoctephunu2023', 2, 'Mừng ngày quốc tế phụ nữ 8-3-2023', 200000, 20, 20000, '2023-03-07', '2023-03-09'),
('quoctethieunhi2023', 1, 'Mừng ngày quốc tế thiếu nhi 01-06-2023', 100000, 10, 5000, '2023-06-01', '2023-06-03'),
('ramthang7', 1, 'Rằm tháng 7', 20000, 50, 50000, '2023-07-01', '2023-08-01');
...
CREATE TABLE `tbl_ward` (
  `idWard` int(11) NOT NULL,
  `nameWard` varchar(100) DEFAULT NULL,
  `idDistrict` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_ward` (`idWard`, `nameWard`, `idDistrict`) VALUES
(1, 'Phường Phúc Xá', 1),
...
ALTER TABLE `tbl_account`
  ...
  ADD KEY `FK_account_permission` (`codePermission`);

--
-- Indexes for table `tbl_cart`
--
ALTER TABLE `tbl_cart`
  ADD PRIMARY KEY (`idAccount`,`idSegment`),
  ADD KEY `FK_cart_classify_product` (`idSegment`);
...
--
-- Indexes for table `tbl_classify`
--
ALTER TABLE `tbl_classify`
  ADD PRIMARY KEY (`codeClassify`);

--
-- Indexes for table `tbl_classify_product`
--
ALTER TABLE `tbl_classify_product`
  ADD PRIMARY KEY (`idSegment`),
  ADD KEY `FK_classify_product_product` (`idProduct`),
  ADD KEY `FK_classify_product_classify` (`codeClassify`);
...
ALTER TABLE `tbl_contact`
  ...
  ADD KEY `FK_contact_account` (`idAccount`),
  ADD KEY `FK_contact_shop_seller` (`idShop`);
...
ALTER TABLE `tbl_delivery_address`
  ...
  ADD KEY `FK_delivery_account` (`idAccount`),
  ADD KEY `FK_delivery_ward` (`idWard`);

--
-- Indexes for table `tbl_detail_oder`
--
ALTER TABLE `tbl_detail_oder`
  ADD PRIMARY KEY (`idOder`,`idSegment`),
  ADD KEY `FK_detail_oder_classify_product` (`idSegment`);
...
ALTER TABLE `tbl_district`
  ...
  ADD KEY `FK_district_provine` (`idProvine`);
...
ALTER TABLE `tbl_oder`
  ...
  ADD KEY `FK_oder_delivery` (`idDelivery`),
  ADD KEY `FK_oder_voucher` (`codeVoucher`),
  ADD KEY `FK_oder_pay` (`codePay`),
  ADD KEY `FK_oder_ship_code` (`codeShip`);

--
-- Indexes for table `tbl_pay`
--
ALTER TABLE `tbl_pay`
  ADD PRIMARY KEY (`codePay`);
...
ALTER TABLE `tbl_product`
  ...
  ADD KEY `FK_product_shop` (`idShop`),
  ADD KEY `FK_product_category` (`idCategory`),
  ADD KEY `FK_product_country` (`idCountry`);
...
--
-- Indexes for table `tbl_product_rate`
--
ALTER TABLE `tbl_product_rate`
  ADD PRIMARY KEY (`idProduct`,`idAccount`),
  ADD KEY `FK_product_rate_account` (`idAccount`);

--
-- Indexes for table `tbl_provine`
--
ALTER TABLE `tbl_provine`
  ADD PRIMARY KEY (`idProvine`);

--
-- Indexes for table `tbl_sale_off`
--
ALTER TABLE `tbl_sale_off`
  ADD PRIMARY KEY (`idProduct`);

--
-- Indexes for table `tbl_ship_code`
--
ALTER TABLE `tbl_ship_code`
  ADD PRIMARY KEY (`codeShip`);

--
-- Indexes for table `tbl_shop_follow`
--
ALTER TABLE `tbl_shop_follow`
  ADD PRIMARY KEY (`idAccount`,`idShop`);

--
-- Indexes for table `tbl_shop_of_seller`
--
ALTER TABLE `tbl_shop_of_seller`
  ADD PRIMARY KEY (`idShop`),
  ADD KEY `FK_shop_of_seller_account` (`idAccount`);

--
-- Indexes for table `tbl_shop_voucher`
--
ALTER TABLE `tbl_shop_voucher`
  ADD PRIMARY KEY (`codeVoucher`,`idShop`),
  ADD KEY `FK_shop_voucher_shop_seller` (`idShop`);
...
ALTER TABLE `tbl_ward`
  ...
  ADD KEY `FK_ward_district` (`idDistrict`);
...
--
ALTER TABLE `tbl_category`
  MODIFY `idCategory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `tbl_classify_product`
--
ALTER TABLE `tbl_classify_product`
  MODIFY `idSegment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=537;
...
--
ALTER TABLE `tbl_country`
  MODIFY `idCountry` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=253;
...
--
-- AUTO_INCREMENT for table `tbl_provine`
--
ALTER TABLE `tbl_provine`
  MODIFY `idProvine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;

--
-- AUTO_INCREMENT for table `tbl_shop_of_seller`
--
ALTER TABLE `tbl_shop_of_seller`
...
--
ALTER TABLE `tbl_ward`
  MODIFY `idWard` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32249;
...
--
ALTER TABLE `tbl_account`
  ADD CONSTRAINT `FK_account_permission` FOREIGN KEY (`codePermission`) REFERENCES `tbl_permission` (`codePermission`);

--
-- Constraints for table `tbl_cart`
--
ALTER TABLE `tbl_cart`
  ADD CONSTRAINT `FK_cart_account` FOREIGN KEY (`idAccount`) REFERENCES `tbl_account` (`idAccount`),
  ADD CONSTRAINT `FK_cart_classify_product` FOREIGN KEY (`idSegment`) REFERENCES `tbl_classify_product` (`idSegment`);

--
-- Constraints for table `tbl_classify_product`
--
ALTER TABLE `tbl_classify_product`
  ADD CONSTRAINT `FK_classify_product_classify` FOREIGN KEY (`codeClassify`) REFERENCES `tbl_classify` (`codeClassify`),
  ADD CONSTRAINT `FK_classify_product_product` FOREIGN KEY (`idProduct`) REFERENCES `tbl_product` (`idProduct`);

--
-- Constraints for table `tbl_contact`
--
ALTER TABLE `tbl_contact`
  ADD CONSTRAINT `FK_contact_account` FOREIGN KEY (`idAccount`) REFERENCES `tbl_account` (`idAccount`),
  ADD CONSTRAINT `FK_contact_shop_seller` FOREIGN KEY (`idShop`) REFERENCES `tbl_shop_of_seller` (`idShop`);

--
-- Constraints for table `tbl_delivery_address`
--
ALTER TABLE `tbl_delivery_address`
  ADD CONSTRAINT `FK_delivery_account` FOREIGN KEY (`idAccount`) REFERENCES `tbl_account` (`idAccount`),
  ADD CONSTRAINT `FK_delivery_ward` FOREIGN KEY (`idWard`) REFERENCES `tbl_ward` (`idWard`);

--
-- Constraints for table `tbl_detail_oder`
--
ALTER TABLE `tbl_detail_oder`
  ADD CONSTRAINT `FK_detail_oder_classify_product` FOREIGN KEY (`idSegment`) REFERENCES `tbl_classify_product` (`idSegment`),
  ADD CONSTRAINT `FK_detail_oder_oder` FOREIGN KEY (`idOder`) REFERENCES `tbl_oder` (`idOder`);

--
-- Constraints for table `tbl_district`
--
ALTER TABLE `tbl_district`
  ADD CONSTRAINT `FK_district_provine` FOREIGN KEY (`idProvine`) REFERENCES `tbl_provine` (`idProvine`);

--
-- Constraints for table `tbl_oder`
--
ALTER TABLE `tbl_oder`
  ADD CONSTRAINT `FK_oder_delivery` FOREIGN KEY (`idDelivery`) REFERENCES `tbl_delivery_address` (`idDelivery`),
  ADD CONSTRAINT `FK_oder_pay` FOREIGN KEY (`codePay`) REFERENCES `tbl_pay` (`codePay`),
  ADD CONSTRAINT `FK_oder_ship_code` FOREIGN KEY (`codeShip`) REFERENCES `tbl_ship_code` (`codeShip`),
  ADD CONSTRAINT `FK_oder_voucher` FOREIGN KEY (`codeVoucher`) REFERENCES `tbl_shop_voucher` (`codeVoucher`);

--
-- Constraints for table `tbl_product`
--
ALTER TABLE `tbl_product`
  ADD CONSTRAINT `FK_product_category` FOREIGN KEY (`idCategory`) REFERENCES `tbl_category` (`idCategory`),
  ADD CONSTRAINT `FK_product_country` FOREIGN KEY (`idCountry`) REFERENCES `tbl_country` (`idCountry`),
  ADD CONSTRAINT `FK_product_shop` FOREIGN KEY (`idShop`) REFERENCES `tbl_shop_of_seller` (`idShop`);

--
-- Constraints for table `tbl_product_image`
--
ALTER TABLE `tbl_product_image`
  ADD CONSTRAINT `FK_product_image_product` FOREIGN KEY (`idProduct`) REFERENCES `tbl_product` (`idProduct`);

--
-- Constraints for table `tbl_product_rate`
--
ALTER TABLE `tbl_product_rate`
  ADD CONSTRAINT `FK_product_rate_account` FOREIGN KEY (`idAccount`) REFERENCES `tbl_account` (`idAccount`),
  ADD CONSTRAINT `FK_product_rate_product` FOREIGN KEY (`idProduct`) REFERENCES `tbl_product` (`idProduct`);

--
-- Constraints for table `tbl_sale_off`
--
ALTER TABLE `tbl_sale_off`
  ADD CONSTRAINT `FK_sale_off_product` FOREIGN KEY (`idProduct`) REFERENCES `tbl_product` (`idProduct`);

--
-- Constraints for table `tbl_shop_of_seller`
--
ALTER TABLE `tbl_shop_of_seller`
  ADD CONSTRAINT `FK_shop_of_seller_account` FOREIGN KEY (`idAccount`) REFERENCES `tbl_account` (`idAccount`);

--
-- Constraints for table `tbl_shop_voucher`
--
ALTER TABLE `tbl_shop_voucher`
  ADD CONSTRAINT `FK_shop_voucher_shop_seller` FOREIGN KEY (`idShop`) REFERENCES `tbl_shop_of_seller` (`idShop`);

--
-- Constraints for table `tbl_ward`
--
ALTER TABLE `tbl_ward`
  ADD CONSTRAINT `FK_ward_district` FOREIGN KEY (`idDistrict`) REFERENCES `tbl_district` (`idDistrict`);
COMMIT;
